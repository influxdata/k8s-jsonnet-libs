{
  ...
  podDisruptionBudget: {
    ...
    withMaxUnavailable(maxUnavailable): { podDisruptionBudget+: { maxUnavailable: maxUnavailable } },
    '#withMinAvailable':: d.fn(help='', args=[d.arg(name='minAvailable', type=d.T.string)]),
    withMinAvailable(minAvailable): { podDisruptionBudget+: { minAvailable: minAvailable } },
  },
  ...
  podGC: {
    ...
    labelSelector: {
      '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
      withMatchExpressions(matchExpressions): { podGC+: { labelSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
      withMatchExpressionsMixin(matchExpressions): { podGC+: { labelSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabels(matchLabels): { podGC+: { labelSelector+: { matchLabels: matchLabels } } },
      '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabelsMixin(matchLabels): { podGC+: { labelSelector+: { matchLabels+: matchLabels } } },
    },
  ...
  templateDefaults: {
    ...
    affinity: {
      ...
      nodeAffinity: {
        ...
        requiredDuringSchedulingIgnoredDuringExecution: {
          '#withNodeSelectorTerms':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
          withNodeSelectorTerms(nodeSelectorTerms): { templateDefaults+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } },
          '#withNodeSelectorTermsMixin':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
          withNodeSelectorTermsMixin(nodeSelectorTerms): { templateDefaults+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } },
        },
        '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node matches the corresponding matchExpressions; the node(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node matches the corresponding matchExpressions; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
      },
      '#podAffinity':: d.obj(help='"Pod affinity is a group of inter pod affinity scheduling rules."'),
      podAffinity: {
        '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        ...
        '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        ...
        '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
      },
      '#podAntiAffinity':: d.obj(help='"Pod anti affinity is a group of inter pod anti affinity scheduling rules."'),
      podAntiAffinity: {
        '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling anti-affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        ...
        '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling anti-affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } },
        '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        ...
        '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
        withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { templateDefaults+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } },
      },
    },
    ...
    archiveLocation: {
      ...
      artifactory: {
        ...
        passwordSecret: {
          ...
          withKey(key): { templateDefaults+: { archiveLocation+: { artifactory+: { passwordSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { artifactory+: { passwordSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { artifactory+: { passwordSecret+: { optional: optional } } } } },
        },
        '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        usernameSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { artifactory+: { usernameSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { artifactory+: { usernameSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { artifactory+: { usernameSecret+: { optional: optional } } } } },
        },
        '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { templateDefaults+: { archiveLocation+: { artifactory+: { url: url } } } },
      },
      ...
      gcs: {
        ...
        serviceAccountKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { gcs+: { serviceAccountKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { gcs+: { serviceAccountKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { gcs+: { serviceAccountKeySecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { templateDefaults+: { archiveLocation+: { gcs+: { bucket: bucket } } } },
        '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { templateDefaults+: { archiveLocation+: { gcs+: { key: key } } } },
      },
      ...
      git: {
        ...
        passwordSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { git+: { passwordSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { git+: { passwordSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { git+: { passwordSecret+: { optional: optional } } } } },
        },
        '#sshPrivateKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        sshPrivateKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { git+: { sshPrivateKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { git+: { sshPrivateKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { git+: { sshPrivateKeySecret+: { optional: optional } } } } },
        },
        '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        usernameSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { git+: { usernameSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { git+: { usernameSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { git+: { usernameSecret+: { optional: optional } } } } },
        },
        ...
        withDepth(depth): { templateDefaults+: { archiveLocation+: { git+: { depth: depth } } } },
        ...
        withDisableSubmodules(disableSubmodules): { templateDefaults+: { archiveLocation+: { git+: { disableSubmodules: disableSubmodules } } } },
        ...
        withFetch(fetch): { templateDefaults+: { archiveLocation+: { git+: { fetch: if std.isArray(v=fetch) then fetch else [fetch] } } } },
        ...
        withFetchMixin(fetch): { templateDefaults+: { archiveLocation+: { git+: { fetch+: if std.isArray(v=fetch) then fetch else [fetch] } } } },
        ...
        withInsecureIgnoreHostKey(insecureIgnoreHostKey): { templateDefaults+: { archiveLocation+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } },
        '#withRepo':: d.fn(help='"Repo is the git repository"', args=[d.arg(name='repo', type=d.T.string)]),
        withRepo(repo): { templateDefaults+: { archiveLocation+: { git+: { repo: repo } } } },
        '#withRevision':: d.fn(help='"Revision is the git commit, tag, branch to checkout"', args=[d.arg(name='revision', type=d.T.string)]),
        withRevision(revision): { templateDefaults+: { archiveLocation+: { git+: { revision: revision } } } },
      },
      ...
      hdfs: {
        ...
        krbCCacheSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { hdfs+: { krbCCacheSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { hdfs+: { krbCCacheSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { hdfs+: { krbCCacheSecret+: { optional: optional } } } } },
        },
        '#krbConfigConfigMap':: d.obj(help='"Selects a key from a ConfigMap."'),
        krbConfigConfigMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { hdfs+: { krbConfigConfigMap+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { hdfs+: { krbConfigConfigMap+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { hdfs+: { krbConfigConfigMap+: { optional: optional } } } } },
        },
        '#krbKeytabSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        krbKeytabSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { hdfs+: { krbKeytabSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { hdfs+: { krbKeytabSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { hdfs+: { krbKeytabSecret+: { optional: optional } } } } },
        },
        '#withAddresses':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"', args=[d.arg(name='addresses', type=d.T.array)]),
        withAddresses(addresses): { templateDefaults+: { archiveLocation+: { hdfs+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } } },
        ...
        withAddressesMixin(addresses): { templateDefaults+: { archiveLocation+: { hdfs+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } } },
        '#withForce':: d.fn(help='"Force copies a file forcibly even if it exists (default: false)"', args=[d.arg(name='force', type=d.T.boolean)]),
        withForce(force): { templateDefaults+: { archiveLocation+: { hdfs+: { force: force } } } },
        ...
        withHdfsUser(hdfsUser): { templateDefaults+: { archiveLocation+: { hdfs+: { hdfsUser: hdfsUser } } } },
        ...
        withKrbRealm(krbRealm): { templateDefaults+: { archiveLocation+: { hdfs+: { krbRealm: krbRealm } } } },
        ...
        withKrbServicePrincipalName(krbServicePrincipalName): { templateDefaults+: { archiveLocation+: { hdfs+: { krbServicePrincipalName: krbServicePrincipalName } } } },
        ...
        withKrbUsername(krbUsername): { templateDefaults+: { archiveLocation+: { hdfs+: { krbUsername: krbUsername } } } },
        '#withPath':: d.fn(help='"Path is a file path in HDFS"', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { templateDefaults+: { archiveLocation+: { hdfs+: { path: path } } } },
      },
      ...
      http: {
        ...
        withHeaders(headers): { templateDefaults+: { archiveLocation+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } } },
        ...
        withHeadersMixin(headers): { templateDefaults+: { archiveLocation+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } },
        '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { templateDefaults+: { archiveLocation+: { http+: { url: url } } } },
      },
      ...
      oss: {
        ...
        accessKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { oss+: { accessKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { oss+: { accessKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { oss+: { accessKeySecret+: { optional: optional } } } } },
        },
        ...
        lifecycleRule: {
          ...
          withMarkDeletionAfterDays(markDeletionAfterDays): { templateDefaults+: { archiveLocation+: { oss+: { lifecycleRule+: { markDeletionAfterDays: markDeletionAfterDays } } } } },
          ...
          withMarkInfrequentAccessAfterDays(markInfrequentAccessAfterDays): { templateDefaults+: { archiveLocation+: { oss+: { lifecycleRule+: { markInfrequentAccessAfterDays: markInfrequentAccessAfterDays } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { oss+: { secretKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { oss+: { secretKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { oss+: { secretKeySecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { templateDefaults+: { archiveLocation+: { oss+: { bucket: bucket } } } },
        ...
        withCreateBucketIfNotPresent(createBucketIfNotPresent): { templateDefaults+: { archiveLocation+: { oss+: { createBucketIfNotPresent: createBucketIfNotPresent } } } },
        '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { templateDefaults+: { archiveLocation+: { oss+: { endpoint: endpoint } } } },
        '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { templateDefaults+: { archiveLocation+: { oss+: { key: key } } } },
        ...
        withSecurityToken(securityToken): { templateDefaults+: { archiveLocation+: { oss+: { securityToken: securityToken } } } },
      },
      ...
      raw: {
        ...
        withData(data): { templateDefaults+: { archiveLocation+: { raw+: { data: data } } } },
      },
      ...
      s3: {
        ...
        accessKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { s3+: { accessKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { s3+: { accessKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { s3+: { accessKeySecret+: { optional: optional } } } } },
        },
        ...
        createBucketIfNotPresent: {
          ...
          withObjectLocking(objectLocking): { templateDefaults+: { archiveLocation+: { s3+: { createBucketIfNotPresent+: { objectLocking: objectLocking } } } } },
        },
        ...
        encryptionOptions: {
          ...
          serverSideCustomerKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } },
          },
          ...
          withEnableEncryption(enableEncryption): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } },
          ...
          withKmsEncryptionContext(kmsEncryptionContext): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } },
          ...
          withKmsKeyId(kmsKeyId): { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { archiveLocation+: { s3+: { secretKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { archiveLocation+: { s3+: { secretKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { archiveLocation+: { s3+: { secretKeySecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { templateDefaults+: { archiveLocation+: { s3+: { bucket: bucket } } } },
        '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { templateDefaults+: { archiveLocation+: { s3+: { endpoint: endpoint } } } },
        '#withInsecure':: d.fn(help='"Insecure will connect to the service with TLS"', args=[d.arg(name='insecure', type=d.T.boolean)]),
        withInsecure(insecure): { templateDefaults+: { archiveLocation+: { s3+: { insecure: insecure } } } },
        '#withKey':: d.fn(help='"Key is the key in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { templateDefaults+: { archiveLocation+: { s3+: { key: key } } } },
        '#withRegion':: d.fn(help='"Region contains the optional bucket region"', args=[d.arg(name='region', type=d.T.string)]),
        withRegion(region): { templateDefaults+: { archiveLocation+: { s3+: { region: region } } } },
        ...
        withRoleARN(roleARN): { templateDefaults+: { archiveLocation+: { s3+: { roleARN: roleARN } } } },
        ...
        withUseSDKCreds(useSDKCreds): { templateDefaults+: { archiveLocation+: { s3+: { useSDKCreds: useSDKCreds } } } },
      },
      ...
      withArchiveLogs(archiveLogs): { templateDefaults+: { archiveLocation+: { archiveLogs: archiveLogs } } },
    },
    ...
    container: {
      ...
      lifecycle: {
        ...
        postStart: {
          ...
          exec: {
            ...
            withCommand(command): { templateDefaults+: { container+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            ...
            withCommandMixin(command): { templateDefaults+: { container+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          ...
          httpGet: {
            ...
            withHost(host): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } },
            ...
            withHttpHeaders(httpHeaders): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            ...
            withHttpHeadersMixin(httpHeaders): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { templateDefaults+: { container+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } },
          },
          ...
          tcpSocket: {
            ...
            withHost(host): { templateDefaults+: { container+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { container+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } },
          },
        },
        ...
        preStop: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { templateDefaults+: { container+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { templateDefaults+: { container+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
          httpGet: {
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { templateDefaults+: { container+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { container+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { container+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } },
          },
        },
      },
      ...
      livenessProbe: {
        ...
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { container+: { livenessProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { container+: { livenessProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { container+: { livenessProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { livenessProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { livenessProbe+: { tcpSocket+: { port: port } } } } },
        },
        ...
        withFailureThreshold(failureThreshold): { templateDefaults+: { container+: { livenessProbe+: { failureThreshold: failureThreshold } } } },
        ...
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { container+: { livenessProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        ...
        withPeriodSeconds(periodSeconds): { templateDefaults+: { container+: { livenessProbe+: { periodSeconds: periodSeconds } } } },
        ...
        withSuccessThreshold(successThreshold): { templateDefaults+: { container+: { livenessProbe+: { successThreshold: successThreshold } } } },
        ...
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { container+: { livenessProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      ...
      readinessProbe: {
        ...
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { container+: { readinessProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { container+: { readinessProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { container+: { readinessProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { readinessProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { readinessProbe+: { tcpSocket+: { port: port } } } } },
        },
        '#withFailureThreshold':: d.fn(help='"Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1."', args=[d.arg(name='failureThreshold', type=d.T.integer)]),
        withFailureThreshold(failureThreshold): { templateDefaults+: { container+: { readinessProbe+: { failureThreshold: failureThreshold } } } },
        '#withInitialDelaySeconds':: d.fn(help='"Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='initialDelaySeconds', type=d.T.integer)]),
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { container+: { readinessProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        '#withPeriodSeconds':: d.fn(help='"How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1."', args=[d.arg(name='periodSeconds', type=d.T.integer)]),
        withPeriodSeconds(periodSeconds): { templateDefaults+: { container+: { readinessProbe+: { periodSeconds: periodSeconds } } } },
        '#withSuccessThreshold':: d.fn(help='"Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1."', args=[d.arg(name='successThreshold', type=d.T.integer)]),
        withSuccessThreshold(successThreshold): { templateDefaults+: { container+: { readinessProbe+: { successThreshold: successThreshold } } } },
        '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { container+: { readinessProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      ...
      resources: {
        ...
        withLimits(limits): { templateDefaults+: { container+: { resources+: { limits: limits } } } },
        ...
        withLimitsMixin(limits): { templateDefaults+: { container+: { resources+: { limits+: limits } } } },
        ...
        withRequests(requests): { templateDefaults+: { container+: { resources+: { requests: requests } } } },
        ...
        withRequestsMixin(requests): { templateDefaults+: { container+: { resources+: { requests+: requests } } } },
      },
      ...
      securityContext: {
        ...
        capabilities: {
          ...
          withAdd(add): { templateDefaults+: { container+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } },
          ...
          withAddMixin(add): { templateDefaults+: { container+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } },
          '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
          withDrop(drop): { templateDefaults+: { container+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } },
          ...
          withDropMixin(drop): { templateDefaults+: { container+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"SELinuxOptions are the labels to be applied to the container"'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { templateDefaults+: { container+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { templateDefaults+: { container+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { templateDefaults+: { container+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { templateDefaults+: { container+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#windowsOptions':: d.obj(help='"WindowsSecurityContextOptions contain Windows-specific options and credentials."'),
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { templateDefaults+: { container+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { templateDefaults+: { container+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. This field is beta-level and may be disabled with the WindowsRunAsUserName feature flag."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { templateDefaults+: { container+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        ...
        withAllowPrivilegeEscalation(allowPrivilegeEscalation): { templateDefaults+: { container+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } },
        ...
        withPrivileged(privileged): { templateDefaults+: { container+: { securityContext+: { privileged: privileged } } } },
        ...
        withProcMount(procMount): { templateDefaults+: { container+: { securityContext+: { procMount: procMount } } } },
        ...
        withReadOnlyRootFilesystem(readOnlyRootFilesystem): { templateDefaults+: { container+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } },
        ...
        withRunAsGroup(runAsGroup): { templateDefaults+: { container+: { securityContext+: { runAsGroup: runAsGroup } } } },
        ...
        withRunAsNonRoot(runAsNonRoot): { templateDefaults+: { container+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        ...
        withRunAsUser(runAsUser): { templateDefaults+: { container+: { securityContext+: { runAsUser: runAsUser } } } },
      },
      ...
      startupProbe: {
        ...
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { container+: { startupProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { container+: { startupProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { container+: { startupProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { container+: { startupProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { container+: { startupProbe+: { tcpSocket+: { port: port } } } } },
        },
        '#withFailureThreshold':: d.fn(help='"Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1."', args=[d.arg(name='failureThreshold', type=d.T.integer)]),
        withFailureThreshold(failureThreshold): { templateDefaults+: { container+: { startupProbe+: { failureThreshold: failureThreshold } } } },
        '#withInitialDelaySeconds':: d.fn(help='"Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='initialDelaySeconds', type=d.T.integer)]),
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { container+: { startupProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        '#withPeriodSeconds':: d.fn(help='"How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1."', args=[d.arg(name='periodSeconds', type=d.T.integer)]),
        withPeriodSeconds(periodSeconds): { templateDefaults+: { container+: { startupProbe+: { periodSeconds: periodSeconds } } } },
        '#withSuccessThreshold':: d.fn(help='"Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1."', args=[d.arg(name='successThreshold', type=d.T.integer)]),
        withSuccessThreshold(successThreshold): { templateDefaults+: { container+: { startupProbe+: { successThreshold: successThreshold } } } },
        '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { container+: { startupProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      ...
      withArgs(args): { templateDefaults+: { container+: { args: if std.isArray(v=args) then args else [args] } } },
      ...
      withArgsMixin(args): { templateDefaults+: { container+: { args+: if std.isArray(v=args) then args else [args] } } },
      ...
      withCommand(command): { templateDefaults+: { container+: { command: if std.isArray(v=command) then command else [command] } } },
      ...
      withCommandMixin(command): { templateDefaults+: { container+: { command+: if std.isArray(v=command) then command else [command] } } },
      ...
      withEnv(env): { templateDefaults+: { container+: { env: if std.isArray(v=env) then env else [env] } } },
      ...
      withEnvFrom(envFrom): { templateDefaults+: { container+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      ...
      withEnvFromMixin(envFrom): { templateDefaults+: { container+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      ...
      withEnvMixin(env): { templateDefaults+: { container+: { env+: if std.isArray(v=env) then env else [env] } } },
      ...
      withImage(image): { templateDefaults+: { container+: { image: image } } },
      ...
      withImagePullPolicy(imagePullPolicy): { templateDefaults+: { container+: { imagePullPolicy: imagePullPolicy } } },
      ...
      withName(name): { templateDefaults+: { container+: { name: name } } },
      ...
      withPorts(ports): { templateDefaults+: { container+: { ports: if std.isArray(v=ports) then ports else [ports] } } },
      ...
      withPortsMixin(ports): { templateDefaults+: { container+: { ports+: if std.isArray(v=ports) then ports else [ports] } } },
      ...
      withStdin(stdin): { templateDefaults+: { container+: { stdin: stdin } } },
      ...
      withStdinOnce(stdinOnce): { templateDefaults+: { container+: { stdinOnce: stdinOnce } } },
      ...
      withTerminationMessagePath(terminationMessagePath): { templateDefaults+: { container+: { terminationMessagePath: terminationMessagePath } } },
      ...
      withTerminationMessagePolicy(terminationMessagePolicy): { templateDefaults+: { container+: { terminationMessagePolicy: terminationMessagePolicy } } },
      ...
      withTty(tty): { templateDefaults+: { container+: { tty: tty } } },
      ...
      withVolumeDevices(volumeDevices): { templateDefaults+: { container+: { volumeDevices: if std.isArray(v=volumeDevices) then volumeDevices else [volumeDevices] } } },
      ...
      withVolumeDevicesMixin(volumeDevices): { templateDefaults+: { container+: { volumeDevices+: if std.isArray(v=volumeDevices) then volumeDevices else [volumeDevices] } } },
      ...
      withVolumeMounts(volumeMounts): { templateDefaults+: { container+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      ...
      withVolumeMountsMixin(volumeMounts): { templateDefaults+: { container+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      ...
      withWorkingDir(workingDir): { templateDefaults+: { container+: { workingDir: workingDir } } },
    },
    '#containerSet':: d.obj(help=''),
    containerSet: {
      '#withContainers':: d.fn(help='', args=[d.arg(name='containers', type=d.T.array)]),
      withContainers(containers): { templateDefaults+: { containerSet+: { containers: if std.isArray(v=containers) then containers else [containers] } } },
      ...
      withContainersMixin(containers): { templateDefaults+: { containerSet+: { containers+: if std.isArray(v=containers) then containers else [containers] } } },
      '#withVolumeMounts':: d.fn(help='', args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { templateDefaults+: { containerSet+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMountsMixin(volumeMounts): { templateDefaults+: { containerSet+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
    },
    ...
    dag: {
      ...
      withTasksMixin(tasks): { templateDefaults+: { dag+: { tasks+: if std.isArray(v=tasks) then tasks else [tasks] } } },
    },
    ...
    data: {
        ...
        artifactPaths: {
          ...
          archive: {
            ...
            tar: {
              ...
              withCompressionLevel(compressionLevel): { templateDefaults+: { data+: { source+: { artifactPaths+: { archive+: { tar+: { compressionLevel: compressionLevel } } } } } } },
            },
            ...
            withNone(none): { templateDefaults+: { data+: { source+: { artifactPaths+: { archive+: { none: none } } } } } },
            ...
            withNoneMixin(none): { templateDefaults+: { data+: { source+: { artifactPaths+: { archive+: { none+: none } } } } } },
            '#withZip':: d.fn(help='"ZipStrategy will unzip zipped input artifacts"', args=[d.arg(name='zip', type=d.T.object)]),
            withZip(zip): { templateDefaults+: { data+: { source+: { artifactPaths+: { archive+: { zip: zip } } } } } },
            ...
            withZipMixin(zip): { templateDefaults+: { data+: { source+: { artifactPaths+: { archive+: { zip+: zip } } } } } },
          },
          '#artifactory':: d.obj(help='"ArtifactoryArtifact is the location of an artifactory artifact"'),
          artifactory: {
            '#passwordSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            passwordSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { passwordSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { passwordSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { passwordSecret+: { optional: optional } } } } } } },
            },
            '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            usernameSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { usernameSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { usernameSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { usernameSecret+: { optional: optional } } } } } } },
            },
            '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
            withUrl(url): { templateDefaults+: { data+: { source+: { artifactPaths+: { artifactory+: { url: url } } } } } },
          },
          '#gcs':: d.obj(help='"GCSArtifact is the location of a GCS artifact"'),
          gcs: {
            '#serviceAccountKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            serviceAccountKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { gcs+: { serviceAccountKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { gcs+: { serviceAccountKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { gcs+: { serviceAccountKeySecret+: { optional: optional } } } } } } },
            },
            '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
            withBucket(bucket): { templateDefaults+: { data+: { source+: { artifactPaths+: { gcs+: { bucket: bucket } } } } } },
            '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { gcs+: { key: key } } } } } },
          },
          '#git':: d.obj(help='"GitArtifact is the location of an git artifact"'),
          git: {
            '#passwordSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            passwordSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { passwordSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { passwordSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { passwordSecret+: { optional: optional } } } } } } },
            },
            '#sshPrivateKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            sshPrivateKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { sshPrivateKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { sshPrivateKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { sshPrivateKeySecret+: { optional: optional } } } } } } },
            },
            '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            usernameSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { usernameSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { usernameSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { usernameSecret+: { optional: optional } } } } } } },
            },
            '#withDepth':: d.fn(help='"Depth specifies clones/fetches should be shallow and include the given number of commits from the branch tip"', args=[d.arg(name='depth', type=d.T.integer)]),
            withDepth(depth): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { depth: depth } } } } } },
            '#withDisableSubmodules':: d.fn(help='"DisableSubmodules disables submodules during git clone"', args=[d.arg(name='disableSubmodules', type=d.T.boolean)]),
            withDisableSubmodules(disableSubmodules): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { disableSubmodules: disableSubmodules } } } } } },
            '#withFetch':: d.fn(help='"Fetch specifies a number of refs that should be fetched before checkout"', args=[d.arg(name='fetch', type=d.T.array)]),
            withFetch(fetch): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { fetch: if std.isArray(v=fetch) then fetch else [fetch] } } } } } },
            '#withFetchMixin':: d.fn(help='"Fetch specifies a number of refs that should be fetched before checkout"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fetch', type=d.T.array)]),
            withFetchMixin(fetch): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { fetch+: if std.isArray(v=fetch) then fetch else [fetch] } } } } } },
            '#withInsecureIgnoreHostKey':: d.fn(help='"InsecureIgnoreHostKey disables SSH strict host key checking during git clone"', args=[d.arg(name='insecureIgnoreHostKey', type=d.T.boolean)]),
            withInsecureIgnoreHostKey(insecureIgnoreHostKey): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } } } },
            '#withRepo':: d.fn(help='"Repo is the git repository"', args=[d.arg(name='repo', type=d.T.string)]),
            withRepo(repo): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { repo: repo } } } } } },
            '#withRevision':: d.fn(help='"Revision is the git commit, tag, branch to checkout"', args=[d.arg(name='revision', type=d.T.string)]),
            withRevision(revision): { templateDefaults+: { data+: { source+: { artifactPaths+: { git+: { revision: revision } } } } } },
          },
          '#hdfs':: d.obj(help='"HDFSArtifact is the location of an HDFS artifact"'),
          hdfs: {
            '#krbCCacheSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            krbCCacheSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbCCacheSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbCCacheSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbCCacheSecret+: { optional: optional } } } } } } },
            },
            '#krbConfigConfigMap':: d.obj(help='"Selects a key from a ConfigMap."'),
            krbConfigConfigMap: {
              '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbConfigConfigMap+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbConfigConfigMap+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbConfigConfigMap+: { optional: optional } } } } } } },
            },
            '#krbKeytabSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            krbKeytabSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbKeytabSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbKeytabSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbKeytabSecret+: { optional: optional } } } } } } },
            },
            '#withAddresses':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"', args=[d.arg(name='addresses', type=d.T.array)]),
            withAddresses(addresses): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } } } } },
            '#withAddressesMixin':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
            withAddressesMixin(addresses): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } } } } },
            '#withForce':: d.fn(help='"Force copies a file forcibly even if it exists (default: false)"', args=[d.arg(name='force', type=d.T.boolean)]),
            withForce(force): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { force: force } } } } } },
            '#withHdfsUser':: d.fn(help='"HDFSUser is the user to access HDFS file system. It is ignored if either ccache or keytab is used."', args=[d.arg(name='hdfsUser', type=d.T.string)]),
            withHdfsUser(hdfsUser): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { hdfsUser: hdfsUser } } } } } },
            '#withKrbRealm':: d.fn(help='"KrbRealm is the Kerberos realm used with Kerberos keytab It must be set if keytab is used."', args=[d.arg(name='krbRealm', type=d.T.string)]),
            withKrbRealm(krbRealm): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbRealm: krbRealm } } } } } },
            '#withKrbServicePrincipalName':: d.fn(help='"KrbServicePrincipalName is the principal name of Kerberos service It must be set if either ccache or keytab is used."', args=[d.arg(name='krbServicePrincipalName', type=d.T.string)]),
            withKrbServicePrincipalName(krbServicePrincipalName): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbServicePrincipalName: krbServicePrincipalName } } } } } },
            '#withKrbUsername':: d.fn(help='"KrbUsername is the Kerberos username used with Kerberos keytab It must be set if keytab is used."', args=[d.arg(name='krbUsername', type=d.T.string)]),
            withKrbUsername(krbUsername): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { krbUsername: krbUsername } } } } } },
            '#withPath':: d.fn(help='"Path is a file path in HDFS"', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { templateDefaults+: { data+: { source+: { artifactPaths+: { hdfs+: { path: path } } } } } },
          },
          '#http':: d.obj(help='"HTTPArtifact allows an file served on HTTP to be placed as an input artifact in a container"'),
          http: {
            '#withHeaders':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests for artifacts"', args=[d.arg(name='headers', type=d.T.array)]),
            withHeaders(headers): { templateDefaults+: { data+: { source+: { artifactPaths+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } } },
            '#withHeadersMixin':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests for artifacts"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
            withHeadersMixin(headers): { templateDefaults+: { data+: { source+: { artifactPaths+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } } },
            '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
            withUrl(url): { templateDefaults+: { data+: { source+: { artifactPaths+: { http+: { url: url } } } } } },
          },
          '#oss':: d.obj(help='"OSSArtifact is the location of an Alibaba Cloud OSS artifact"'),
          oss: {
            '#accessKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            accessKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { accessKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { accessKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { accessKeySecret+: { optional: optional } } } } } } },
            },
            '#lifecycleRule':: d.obj(help="\"OSSLifecycleRule specifies how to manage bucket's lifecycle\""),
            lifecycleRule: {
              '#withMarkDeletionAfterDays':: d.fn(help='"MarkDeletionAfterDays is the number of days before we delete objects in the bucket"', args=[d.arg(name='markDeletionAfterDays', type=d.T.integer)]),
              withMarkDeletionAfterDays(markDeletionAfterDays): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { lifecycleRule+: { markDeletionAfterDays: markDeletionAfterDays } } } } } } },
              '#withMarkInfrequentAccessAfterDays':: d.fn(help='"MarkInfrequentAccessAfterDays is the number of days before we convert the objects in the bucket to Infrequent Access (IA) storage type"', args=[d.arg(name='markInfrequentAccessAfterDays', type=d.T.integer)]),
              withMarkInfrequentAccessAfterDays(markInfrequentAccessAfterDays): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { lifecycleRule+: { markInfrequentAccessAfterDays: markInfrequentAccessAfterDays } } } } } } },
            },
            '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            secretKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { secretKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { secretKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { secretKeySecret+: { optional: optional } } } } } } },
            },
            '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
            withBucket(bucket): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { bucket: bucket } } } } } },
            '#withCreateBucketIfNotPresent':: d.fn(help="\"CreateBucketIfNotPresent tells the driver to attempt to create the OSS bucket for output artifacts, if it doesn't exist\"", args=[d.arg(name='createBucketIfNotPresent', type=d.T.boolean)]),
            withCreateBucketIfNotPresent(createBucketIfNotPresent): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { createBucketIfNotPresent: createBucketIfNotPresent } } } } } },
            '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
            withEndpoint(endpoint): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { endpoint: endpoint } } } } } },
            '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { key: key } } } } } },
            '#withSecurityToken':: d.fn(help="\"SecurityToken is the user's temporary security token. For more details, check out: https://www.alibabacloud.com/help/doc-detail/100624.htm\"", args=[d.arg(name='securityToken', type=d.T.string)]),
            withSecurityToken(securityToken): { templateDefaults+: { data+: { source+: { artifactPaths+: { oss+: { securityToken: securityToken } } } } } },
          },
          '#raw':: d.obj(help='"RawArtifact allows raw string content to be placed as an artifact in a container"'),
          raw: {
            '#withData':: d.fn(help='"Data is the string contents of the artifact"', args=[d.arg(name='data', type=d.T.string)]),
            withData(data): { templateDefaults+: { data+: { source+: { artifactPaths+: { raw+: { data: data } } } } } },
          },
          '#s3':: d.obj(help='"S3Artifact is the location of an S3 artifact"'),
          s3: {
            '#accessKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            accessKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { accessKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { accessKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { accessKeySecret+: { optional: optional } } } } } } },
            },
            '#createBucketIfNotPresent':: d.obj(help='"CreateS3BucketOptions options used to determine automatic automatic bucket-creation process"'),
            createBucketIfNotPresent: {
              '#withObjectLocking':: d.fn(help='"ObjectLocking Enable object locking"', args=[d.arg(name='objectLocking', type=d.T.boolean)]),
              withObjectLocking(objectLocking): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { createBucketIfNotPresent+: { objectLocking: objectLocking } } } } } } },
            },
            '#encryptionOptions':: d.obj(help='"S3EncryptionOptions used to determine encryption options during s3 operations"'),
            encryptionOptions: {
              '#serverSideCustomerKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              serverSideCustomerKeySecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } } } },
              },
              '#withEnableEncryption':: d.fn(help='"EnableEncryption tells the driver to encrypt objects if set to true. If kmsKeyId and serverSideCustomerKeySecret are not set, SSE-S3 will be used"', args=[d.arg(name='enableEncryption', type=d.T.boolean)]),
              withEnableEncryption(enableEncryption): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } } } },
              '#withKmsEncryptionContext':: d.fn(help='"KmsEncryptionContext is a json blob that contains an encryption context. See https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context for more information"', args=[d.arg(name='kmsEncryptionContext', type=d.T.string)]),
              withKmsEncryptionContext(kmsEncryptionContext): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } } } },
              '#withKmsKeyId':: d.fn(help='"KMSKeyId tells the driver to encrypt the object using the specified KMS Key."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
              withKmsKeyId(kmsKeyId): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } } } },
            },
            '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            secretKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { secretKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { secretKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { secretKeySecret+: { optional: optional } } } } } } },
            },
            '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
            withBucket(bucket): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { bucket: bucket } } } } } },
            '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
            withEndpoint(endpoint): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { endpoint: endpoint } } } } } },
            '#withInsecure':: d.fn(help='"Insecure will connect to the service with TLS"', args=[d.arg(name='insecure', type=d.T.boolean)]),
            withInsecure(insecure): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { insecure: insecure } } } } } },
            '#withKey':: d.fn(help='"Key is the key in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { key: key } } } } } },
            '#withRegion':: d.fn(help='"Region contains the optional bucket region"', args=[d.arg(name='region', type=d.T.string)]),
            withRegion(region): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { region: region } } } } } },
            '#withRoleARN':: d.fn(help='"RoleARN is the Amazon Resource Name (ARN) of the role to assume."', args=[d.arg(name='roleARN', type=d.T.string)]),
            withRoleARN(roleARN): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { roleARN: roleARN } } } } } },
            '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
            withUseSDKCreds(useSDKCreds): { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { useSDKCreds: useSDKCreds } } } } } },
          },
          '#withArchiveLogs':: d.fn(help='"ArchiveLogs indicates if the container logs should be archived"', args=[d.arg(name='archiveLogs', type=d.T.boolean)]),
          withArchiveLogs(archiveLogs): { templateDefaults+: { data+: { source+: { artifactPaths+: { archiveLogs: archiveLogs } } } } },
          ...
          withFrom(from): { templateDefaults+: { data+: { source+: { artifactPaths+: { from: from } } } } },
          ...
          withFromExpression(fromExpression): { templateDefaults+: { data+: { source+: { artifactPaths+: { fromExpression: fromExpression } } } } },
          ...
          withGlobalName(globalName): { templateDefaults+: { data+: { source+: { artifactPaths+: { globalName: globalName } } } } },
          ...
          withMode(mode): { templateDefaults+: { data+: { source+: { artifactPaths+: { mode: mode } } } } },
          ...
          withName(name): { templateDefaults+: { data+: { source+: { artifactPaths+: { name: name } } } } },
          ...
          withOptional(optional): { templateDefaults+: { data+: { source+: { artifactPaths+: { optional: optional } } } } },
          '#withPath':: d.fn(help='"Path is the container path to the artifact"', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { data+: { source+: { artifactPaths+: { path: path } } } } },
          ...
          withRecurseMode(recurseMode): { templateDefaults+: { data+: { source+: { artifactPaths+: { recurseMode: recurseMode } } } } },
          ...
          withSubPath(subPath): { templateDefaults+: { data+: { source+: { artifactPaths+: { subPath: subPath } } } } },
        },
      },
      ...
      withTransformation(transformation): { templateDefaults+: { data+: { transformation: if std.isArray(v=transformation) then transformation else [transformation] } } },
      ...
      withTransformationMixin(transformation): { templateDefaults+: { data+: { transformation+: if std.isArray(v=transformation) then transformation else [transformation] } } },
    },
    '#executor':: d.obj(help='"ExecutorConfig holds configurations of an executor container."'),
    executor: {
      '#withServiceAccountName':: d.fn(help='"ServiceAccountName specifies the service account name of the executor container."', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
      withServiceAccountName(serviceAccountName): { templateDefaults+: { executor+: { serviceAccountName: serviceAccountName } } },
    },
    '#http':: d.obj(help=''),
    http: {
      '#withBody':: d.fn(help='"Body is content of the HTTP Request"', args=[d.arg(name='body', type=d.T.string)]),
      withBody(body): { templateDefaults+: { http+: { body: body } } },
      ...
      withHeaders(headers): { templateDefaults+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } },
      '#withHeadersMixin':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
      withHeadersMixin(headers): { templateDefaults+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } },
      '#withMethod':: d.fn(help='"Method is HTTP methods for HTTP Request"', args=[d.arg(name='method', type=d.T.string)]),
      withMethod(method): { templateDefaults+: { http+: { method: method } } },
      ...
      withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { http+: { timeoutSeconds: timeoutSeconds } } },
      '#withUrl':: d.fn(help='"URL of the HTTP Request"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { templateDefaults+: { http+: { url: url } } },
    },
    ...
    inputs: {
      ...
      withArtifacts(artifacts): { templateDefaults+: { inputs+: { artifacts: if std.isArray(v=artifacts) then artifacts else [artifacts] } } },
      '#withArtifactsMixin':: d.fn(help='"Artifact are a list of artifacts passed as inputs"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='artifacts', type=d.T.array)]),
      withArtifactsMixin(artifacts): { templateDefaults+: { inputs+: { artifacts+: if std.isArray(v=artifacts) then artifacts else [artifacts] } } },
      '#withParameters':: d.fn(help='"Parameters are a list of parameters passed as inputs"', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { templateDefaults+: { inputs+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"Parameters are a list of parameters passed as inputs"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { templateDefaults+: { inputs+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
    },
    ...
    memoize: {
      ...
      cache: {
        ...
        configMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { memoize+: { cache+: { configMap+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { memoize+: { cache+: { configMap+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { memoize+: { cache+: { configMap+: { optional: optional } } } } },
        },
      },
      '#withKey':: d.fn(help='"Key is the key to use as the caching key"', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { templateDefaults+: { memoize+: { key: key } } },
      ...
      withMaxAge(maxAge): { templateDefaults+: { memoize+: { maxAge: maxAge } } },
    },
    '#metadata':: d.obj(help='"Pod metdata"'),
    metadata: {
      '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotations(annotations): { templateDefaults+: { metadata+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { templateDefaults+: { metadata+: { annotations+: annotations } } },
      '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { templateDefaults+: { metadata+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { templateDefaults+: { metadata+: { labels+: labels } } },
    },
    '#metrics':: d.obj(help='"Metrics are a list of metrics emitted from a Workflow/Template"'),
    metrics: {
      '#withPrometheus':: d.fn(help='"Prometheus is a list of prometheus metrics to be emitted"', args=[d.arg(name='prometheus', type=d.T.array)]),
      withPrometheus(prometheus): { templateDefaults+: { metrics+: { prometheus: if std.isArray(v=prometheus) then prometheus else [prometheus] } } },
      '#withPrometheusMixin':: d.fn(help='"Prometheus is a list of prometheus metrics to be emitted"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='prometheus', type=d.T.array)]),
      withPrometheusMixin(prometheus): { templateDefaults+: { metrics+: { prometheus+: if std.isArray(v=prometheus) then prometheus else [prometheus] } } },
    },
    ...
    outputs: {
      ...
      withArtifacts(artifacts): { templateDefaults+: { outputs+: { artifacts: if std.isArray(v=artifacts) then artifacts else [artifacts] } } },
      '#withArtifactsMixin':: d.fn(help='"Artifacts holds the list of output artifacts produced by a step"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='artifacts', type=d.T.array)]),
      withArtifactsMixin(artifacts): { templateDefaults+: { outputs+: { artifacts+: if std.isArray(v=artifacts) then artifacts else [artifacts] } } },
      '#withExitCode':: d.fn(help='"ExitCode holds the exit code of a script template"', args=[d.arg(name='exitCode', type=d.T.string)]),
      withExitCode(exitCode): { templateDefaults+: { outputs+: { exitCode: exitCode } } },
      ...
      withParameters(parameters): { templateDefaults+: { outputs+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"Parameters holds the list of output parameters produced by a step"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { templateDefaults+: { outputs+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withResult':: d.fn(help='"Result holds the result (stdout) of a script template"', args=[d.arg(name='result', type=d.T.string)]),
      withResult(result): { templateDefaults+: { outputs+: { result: result } } },
    },
    ...
    resource: {
      ...
      withAction(action): { templateDefaults+: { resource+: { action: action } } },
      ...
      withFailureCondition(failureCondition): { templateDefaults+: { resource+: { failureCondition: failureCondition } } },
      ...
      withFlags(flags): { templateDefaults+: { resource+: { flags: if std.isArray(v=flags) then flags else [flags] } } },
      ...
      withFlagsMixin(flags): { templateDefaults+: { resource+: { flags+: if std.isArray(v=flags) then flags else [flags] } } },
      '#withManifest':: d.fn(help='"Manifest contains the kubernetes manifest"', args=[d.arg(name='manifest', type=d.T.string)]),
      withManifest(manifest): { templateDefaults+: { resource+: { manifest: manifest } } },
      ...
      withMergeStrategy(mergeStrategy): { templateDefaults+: { resource+: { mergeStrategy: mergeStrategy } } },
      ...
      withSetOwnerReference(setOwnerReference): { templateDefaults+: { resource+: { setOwnerReference: setOwnerReference } } },
      ...
      withSuccessCondition(successCondition): { templateDefaults+: { resource+: { successCondition: successCondition } } },
    },
    '#retryStrategy':: d.obj(help='"RetryStrategy provides controls on how to retry a workflow step"'),
    retryStrategy: {
      '#affinity':: d.obj(help='"RetryAffinity prevents running steps on the same host."'),
      affinity: {
        '#withNodeAntiAffinity':: d.fn(help='"RetryNodeAntiAffinity is a placeholder for future expansion, only empty nodeAntiAffinity is allowed. In order to prevent running steps on the same host, it uses \\"kubernetes.io/hostname\\"."', args=[d.arg(name='nodeAntiAffinity', type=d.T.object)]),
        withNodeAntiAffinity(nodeAntiAffinity): { templateDefaults+: { retryStrategy+: { affinity+: { nodeAntiAffinity: nodeAntiAffinity } } } },
        '#withNodeAntiAffinityMixin':: d.fn(help='"RetryNodeAntiAffinity is a placeholder for future expansion, only empty nodeAntiAffinity is allowed. In order to prevent running steps on the same host, it uses \\"kubernetes.io/hostname\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeAntiAffinity', type=d.T.object)]),
        withNodeAntiAffinityMixin(nodeAntiAffinity): { templateDefaults+: { retryStrategy+: { affinity+: { nodeAntiAffinity+: nodeAntiAffinity } } } },
      },
      '#backoff':: d.obj(help='"Backoff is a backoff strategy to use within retryStrategy"'),
      backoff: {
        '#withDuration':: d.fn(help='"Duration is the amount to back off. Default unit is seconds, but could also be a duration (e.g. \\"2m\\", \\"1h\\")"', args=[d.arg(name='duration', type=d.T.string)]),
        withDuration(duration): { templateDefaults+: { retryStrategy+: { backoff+: { duration: duration } } } },
        '#withFactor':: d.fn(help='', args=[d.arg(name='factor', type=d.T.string)]),
        withFactor(factor): { templateDefaults+: { retryStrategy+: { backoff+: { factor: factor } } } },
        '#withMaxDuration':: d.fn(help='"MaxDuration is the maximum amount of time allowed for the backoff strategy"', args=[d.arg(name='maxDuration', type=d.T.string)]),
        withMaxDuration(maxDuration): { templateDefaults+: { retryStrategy+: { backoff+: { maxDuration: maxDuration } } } },
      },
      '#withExpression':: d.fn(help='"Expression is a condition expression for when a node will be retried. If it evaluates to false, the node will not be retried and the retry strategy will be ignored/"', args=[d.arg(name='expression', type=d.T.string)]),
      withExpression(expression): { templateDefaults+: { retryStrategy+: { expression: expression } } },
      '#withLimit':: d.fn(help='', args=[d.arg(name='limit', type=d.T.string)]),
      withLimit(limit): { templateDefaults+: { retryStrategy+: { limit: limit } } },
      '#withRetryPolicy':: d.fn(help='"RetryPolicy is a policy of NodePhase statuses that will be retried"', args=[d.arg(name='retryPolicy', type=d.T.string)]),
      withRetryPolicy(retryPolicy): { templateDefaults+: { retryStrategy+: { retryPolicy: retryPolicy } } },
    },
    ...
    script: {
      ...
      lifecycle: {
        ...
        postStart: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { templateDefaults+: { script+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { templateDefaults+: { script+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
          httpGet: {
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { templateDefaults+: { script+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { script+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { script+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } },
          },
        },
        '#preStop':: d.obj(help='"Handler defines a specific action that should be taken"'),
        preStop: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { templateDefaults+: { script+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { templateDefaults+: { script+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
          httpGet: {
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { templateDefaults+: { script+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { templateDefaults+: { script+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { templateDefaults+: { script+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } },
          },
        },
      },
      '#livenessProbe':: d.obj(help='"Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic."'),
      livenessProbe: {
        ...
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { script+: { livenessProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { script+: { livenessProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { script+: { livenessProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { livenessProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { livenessProbe+: { tcpSocket+: { port: port } } } } },
        },
        '#withFailureThreshold':: d.fn(help='"Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1."', args=[d.arg(name='failureThreshold', type=d.T.integer)]),
        withFailureThreshold(failureThreshold): { templateDefaults+: { script+: { livenessProbe+: { failureThreshold: failureThreshold } } } },
        '#withInitialDelaySeconds':: d.fn(help='"Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='initialDelaySeconds', type=d.T.integer)]),
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { script+: { livenessProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        '#withPeriodSeconds':: d.fn(help='"How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1."', args=[d.arg(name='periodSeconds', type=d.T.integer)]),
        withPeriodSeconds(periodSeconds): { templateDefaults+: { script+: { livenessProbe+: { periodSeconds: periodSeconds } } } },
        '#withSuccessThreshold':: d.fn(help='"Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1."', args=[d.arg(name='successThreshold', type=d.T.integer)]),
        withSuccessThreshold(successThreshold): { templateDefaults+: { script+: { livenessProbe+: { successThreshold: successThreshold } } } },
        '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { script+: { livenessProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      '#readinessProbe':: d.obj(help='"Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic."'),
      readinessProbe: {
        '#exec':: d.obj(help='"ExecAction describes a \\"run in container\\" action."'),
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { script+: { readinessProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { script+: { readinessProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { script+: { readinessProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { readinessProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { readinessProbe+: { tcpSocket+: { port: port } } } } },
        },
        '#withFailureThreshold':: d.fn(help='"Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1."', args=[d.arg(name='failureThreshold', type=d.T.integer)]),
        withFailureThreshold(failureThreshold): { templateDefaults+: { script+: { readinessProbe+: { failureThreshold: failureThreshold } } } },
        '#withInitialDelaySeconds':: d.fn(help='"Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='initialDelaySeconds', type=d.T.integer)]),
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { script+: { readinessProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        '#withPeriodSeconds':: d.fn(help='"How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1."', args=[d.arg(name='periodSeconds', type=d.T.integer)]),
        withPeriodSeconds(periodSeconds): { templateDefaults+: { script+: { readinessProbe+: { periodSeconds: periodSeconds } } } },
        '#withSuccessThreshold':: d.fn(help='"Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1."', args=[d.arg(name='successThreshold', type=d.T.integer)]),
        withSuccessThreshold(successThreshold): { templateDefaults+: { script+: { readinessProbe+: { successThreshold: successThreshold } } } },
        '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { script+: { readinessProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      '#resources':: d.obj(help='"ResourceRequirements describes the compute resource requirements."'),
      resources: {
        '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/"', args=[d.arg(name='limits', type=d.T.object)]),
        withLimits(limits): { templateDefaults+: { script+: { resources+: { limits: limits } } } },
        '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
        withLimitsMixin(limits): { templateDefaults+: { script+: { resources+: { limits+: limits } } } },
        '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/"', args=[d.arg(name='requests', type=d.T.object)]),
        withRequests(requests): { templateDefaults+: { script+: { resources+: { requests: requests } } } },
        '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
        withRequestsMixin(requests): { templateDefaults+: { script+: { resources+: { requests+: requests } } } },
      },
      '#securityContext':: d.obj(help='"SecurityContext holds security configuration that will be applied to a container. Some fields are present in both SecurityContext and PodSecurityContext.  When both are set, the values in SecurityContext take precedence."'),
      securityContext: {
        '#capabilities':: d.obj(help='"Adds and removes POSIX capabilities from running containers."'),
        capabilities: {
          '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
          withAdd(add): { templateDefaults+: { script+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } },
          '#withAddMixin':: d.fn(help='"Added capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
          withAddMixin(add): { templateDefaults+: { script+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } },
          '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
          withDrop(drop): { templateDefaults+: { script+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } },
          '#withDropMixin':: d.fn(help='"Removed capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
          withDropMixin(drop): { templateDefaults+: { script+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"SELinuxOptions are the labels to be applied to the container"'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { templateDefaults+: { script+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { templateDefaults+: { script+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { templateDefaults+: { script+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { templateDefaults+: { script+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#windowsOptions':: d.obj(help='"WindowsSecurityContextOptions contain Windows-specific options and credentials."'),
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { templateDefaults+: { script+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { templateDefaults+: { script+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. This field is beta-level and may be disabled with the WindowsRunAsUserName feature flag."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { templateDefaults+: { script+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        '#withAllowPrivilegeEscalation':: d.fn(help='"AllowPrivilegeEscalation controls whether a process can gain more privileges than its parent process. This bool directly controls if the no_new_privs flag will be set on the container process. AllowPrivilegeEscalation is true always when the container is: 1) run as Privileged 2) has CAP_SYS_ADMIN"', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
        withAllowPrivilegeEscalation(allowPrivilegeEscalation): { templateDefaults+: { script+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } },
        '#withPrivileged':: d.fn(help='"Run container in privileged mode. Processes in privileged containers are essentially equivalent to root on the host. Defaults to false."', args=[d.arg(name='privileged', type=d.T.boolean)]),
        withPrivileged(privileged): { templateDefaults+: { script+: { securityContext+: { privileged: privileged } } } },
        '#withProcMount':: d.fn(help='"procMount denotes the type of proc mount to use for the containers. The default is DefaultProcMount which uses the container runtime defaults for readonly paths and masked paths. This requires the ProcMountType feature flag to be enabled."', args=[d.arg(name='procMount', type=d.T.string)]),
        withProcMount(procMount): { templateDefaults+: { script+: { securityContext+: { procMount: procMount } } } },
        '#withReadOnlyRootFilesystem':: d.fn(help='"Whether this container has a read-only root filesystem. Default is false."', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
        withReadOnlyRootFilesystem(readOnlyRootFilesystem): { templateDefaults+: { script+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } },
        '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process. Uses runtime default if unset. May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
        withRunAsGroup(runAsGroup): { templateDefaults+: { script+: { securityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user. If true, the Kubelet will validate the image at runtime to ensure that it does not run as UID 0 (root) and fail to start the container if it does. If unset or false, no such validation will be performed. May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { templateDefaults+: { script+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { templateDefaults+: { script+: { securityContext+: { runAsUser: runAsUser } } } },
      },
      '#startupProbe':: d.obj(help='"Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic."'),
      startupProbe: {
        '#exec':: d.obj(help='"ExecAction describes a \\"run in container\\" action."'),
        exec: {
          '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
          withCommand(command): { templateDefaults+: { script+: { startupProbe+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } },
          '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
          withCommandMixin(command): { templateDefaults+: { script+: { startupProbe+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } },
        },
        '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
        httpGet: {
          '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { host: host } } } } },
          '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeaders(httpHeaders): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
          withHttpHeadersMixin(httpHeaders): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } },
          '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { path: path } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { port: port } } } } },
          '#withScheme':: d.fn(help='"Scheme to use for connecting to the host. Defaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
          withScheme(scheme): { templateDefaults+: { script+: { startupProbe+: { httpGet+: { scheme: scheme } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { templateDefaults+: { script+: { startupProbe+: { tcpSocket+: { host: host } } } } },
          '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.string)]),
          withPort(port): { templateDefaults+: { script+: { startupProbe+: { tcpSocket+: { port: port } } } } },
        },
        '#withFailureThreshold':: d.fn(help='"Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1."', args=[d.arg(name='failureThreshold', type=d.T.integer)]),
        withFailureThreshold(failureThreshold): { templateDefaults+: { script+: { startupProbe+: { failureThreshold: failureThreshold } } } },
        '#withInitialDelaySeconds':: d.fn(help='"Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='initialDelaySeconds', type=d.T.integer)]),
        withInitialDelaySeconds(initialDelaySeconds): { templateDefaults+: { script+: { startupProbe+: { initialDelaySeconds: initialDelaySeconds } } } },
        '#withPeriodSeconds':: d.fn(help='"How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1."', args=[d.arg(name='periodSeconds', type=d.T.integer)]),
        withPeriodSeconds(periodSeconds): { templateDefaults+: { script+: { startupProbe+: { periodSeconds: periodSeconds } } } },
        '#withSuccessThreshold':: d.fn(help='"Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1."', args=[d.arg(name='successThreshold', type=d.T.integer)]),
        withSuccessThreshold(successThreshold): { templateDefaults+: { script+: { startupProbe+: { successThreshold: successThreshold } } } },
        '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { templateDefaults+: { script+: { startupProbe+: { timeoutSeconds: timeoutSeconds } } } },
      },
      '#withArgs':: d.fn(help="\"Arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell\"", args=[d.arg(name='args', type=d.T.array)]),
      withArgs(args): { templateDefaults+: { script+: { args: if std.isArray(v=args) then args else [args] } } },
      '#withArgsMixin':: d.fn(help="\"Arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='args', type=d.T.array)]),
      withArgsMixin(args): { templateDefaults+: { script+: { args+: if std.isArray(v=args) then args else [args] } } },
      '#withCommand':: d.fn(help="\"Entrypoint array. Not executed within a shell. The docker image's ENTRYPOINT is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell\"", args=[d.arg(name='command', type=d.T.array)]),
      withCommand(command): { templateDefaults+: { script+: { command: if std.isArray(v=command) then command else [command] } } },
      '#withCommandMixin':: d.fn(help="\"Entrypoint array. Not executed within a shell. The docker image's ENTRYPOINT is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
      withCommandMixin(command): { templateDefaults+: { script+: { command+: if std.isArray(v=command) then command else [command] } } },
      '#withEnv':: d.fn(help='"List of environment variables to set in the container. Cannot be updated."', args=[d.arg(name='env', type=d.T.array)]),
      withEnv(env): { templateDefaults+: { script+: { env: if std.isArray(v=env) then env else [env] } } },
      '#withEnvFrom':: d.fn(help='"List of sources to populate environment variables in the container. The keys defined within a source must be a C_IDENTIFIER. All invalid keys will be reported as an event when the container is starting. When a key exists in multiple sources, the value associated with the last source will take precedence. Values defined by an Env with a duplicate key will take precedence. Cannot be updated."', args=[d.arg(name='envFrom', type=d.T.array)]),
      withEnvFrom(envFrom): { templateDefaults+: { script+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvFromMixin':: d.fn(help='"List of sources to populate environment variables in the container. The keys defined within a source must be a C_IDENTIFIER. All invalid keys will be reported as an event when the container is starting. When a key exists in multiple sources, the value associated with the last source will take precedence. Values defined by an Env with a duplicate key will take precedence. Cannot be updated."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
      withEnvFromMixin(envFrom): { templateDefaults+: { script+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvMixin':: d.fn(help='"List of environment variables to set in the container. Cannot be updated."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
      withEnvMixin(env): { templateDefaults+: { script+: { env+: if std.isArray(v=env) then env else [env] } } },
      '#withImage':: d.fn(help='"Docker image name. More info: https://kubernetes.io/docs/concepts/containers/images This field is optional to allow higher level config management to default or override container images in workload controllers like Deployments and StatefulSets."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { templateDefaults+: { script+: { image: image } } },
      '#withImagePullPolicy':: d.fn(help='"Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
      withImagePullPolicy(imagePullPolicy): { templateDefaults+: { script+: { imagePullPolicy: imagePullPolicy } } },
      '#withName':: d.fn(help='"Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL). Cannot be updated."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { templateDefaults+: { script+: { name: name } } },
      '#withPorts':: d.fn(help='"List of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default \\"0.0.0.0\\" address inside a container will be accessible from the network. Cannot be updated."', args=[d.arg(name='ports', type=d.T.array)]),
      withPorts(ports): { templateDefaults+: { script+: { ports: if std.isArray(v=ports) then ports else [ports] } } },
      '#withPortsMixin':: d.fn(help='"List of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default \\"0.0.0.0\\" address inside a container will be accessible from the network. Cannot be updated."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
      withPortsMixin(ports): { templateDefaults+: { script+: { ports+: if std.isArray(v=ports) then ports else [ports] } } },
      '#withSource':: d.fn(help='"Source contains the source code of the script to execute"', args=[d.arg(name='source', type=d.T.string)]),
      withSource(source): { templateDefaults+: { script+: { source: source } } },
      '#withStdin':: d.fn(help='"Whether this container should allocate a buffer for stdin in the container runtime. If this is not set, reads from stdin in the container will always result in EOF. Default is false."', args=[d.arg(name='stdin', type=d.T.boolean)]),
      withStdin(stdin): { templateDefaults+: { script+: { stdin: stdin } } },
      '#withStdinOnce':: d.fn(help='"Whether the container runtime should close the stdin channel after it has been opened by a single attach. When stdin is true the stdin stream will remain open across multiple attach sessions. If stdinOnce is set to true, stdin is opened on container start, is empty until the first client attaches to stdin, and then remains open and accepts data until the client disconnects, at which time stdin is closed and remains closed until the container is restarted. If this flag is false, a container processes that reads from stdin will never receive an EOF. Default is false"', args=[d.arg(name='stdinOnce', type=d.T.boolean)]),
      withStdinOnce(stdinOnce): { templateDefaults+: { script+: { stdinOnce: stdinOnce } } },
      '#withTerminationMessagePath':: d.fn(help="\"Optional: Path at which the file to which the container's termination message will be written is mounted into the container's filesystem. Message written is intended to be brief final status, such as an assertion failure message. Will be truncated by the node if greater than 4096 bytes. The total message length across all containers will be limited to 12kb. Defaults to /dev/termination-log. Cannot be updated.\"", args=[d.arg(name='terminationMessagePath', type=d.T.string)]),
      withTerminationMessagePath(terminationMessagePath): { templateDefaults+: { script+: { terminationMessagePath: terminationMessagePath } } },
      '#withTerminationMessagePolicy':: d.fn(help='"Indicate how the termination message should be populated. File will use the contents of terminationMessagePath to populate the container status message on both success and failure. FallbackToLogsOnError will use the last chunk of container log output if the termination message file is empty and the container exited with an error. The log output is limited to 2048 bytes or 80 lines, whichever is smaller. Defaults to File. Cannot be updated."', args=[d.arg(name='terminationMessagePolicy', type=d.T.string)]),
      withTerminationMessagePolicy(terminationMessagePolicy): { templateDefaults+: { script+: { terminationMessagePolicy: terminationMessagePolicy } } },
      '#withTty':: d.fn(help="\"Whether this container should allocate a TTY for itself, also requires 'stdin' to be true. Default is false.\"", args=[d.arg(name='tty', type=d.T.boolean)]),
      withTty(tty): { templateDefaults+: { script+: { tty: tty } } },
      ...
      withVolumeDevices(volumeDevices): { templateDefaults+: { script+: { volumeDevices: if std.isArray(v=volumeDevices) then volumeDevices else [volumeDevices] } } },
      '#withVolumeDevicesMixin':: d.fn(help='"volumeDevices is the list of block devices to be used by the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeDevices', type=d.T.array)]),
      withVolumeDevicesMixin(volumeDevices): { templateDefaults+: { script+: { volumeDevices+: if std.isArray(v=volumeDevices) then volumeDevices else [volumeDevices] } } },
      '#withVolumeMounts':: d.fn(help="\"Pod volumes to mount into the container's filesystem. Cannot be updated.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { templateDefaults+: { script+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help="\"Pod volumes to mount into the container's filesystem. Cannot be updated.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMountsMixin(volumeMounts): { templateDefaults+: { script+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withWorkingDir':: d.fn(help="\"Container's working directory. If not specified, the container runtime's default will be used, which might be configured in the container image. Cannot be updated.\"", args=[d.arg(name='workingDir', type=d.T.string)]),
      withWorkingDir(workingDir): { templateDefaults+: { script+: { workingDir: workingDir } } },
    },
    '#securityContext':: d.obj(help='"PodSecurityContext holds pod-level security attributes and common container settings. Some fields are also present in container.securityContext.  Field values of container.securityContext take precedence over field values of PodSecurityContext."'),
    securityContext: {
      '#seLinuxOptions':: d.obj(help='"SELinuxOptions are the labels to be applied to the container"'),
      seLinuxOptions: {
        '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { templateDefaults+: { securityContext+: { seLinuxOptions+: { level: level } } } },
        '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
        withRole(role): { templateDefaults+: { securityContext+: { seLinuxOptions+: { role: role } } } },
        '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { templateDefaults+: { securityContext+: { seLinuxOptions+: { type: type } } } },
        '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
        withUser(user): { templateDefaults+: { securityContext+: { seLinuxOptions+: { user: user } } } },
      },
      '#windowsOptions':: d.obj(help='"WindowsSecurityContextOptions contain Windows-specific options and credentials."'),
      windowsOptions: {
        '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
        withGmsaCredentialSpec(gmsaCredentialSpec): { templateDefaults+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } },
        '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
        withGmsaCredentialSpecName(gmsaCredentialSpecName): { templateDefaults+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } },
        '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. This field is beta-level and may be disabled with the WindowsRunAsUserName feature flag."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
        withRunAsUserName(runAsUserName): { templateDefaults+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } },
      },
      '#withFsGroup':: d.fn(help="\"A special supplemental group that applies to all containers in a pod. Some volume types allow the Kubelet to change the ownership of that volume to be owned by the pod:\\n\\n1. The owning GID will be the FSGroup 2. The setgid bit is set (new files created in the volume will be owned by FSGroup) 3. The permission bits are OR'd with rw-rw----\\n\\nIf unset, the Kubelet will not modify the ownership and permissions of any volume.\"", args=[d.arg(name='fsGroup', type=d.T.integer)]),
      withFsGroup(fsGroup): { templateDefaults+: { securityContext+: { fsGroup: fsGroup } } },
      '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process. Uses runtime default if unset. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
      withRunAsGroup(runAsGroup): { templateDefaults+: { securityContext+: { runAsGroup: runAsGroup } } },
      '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user. If true, the Kubelet will validate the image at runtime to ensure that it does not run as UID 0 (root) and fail to start the container if it does. If unset or false, no such validation will be performed. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
      withRunAsNonRoot(runAsNonRoot): { templateDefaults+: { securityContext+: { runAsNonRoot: runAsNonRoot } } },
      '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
      withRunAsUser(runAsUser): { templateDefaults+: { securityContext+: { runAsUser: runAsUser } } },
      '#withSupplementalGroups':: d.fn(help="\"A list of groups applied to the first process run in each container, in addition to the container's primary GID.  If unspecified, no groups will be added to any container.\"", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
      withSupplementalGroups(supplementalGroups): { templateDefaults+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      '#withSupplementalGroupsMixin':: d.fn(help="\"A list of groups applied to the first process run in each container, in addition to the container's primary GID.  If unspecified, no groups will be added to any container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
      withSupplementalGroupsMixin(supplementalGroups): { templateDefaults+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      '#withSysctls':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch."', args=[d.arg(name='sysctls', type=d.T.array)]),
      withSysctls(sysctls): { templateDefaults+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } },
      '#withSysctlsMixin':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sysctls', type=d.T.array)]),
      withSysctlsMixin(sysctls): { templateDefaults+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } },
    },
    ...
    suspend: {
      ...
      withDuration(duration): { templateDefaults+: { suspend+: { duration: duration } } },
    },
    '#synchronization':: d.obj(help='"Synchronization holds synchronization lock configuration"'),
    synchronization: {
      '#mutex':: d.obj(help='"Mutex holds Mutex configuration"'),
      mutex: {
        '#withName':: d.fn(help='"name of the mutex"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { templateDefaults+: { synchronization+: { mutex+: { name: name } } } },
      },
      '#semaphore':: d.obj(help='"SemaphoreRef is a reference of Semaphore"'),
      semaphore: {
        '#configMapKeyRef':: d.obj(help='"Selects a key from a ConfigMap."'),
        configMapKeyRef: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { templateDefaults+: { synchronization+: { semaphore+: { configMapKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { templateDefaults+: { synchronization+: { semaphore+: { configMapKeyRef+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { templateDefaults+: { synchronization+: { semaphore+: { configMapKeyRef+: { optional: optional } } } } },
        },
      },
    },
    '#withActiveDeadlineSeconds':: d.fn(help='', args=[d.arg(name='activeDeadlineSeconds', type=d.T.string)]),
    withActiveDeadlineSeconds(activeDeadlineSeconds): { templateDefaults+: { activeDeadlineSeconds: activeDeadlineSeconds } },
    ...
    withAutomountServiceAccountToken(automountServiceAccountToken): { templateDefaults+: { automountServiceAccountToken: automountServiceAccountToken } },
    ...
    withDaemon(daemon): { templateDefaults+: { daemon: daemon } },
    ...
    withFailFast(failFast): { templateDefaults+: { failFast: failFast } },
    ...
    withHostAliases(hostAliases): { templateDefaults+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    ...
    withHostAliasesMixin(hostAliases): { templateDefaults+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    ...
    withInitContainers(initContainers): { templateDefaults+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } },
    ...
    withInitContainersMixin(initContainers): { templateDefaults+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } },
    '#withName':: d.fn(help='"Name is the name of the template"', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { templateDefaults+: { name: name } },
    ...
    withNodeSelector(nodeSelector): { templateDefaults+: { nodeSelector: nodeSelector } },
    ...
    withNodeSelectorMixin(nodeSelector): { templateDefaults+: { nodeSelector+: nodeSelector } },
    ...
    withParallelism(parallelism): { templateDefaults+: { parallelism: parallelism } },
    ...
    withPodSpecPatch(podSpecPatch): { templateDefaults+: { podSpecPatch: podSpecPatch } },
    '#withPriority':: d.fn(help='"Priority to apply to workflow pods."', args=[d.arg(name='priority', type=d.T.integer)]),
    withPriority(priority): { templateDefaults+: { priority: priority } },
    ...
    withPriorityClassName(priorityClassName): { templateDefaults+: { priorityClassName: priorityClassName } },
    ...
    withSchedulerName(schedulerName): { templateDefaults+: { schedulerName: schedulerName } },
    ...
    withServiceAccountName(serviceAccountName): { templateDefaults+: { serviceAccountName: serviceAccountName } },
    ...
    withSidecars(sidecars): { templateDefaults+: { sidecars: if std.isArray(v=sidecars) then sidecars else [sidecars] } },
    ...
    withSidecarsMixin(sidecars): { templateDefaults+: { sidecars+: if std.isArray(v=sidecars) then sidecars else [sidecars] } },
    '#withSteps':: d.fn(help='"Steps define a series of sequential/parallel workflow steps"', args=[d.arg(name='steps', type=d.T.array)]),
    withSteps(steps): { templateDefaults+: { steps: if std.isArray(v=steps) then steps else [steps] } },
    ...
    withStepsMixin(steps): { templateDefaults+: { steps+: if std.isArray(v=steps) then steps else [steps] } },
    ...
    withTimeout(timeout): { templateDefaults+: { timeout: timeout } },
    '#withTolerations':: d.fn(help='"Tolerations to apply to workflow pods."', args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerations(tolerations): { templateDefaults+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    ...
    withTolerationsMixin(tolerations): { templateDefaults+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    ...
    withVolumes(volumes): { templateDefaults+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    ...
    withVolumesMixin(volumes): { templateDefaults+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } },
  },
