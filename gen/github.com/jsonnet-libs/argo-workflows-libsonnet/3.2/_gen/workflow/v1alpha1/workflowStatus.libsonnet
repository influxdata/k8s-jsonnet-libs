{
      ...
      s3: {
        ...
        encryptionOptions: {
          ...
          serverSideCustomerKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } },
          },
          ...
          withEnableEncryption(enableEncryption): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } },
          ...
          withKmsEncryptionContext(kmsEncryptionContext): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } },
          ...
          withKmsKeyId(kmsKeyId): { artifactRepositoryRef+: { artifactRepository+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
  ...
  storedWorkflowTemplateSpec: {
    ...
    retryStrategy: {
      ...
      withExpression(expression): { storedWorkflowTemplateSpec+: { retryStrategy+: { expression: expression } } },
    ...
    templateDefaults: {
      ...
      archiveLocation: {
        ...
        s3: {
          ...
          encryptionOptions: {
            ...
            serverSideCustomerKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } } },
            },
            '#withEnableEncryption':: d.fn(help='"EnableEncryption tells the driver to encrypt objects if set to true. If kmsKeyId and serverSideCustomerKeySecret are not set, SSE-S3 will be used"', args=[d.arg(name='enableEncryption', type=d.T.boolean)]),
            withEnableEncryption(enableEncryption): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } } },
            '#withKmsEncryptionContext':: d.fn(help='"KmsEncryptionContext is a json blob that contains an encryption context. See https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context for more information"', args=[d.arg(name='kmsEncryptionContext', type=d.T.string)]),
            withKmsEncryptionContext(kmsEncryptionContext): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } } },
            '#withKmsKeyId':: d.fn(help='"KMSKeyId tells the driver to encrypt the object using the specified KMS Key."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
            withKmsKeyId(kmsKeyId): { storedWorkflowTemplateSpec+: { templateDefaults+: { archiveLocation+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } } },
          },
          '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          secretKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          artifactPaths: {
            ...
            s3: {
              ...
              encryptionOptions: {
                ...
                serverSideCustomerKeySecret: {
                  '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                  withKey(key): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } } } } },
                  '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                  withName(name): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } } } } },
                  '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                  withOptional(optional): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } } } } },
                },
                '#withEnableEncryption':: d.fn(help='"EnableEncryption tells the driver to encrypt objects if set to true. If kmsKeyId and serverSideCustomerKeySecret are not set, SSE-S3 will be used"', args=[d.arg(name='enableEncryption', type=d.T.boolean)]),
                withEnableEncryption(enableEncryption): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } } } } },
                '#withKmsEncryptionContext':: d.fn(help='"KmsEncryptionContext is a json blob that contains an encryption context. See https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context for more information"', args=[d.arg(name='kmsEncryptionContext', type=d.T.string)]),
                withKmsEncryptionContext(kmsEncryptionContext): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } } } } },
                '#withKmsKeyId':: d.fn(help='"KMSKeyId tells the driver to encrypt the object using the specified KMS Key."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
                withKmsKeyId(kmsKeyId): { storedWorkflowTemplateSpec+: { templateDefaults+: { data+: { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } } } } },
              },
              '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              secretKeySecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      http: {
        ...
        withBody(body): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { body: body } } } },
        ...
        withHeaders(headers): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } } },
        '#withHeadersMixin':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
        withHeadersMixin(headers): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } },
        '#withMethod':: d.fn(help='"Method is HTTP methods for HTTP Request"', args=[d.arg(name='method', type=d.T.string)]),
        withMethod(method): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { method: method } } } },
        ...
        withTimeoutSeconds(timeoutSeconds): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { timeoutSeconds: timeoutSeconds } } } },
        '#withUrl':: d.fn(help='"URL of the HTTP Request"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { storedWorkflowTemplateSpec+: { templateDefaults+: { http+: { url: url } } } },
      },
      ...
      retryStrategy: {
        ...
        '#withExpression':: d.fn(help='"Expression is a condition expression for when a node will be retried. If it evaluates to false, the node will not be retried and the retry strategy will be ignored/"', args=[d.arg(name='expression', type=d.T.string)]),
        withExpression(expression): { storedWorkflowTemplateSpec+: { templateDefaults+: { retryStrategy+: { expression: expression } } } },
        '#withLimit':: d.fn(help='', args=[d.arg(name='limit', type=d.T.string)]),
    ...
    '#withArchiveLogs':: d.fn(help='"ArchiveLogs indicates if the container logs should be archived"', args=[d.arg(name='archiveLogs', type=d.T.boolean)]),
    withArchiveLogs(archiveLogs): { storedWorkflowTemplateSpec+: { archiveLogs: archiveLogs } },
    '#withAutomountServiceAccountToken':: d.fn(help='"AutomountServiceAccountToken indicates whether a service account token should be automatically mounted in pods. ServiceAccountName of ExecutorConfig must be specified if this value is false."', args=[d.arg(name='automountServiceAccountToken', type=d.T.boolean)]),
