{
  ...
  '#':: d.pkg(name='artifactoryArtifactRepository', url='', help='"ArtifactoryArtifactRepository defines the controller configuration for an artifactory artifact repository"'),
