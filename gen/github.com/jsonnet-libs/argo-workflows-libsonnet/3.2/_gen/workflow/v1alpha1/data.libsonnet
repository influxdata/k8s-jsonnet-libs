      ...
      s3: {
        ...
        encryptionOptions: {
          ...
          serverSideCustomerKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } },
          },
          ...
          withEnableEncryption(enableEncryption): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } },
          ...
          withKmsEncryptionContext(kmsEncryptionContext): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } },
          ...
          withKmsKeyId(kmsKeyId): { source+: { artifactPaths+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
