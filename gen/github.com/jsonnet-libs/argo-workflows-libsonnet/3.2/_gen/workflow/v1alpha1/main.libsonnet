{
  ...
  nodeResult: (import 'nodeResult.libsonnet'),
  ...
  workflowTaskSet: (import 'workflowTaskSet.libsonnet'),
  workflowTaskSetSpec: (import 'workflowTaskSetSpec.libsonnet'),
  workflowTaskSetStatus: (import 'workflowTaskSetStatus.libsonnet'),
