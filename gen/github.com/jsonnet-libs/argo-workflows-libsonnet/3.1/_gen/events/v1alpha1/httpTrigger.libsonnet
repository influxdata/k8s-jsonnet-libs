{
  ...
  '#':: d.pkg(name='httpTrigger', url='', help=''),
  ...
  withSecureHeaders(secureHeaders): { secureHeaders: if std.isArray(v=secureHeaders) then secureHeaders else [secureHeaders] },
  ...
  withSecureHeadersMixin(secureHeaders): { secureHeaders+: if std.isArray(v=secureHeaders) then secureHeaders else [secureHeaders] },
