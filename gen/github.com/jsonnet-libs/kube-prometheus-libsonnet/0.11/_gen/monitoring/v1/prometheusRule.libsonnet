{
  ...
  spec: {
    ...
    groups: {
      '#rules':: d.obj(help=''),
      rules: {
        '#withAlert':: d.fn(help='', args=[d.arg(name='alert', type=d.T.string)]),
        ...
        '#withExpr':: d.fn(help='', args=[d.arg(name='expr', type=d.T.any)]),
        ...
        '#withRecord':: d.fn(help='', args=[d.arg(name='record', type=d.T.string)]),
      ...
      '#withPartial_response_strategy':: d.fn(help='', args=[d.arg(name='partial_response_strategy', type=d.T.string)]),
