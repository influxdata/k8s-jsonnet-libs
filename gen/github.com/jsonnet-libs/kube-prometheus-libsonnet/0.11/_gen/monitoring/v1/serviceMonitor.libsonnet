{
  ...
  spec: {
    ...
    '#withJobLabel':: d.fn(help="\"Chooses the label of the Kubernetes `Endpoints`. Its value will be used for the `job`-label's value of the created metrics. \\n Default \u0026 fallback value: the name of the respective Kubernetes `Endpoint`.\"", args=[d.arg(name='jobLabel', type=d.T.string)]),
