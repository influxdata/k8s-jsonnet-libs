{
  ...
  spec: {
    ...
    '#withTargetLabels':: d.fn(help='"TargetLabels transfers labels from the Kubernetes `Service` onto the created metrics. All labels set in `selector.matchLabels` are automatically transferred."', args=[d.arg(name='targetLabels', type=d.T.array)]),
    withTargetLabels(targetLabels): { spec+: { targetLabels: if std.isArray(v=targetLabels) then targetLabels else [targetLabels] } },
    '#withTargetLabelsMixin':: d.fn(help='"TargetLabels transfers labels from the Kubernetes `Service` onto the created metrics. All labels set in `selector.matchLabels` are automatically transferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetLabels', type=d.T.array)]),
