  ...
  spec: {
    ...
    inhibitRules: {
      ...
      sourceMatch: {
        ...
        '#withRegex':: d.fn(help='"Whether to match on equality (false) or regular-expression (true)."', args=[d.arg(name='regex', type=d.T.boolean)]),
    ...
    receivers: {
      ...
      emailConfigs: {
        ...
        '#withSmarthost':: d.fn(help='"The SMTP host through which emails are sent."', args=[d.arg(name='smarthost', type=d.T.string)]),
    ...
    route: {
      ...
      '#withGroupBy':: d.fn(help='"List of labels to group by."', args=[d.arg(name='groupBy', type=d.T.array)]),
      ...
      '#withGroupInterval':: d.fn(help='"How long to wait before sending an updated notification. Must match the regular expression `[0-9]+(ms|s|m|h)` (milliseconds seconds minutes hours)."', args=[d.arg(name='groupInterval', type=d.T.string)]),
      withGroupInterval(groupInterval): { spec+: { route+: { groupInterval: groupInterval } } },
      '#withGroupWait':: d.fn(help='"How long to wait before sending the initial notification. Must match the regular expression `[0-9]+(ms|s|m|h)` (milliseconds seconds minutes hours)."', args=[d.arg(name='groupWait', type=d.T.string)]),
      ...
      '#withRepeatInterval':: d.fn(help='"How long to wait before repeating the last notification. Must match the regular expression `[0-9]+(ms|s|m|h)` (milliseconds seconds minutes hours)."', args=[d.arg(name='repeatInterval', type=d.T.string)]),
