{
  ...
  '#spec':: d.obj(help='"Configuration affecting edge load balancer. See more details at: https://istio.io/docs/reference/config/networking/gateway.html"'),
  spec: {
    '#servers':: d.obj(help='"A list of server specifications."'),
    servers: {
      '#port':: d.obj(help=''),
      port: {
      ...
      '#tls':: d.obj(help="\"Set of TLS related options that govern the server's behavior.\""),
      tls: {
        '#withCaCertificates':: d.fn(help='"REQUIRED if mode is `MUTUAL`."', args=[d.arg(name='caCertificates', type=d.T.string)]),
        ...
        '#withHttpsRedirect':: d.fn(help='', args=[d.arg(name='httpsRedirect', type=d.T.boolean)]),
        withHttpsRedirect(httpsRedirect): { tls+: { httpsRedirect: httpsRedirect } },
        '#withMaxProtocolVersion':: d.fn(help='"Optional: Maximum TLS protocol version."', args=[d.arg(name='maxProtocolVersion', type=d.T.string)]),
        withMaxProtocolVersion(maxProtocolVersion): { tls+: { maxProtocolVersion: maxProtocolVersion } },
        '#withMinProtocolVersion':: d.fn(help='"Optional: Minimum TLS protocol version."', args=[d.arg(name='minProtocolVersion', type=d.T.string)]),
        ...
        '#withVerifyCertificateHash':: d.fn(help='', args=[d.arg(name='verifyCertificateHash', type=d.T.array)]),
        ...
        '#withVerifyCertificateSpki':: d.fn(help='', args=[d.arg(name='verifyCertificateSpki', type=d.T.array)]),
      ...
      '#withBind':: d.fn(help='', args=[d.arg(name='bind', type=d.T.string)]),
      withBind(bind): { bind: bind },
      '#withDefaultEndpoint':: d.fn(help='', args=[d.arg(name='defaultEndpoint', type=d.T.string)]),
      withDefaultEndpoint(defaultEndpoint): { defaultEndpoint: defaultEndpoint },
      '#withHosts':: d.fn(help='"One or more hosts exposed by this gateway."', args=[d.arg(name='hosts', type=d.T.array)]),
      withHosts(hosts): { hosts: if std.isArray(v=hosts) then hosts else [hosts] },
      '#withHostsMixin':: d.fn(help='"One or more hosts exposed by this gateway."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hosts', type=d.T.array)]),
      withHostsMixin(hosts): { hosts+: if std.isArray(v=hosts) then hosts else [hosts] },
      '#withName':: d.fn(help='"An optional name of the server, when set must be unique across all servers."', args=[d.arg(name='name', type=d.T.string)]),
