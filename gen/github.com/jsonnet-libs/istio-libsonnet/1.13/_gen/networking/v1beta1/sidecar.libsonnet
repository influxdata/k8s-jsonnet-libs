{
  ...
  spec: {
    ...
    egress: {
      ...
      '#withCaptureMode':: d.fn(help='', args=[d.arg(name='captureMode', type=d.T.string)]),
    ...
    ingress: {
      ...
      '#withBind':: d.fn(help='"The IP to which the listener should be bound."', args=[d.arg(name='bind', type=d.T.string)]),
      withBind(bind): { bind: bind },
      '#withCaptureMode':: d.fn(help='', args=[d.arg(name='captureMode', type=d.T.string)]),
      withCaptureMode(captureMode): { captureMode: captureMode },
