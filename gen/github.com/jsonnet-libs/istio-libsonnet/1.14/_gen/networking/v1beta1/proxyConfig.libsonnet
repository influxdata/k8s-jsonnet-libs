{
  ...
  '#':: d.pkg(name='proxyConfig', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ProxyConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'ProxyConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Provides configuration for individual workloads. See more details at: https://istio.io/docs/reference/config/networking/proxy-config.html"'),
  spec: {
    '#image':: d.obj(help='"Specifies the details of the proxy image."'),
    image: {
      '#withImageType':: d.fn(help='"The image type of the image."', args=[d.arg(name='imageType', type=d.T.string)]),
      withImageType(imageType): { spec+: { image+: { imageType: imageType } } },
    },
