{
  ...
  spec: {
    ...
    '#withImagePullPolicy':: d.fn(help='"The pull behaviour to be applied when fetching an OCI image."', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
    ...
    '#withPluginName':: d.fn(help='', args=[d.arg(name='pluginName', type=d.T.string)]),
