{
  ...
  '#spec':: d.obj(help='"RequestAuthentication defines what request authentication methods are supported by a workload."'),
  spec: {
    ...
    jwtRules: {
      ...
      '#withJwksUri':: d.fn(help='', args=[d.arg(name='jwksUri', type=d.T.string)]),
      withJwksUri(jwksUri): { jwksUri: jwksUri },
      '#withJwks_uri':: d.fn(help='', args=[d.arg(name='jwks_uri', type=d.T.string)]),
      withJwks_uri(jwks_uri): { jwks_uri: jwks_uri },
      '#withOutputPayloadToHeader':: d.fn(help='', args=[d.arg(name='outputPayloadToHeader', type=d.T.string)]),
      withOutputPayloadToHeader(outputPayloadToHeader): { outputPayloadToHeader: outputPayloadToHeader },
    },
    '#selector':: d.obj(help='"The selector determines the workloads to apply the RequestAuthentication on."'),
    selector: {
