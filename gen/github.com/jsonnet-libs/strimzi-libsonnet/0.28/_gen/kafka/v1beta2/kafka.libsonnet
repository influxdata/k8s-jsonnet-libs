  ...
  spec: {
    ...
    kafka: {
      ...
      authorization: {
        ...
        '#withEnableMetrics':: d.fn(help='"Defines whether the Open Policy Agent authorizer plugin should provide metrics. Defaults to `false`."', args=[d.arg(name='enableMetrics', type=d.T.boolean)]),
