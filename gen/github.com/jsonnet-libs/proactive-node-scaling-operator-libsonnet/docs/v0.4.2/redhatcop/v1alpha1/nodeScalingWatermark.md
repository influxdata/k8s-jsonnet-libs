---
permalink: /v0.4.2/redhatcop/v1alpha1/nodeScalingWatermark/
---

# redhatcop.v1alpha1.nodeScalingWatermark
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPausePodImage(pausePodImage)`](#fn-specwithpausepodimage)
  * [`fn withPausePodSize(pausePodSize)`](#fn-specwithpausepodsize)
  * [`fn withPausePodSizeMixin(pausePodSize)`](#fn-specwithpausepodsizemixin)
...
new returns an instance of NodeScalingWatermark
...
### fn spec.withPausePodImage

```ts
withPausePodImage(pausePodImage)
```



### fn spec.withPausePodSize

```ts
withPausePodSize(pausePodSize)
```
...
### fn spec.withPausePodSizeMixin

```ts
withPausePodSizeMixin(pausePodSize)
```
...
### fn spec.withWatermarkPercentage

```ts
withWatermarkPercentage(watermarkPercentage)
```
