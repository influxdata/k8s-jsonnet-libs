{
  ...
  '#':: d.pkg(name='bucketPolicy', url='', help='"An BucketPolicy is a managed resource that represents an AWS Bucket policy."'),
  ...
  '#spec':: d.obj(help='"An BucketPolicySpec defines the desired state of an BucketPolicy."'),
  spec: {
    '#forProvider':: d.obj(help='"BucketPolicyParameters define the desired state of an AWS BucketPolicy."'),
    forProvider: {
      '#bucketNameRef':: d.obj(help='"BucketNameRef references to an S3Bucket to retrieve its bucketName"'),
      bucketNameRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { bucketNameRef+: { name: name } } } },
      },
      '#bucketNameSelector':: d.obj(help='"BucketNameSelector selects a reference to an S3Bucket to retrieve its bucketName"'),
      bucketNameSelector: {
      ...
      '#policy':: d.obj(help='"Policy is a well defined type which can be parsed into an JSON S3 Bucket Policy either policy or rawPolicy must be specified in the policy"'),
      policy: {
        ...
        statements: {
          '#condition':: d.obj(help='"Condition specifies where conditions for policy are in effect. https://docs.aws.amazon.com/AmazonS3/latest/dev/amazon-s3-policy-keys.html"'),
          condition: {
          ...
          '#notPrincipal':: d.obj(help='"Used with the S3 policy to specify the users which are not included in this policy"'),
          notPrincipal: {
            ...
            awsPrincipals: {
              ...
              '#iamUserArnRef':: d.obj(help='"IAMUserARNRef contains the reference to an IAMUser"'),
              iamUserArnRef: {
                '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { iamUserArnRef+: { name: name } },
              },
              '#iamUserArnSelector':: d.obj(help='"IAMUserARNSelector queries for an IAMUser to retrieve its userName"'),
              iamUserArnSelector: {
                '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
              ...
              '#withIamUserArn':: d.fn(help='"IAMUserARN contains the ARN of an IAM user"', args=[d.arg(name='iamUserArn', type=d.T.string)]),
              withIamUserArn(iamUserArn): { iamUserArn: iamUserArn },
            },
            '#withAllowAnon':: d.fn(help='"This flag indicates if the policy should be made available to all anonymous users."', args=[d.arg(name='allowAnon', type=d.T.boolean)]),
            ...
            '#withFederated':: d.fn(help='"This string contains the identifier for any federated web identity provider."', args=[d.arg(name='federated', type=d.T.string)]),
            withFederated(federated): { notPrincipal+: { federated: federated } },
          ...
          '#principal':: d.obj(help='"Used with the S3 policy to specify the principal that is allowed or denied access to a resource."'),
          principal: {
            '#awsPrincipals':: d.obj(help='"This list contains the all of the AWS IAM users which are affected by the policy statement."'),
            awsPrincipals: {
              '#iamRoleArnRef':: d.obj(help='"IAMRoleARNRef contains the reference to an IAMRole"'),
            ...
            '#withFederated':: d.fn(help='"This string contains the identifier for any federated web identity provider."', args=[d.arg(name='federated', type=d.T.string)]),
            withFederated(federated): { principal+: { federated: federated } },
            '#withService':: d.fn(help='"Service define the services which can have access to this bucket"', args=[d.arg(name='service', type=d.T.array)]),
          ...
          '#withCondition':: d.fn(help='"Condition specifies where conditions for policy are in effect. https://docs.aws.amazon.com/AmazonS3/latest/dev/amazon-s3-policy-keys.html"', args=[d.arg(name='condition', type=d.T.array)]),
          withCondition(condition): { condition: if std.isArray(v=condition) then condition else [condition] },
          '#withConditionMixin':: d.fn(help='"Condition specifies where conditions for policy are in effect. https://docs.aws.amazon.com/AmazonS3/latest/dev/amazon-s3-policy-keys.html"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='condition', type=d.T.array)]),
      ...
      '#withBucketName':: d.fn(help='"BucketName presents the name of the bucket."', args=[d.arg(name='bucketName', type=d.T.string)]),
      withBucketName(bucketName): { spec+: { forProvider+: { bucketName: bucketName } } },
      '#withRawPolicy':: d.fn(help='"RawPolicy is a stringified version of the S3 Bucket Policy. either policy or rawPolicy must be specified in the policy"', args=[d.arg(name='rawPolicy', type=d.T.string)]),
      withRawPolicy(rawPolicy): { spec+: { forProvider+: { rawPolicy: rawPolicy } } },
      '#withRegion':: d.fn(help='"Region is where the Bucket referenced by this BucketPolicy resides."', args=[d.arg(name='region', type=d.T.string)]),
