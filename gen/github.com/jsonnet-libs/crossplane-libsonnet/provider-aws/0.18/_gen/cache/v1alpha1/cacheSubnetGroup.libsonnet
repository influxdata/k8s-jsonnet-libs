{
  ...
  '#':: d.pkg(name='cacheSubnetGroup', url='', help='"A CacheSubnetGroup is a managed resource that represents an AWS Subnet Group for ElasticCache."'),
  ...
  '#new':: d.fn(help='new returns an instance of CacheSubnetGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#subnetIdRefs':: d.obj(help='"SubnetIDRefs references to a Subnet to and retrieves its SubnetID"'),
      subnetIdRefs: {
      ...
      '#withDescription':: d.fn(help='"A description for the cache subnet group."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withSubnetIdRefs':: d.fn(help='"SubnetIDRefs references to a Subnet to and retrieves its SubnetID"', args=[d.arg(name='subnetIdRefs', type=d.T.array)]),
