{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableGlobalWriteForwarding':: d.fn(help='"A value that indicates whether to enable write operations to be forwarded from this cluster to the primary cluster in an Aurora global database. The resulting changes are replicated back to this cluster. This parameter only applies to DB clusters that are secondary clusters in an Aurora global database. By default, Aurora disallows write operations for secondary clusters."', args=[d.arg(name='enableGlobalWriteForwarding', type=d.T.boolean)]),
