{
  ...
  spec: {
    ...
    forProvider: {
      '#withAccessPolicies':: d.fn(help='"The access rules you want to configure."', args=[d.arg(name='accessPolicies', type=d.T.string)]),
      withAccessPolicies(accessPolicies): { spec+: { forProvider+: { accessPolicies: accessPolicies } } },
      '#withDesiredInstanceType':: d.fn(help='"The desired instance type that is being used to process search requests."', args=[d.arg(name='desiredInstanceType', type=d.T.string)]),
      withDesiredInstanceType(desiredInstanceType): { spec+: { forProvider+: { desiredInstanceType: desiredInstanceType } } },
      '#withDesiredPartitionCount':: d.fn(help='"The desired number of partitions across which the search index is spread."', args=[d.arg(name='desiredPartitionCount', type=d.T.integer)]),
      withDesiredPartitionCount(desiredPartitionCount): { spec+: { forProvider+: { desiredPartitionCount: desiredPartitionCount } } },
      '#withDesiredReplicationCount':: d.fn(help='"The desired number of search instances that are available to process search requests."', args=[d.arg(name='desiredReplicationCount', type=d.T.integer)]),
      withDesiredReplicationCount(desiredReplicationCount): { spec+: { forProvider+: { desiredReplicationCount: desiredReplicationCount } } },
      '#withDomainName':: d.fn(help='"A name for the domain you are creating. Allowed characters are a-z (lower-case letters), 0-9, and hyphen (-). Domain names must start with a letter or number and be at least 3 and no more than 28 characters long."', args=[d.arg(name='domainName', type=d.T.string)]),
