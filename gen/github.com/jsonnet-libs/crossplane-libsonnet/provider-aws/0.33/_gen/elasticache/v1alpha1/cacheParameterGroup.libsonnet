{
  ...
  '#':: d.pkg(name='cacheParameterGroup', url='', help='"CacheParameterGroup is the Schema for the CacheParameterGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CacheParameterGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CacheParameterGroupSpec defines the desired state of CacheParameterGroup"'),
  spec: {
    '#forProvider':: d.obj(help='"CacheParameterGroupParameters defines the desired state of CacheParameterGroup"'),
    forProvider: {
      '#parameters':: d.obj(help='"A list of parameters to associate with this DB parameter group"'),
      parameters: {
      ...
      '#tags':: d.obj(help='"A list of tags to be added to this resource. A tag is a key-value pair. A tag key must be accompanied by a tag value, although null is accepted."'),
      tags: {
      ...
      '#withCacheParameterGroupFamily':: d.fn(help='"The name of the cache parameter group family that the cache parameter group can be used with. \\n Valid values are: memcached1.4 | memcached1.5 | memcached1.6 | redis2.6 | redis2.8 | redis3.2 | redis4.0 | redis5.0 | redis6.x |"', args=[d.arg(name='cacheParameterGroupFamily', type=d.T.string)]),
      withCacheParameterGroupFamily(cacheParameterGroupFamily): { spec+: { forProvider+: { cacheParameterGroupFamily: cacheParameterGroupFamily } } },
      '#withDescription':: d.fn(help='"A user-specified description for the cache parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withParameters':: d.fn(help='"A list of parameters to associate with this DB parameter group"', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"A list of parameters to associate with this DB parameter group"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { spec+: { forProvider+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withRegion':: d.fn(help='"Region is which region the CacheParameterGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"A list of tags to be added to this resource. A tag is a key-value pair. A tag key must be accompanied by a tag value, although null is accepted."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"A list of tags to be added to this resource. A tag is a key-value pair. A tag key must be accompanied by a tag value, although null is accepted."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
