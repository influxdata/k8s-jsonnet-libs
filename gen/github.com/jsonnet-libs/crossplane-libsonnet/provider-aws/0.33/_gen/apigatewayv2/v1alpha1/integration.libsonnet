{
  ...
  spec: {
    ...
    forProvider: {
      '#apiIdRef':: d.obj(help='"APIIDRef is a reference to an API used to set the APIID."'),
      apiIdRef: {
      ...
      '#apiIdSelector':: d.obj(help='"APIIDSelector selects references to API used to set the APIID."'),
      apiIdSelector: {
      ...
      tlsConfig: {
        '#withServerNameToVerify':: d.fn(help='"A string with a length between [1-512]."', args=[d.arg(name='serverNameToVerify', type=d.T.string)]),
        withServerNameToVerify(serverNameToVerify): { spec+: { forProvider+: { tlsConfig+: { serverNameToVerify: serverNameToVerify } } } },
      },
      '#withApiId':: d.fn(help='"APIID is the ID for the API."', args=[d.arg(name='apiId', type=d.T.string)]),
      withApiId(apiId): { spec+: { forProvider+: { apiId: apiId } } },
      '#withConnectionID':: d.fn(help='', args=[d.arg(name='connectionID', type=d.T.string)]),
      withConnectionID(connectionID): { spec+: { forProvider+: { connectionID: connectionID } } },
      '#withConnectionType':: d.fn(help='', args=[d.arg(name='connectionType', type=d.T.string)]),
      withConnectionType(connectionType): { spec+: { forProvider+: { connectionType: connectionType } } },
      '#withContentHandlingStrategy':: d.fn(help='', args=[d.arg(name='contentHandlingStrategy', type=d.T.string)]),
      ...
      '#withIntegrationMethod':: d.fn(help='', args=[d.arg(name='integrationMethod', type=d.T.string)]),
      withIntegrationMethod(integrationMethod): { spec+: { forProvider+: { integrationMethod: integrationMethod } } },
      '#withIntegrationSubtype':: d.fn(help='', args=[d.arg(name='integrationSubtype', type=d.T.string)]),
      ...
      '#withIntegrationURI':: d.fn(help='', args=[d.arg(name='integrationURI', type=d.T.string)]),
      withIntegrationURI(integrationURI): { spec+: { forProvider+: { integrationURI: integrationURI } } },
      '#withPassthroughBehavior':: d.fn(help='', args=[d.arg(name='passthroughBehavior', type=d.T.string)]),
      withPassthroughBehavior(passthroughBehavior): { spec+: { forProvider+: { passthroughBehavior: passthroughBehavior } } },
      '#withPayloadFormatVersion':: d.fn(help='', args=[d.arg(name='payloadFormatVersion', type=d.T.string)]),
      ...
      '#withTimeoutInMillis':: d.fn(help='', args=[d.arg(name='timeoutInMillis', type=d.T.integer)]),
