{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#authorizerIDSelector':: d.obj(help='"AuthorizerIDSelector selects references to Authorizer used to set the AuthorizerID."'),
      ...
      '#targetRef':: d.obj(help='"TargetRef is a reference to an Integration ID"'),
      targetRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#targetSelector':: d.obj(help='"TargetSelector is a selector for an Integration ID"'),
      targetSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withApiKeyRequired':: d.fn(help='', args=[d.arg(name='apiKeyRequired', type=d.T.boolean)]),
      withApiKeyRequired(apiKeyRequired): { spec+: { forProvider+: { apiKeyRequired: apiKeyRequired } } },
      '#withAuthorizationScopes':: d.fn(help='', args=[d.arg(name='authorizationScopes', type=d.T.array)]),
      ...
      '#withAuthorizationType':: d.fn(help='', args=[d.arg(name='authorizationType', type=d.T.string)]),
      withAuthorizationType(authorizationType): { spec+: { forProvider+: { authorizationType: authorizationType } } },
      '#withAuthorizerID':: d.fn(help='', args=[d.arg(name='authorizerID', type=d.T.string)]),
      withAuthorizerID(authorizerID): { spec+: { forProvider+: { authorizerID: authorizerID } } },
      '#withModelSelectionExpression':: d.fn(help='', args=[d.arg(name='modelSelectionExpression', type=d.T.string)]),
      withModelSelectionExpression(modelSelectionExpression): { spec+: { forProvider+: { modelSelectionExpression: modelSelectionExpression } } },
      '#withOperationName':: d.fn(help='', args=[d.arg(name='operationName', type=d.T.string)]),
      ...
      '#withRouteResponseSelectionExpression':: d.fn(help='', args=[d.arg(name='routeResponseSelectionExpression', type=d.T.string)]),
      ...
      '#withTarget':: d.fn(help='"Target for the route, of the form integrations/IntegrationID, where IntegrationID is the identifier of an AWS API Gateway Integration"', args=[d.arg(name='target', type=d.T.string)]),
