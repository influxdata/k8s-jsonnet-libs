{
  ...
  '#':: d.pkg(name='groupPolicyAttachment', url='', help='"An GroupPolicyAttachment is a managed resource that represents an AWS IAM Group policy attachment."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withGroupName':: d.fn(help='"GroupName presents the name of the Group."', args=[d.arg(name='groupName', type=d.T.string)]),
