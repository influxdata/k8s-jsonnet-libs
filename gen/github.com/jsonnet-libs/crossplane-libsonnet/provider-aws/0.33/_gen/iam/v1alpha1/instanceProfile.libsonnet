{
  ...
  '#':: d.pkg(name='instanceProfile', url='', help='"InstanceProfile is the Schema for the InstanceProfiles API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"InstanceProfileParameters defines the desired state of InstanceProfile"'),
    forProvider: {
      '#roleRef':: d.obj(help='"RoleRef is a reference to an Role"'),
      roleRef: {
      ...
      '#roleSelector':: d.obj(help='"RoleSelector selects references to Role"'),
      roleSelector: {
