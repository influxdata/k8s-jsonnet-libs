{
  ...
  '#':: d.pkg(name='role', url='', help='"An Role is a managed resource that represents an AWS IAM Role."'),
  ...
  '#spec':: d.obj(help='"An RoleSpec defines the desired state of an Role."'),
  spec: {
    '#forProvider':: d.obj(help='"RoleParameters define the desired state of an AWS IAM Role."'),
    forProvider: {
