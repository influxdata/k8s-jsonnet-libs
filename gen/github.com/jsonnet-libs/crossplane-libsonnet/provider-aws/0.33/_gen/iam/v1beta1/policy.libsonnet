{
  ...
  '#':: d.pkg(name='policy', url='', help='"An Policy is a managed resource that represents an AWS IAM Policy."'),
  ...
  '#spec':: d.obj(help='"An PolicySpec defines the desired state of an Policy."'),
  spec: {
    '#forProvider':: d.obj(help='"PolicyParameters define the desired state of an AWS IAM Policy."'),
    forProvider: {
      '#withDescription':: d.fn(help='"A description of the policy."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDocument':: d.fn(help='"The JSON policy document that is the content for the policy."', args=[d.arg(name='document', type=d.T.string)]),
      withDocument(document): { spec+: { forProvider+: { document: document } } },
      '#withName':: d.fn(help='"The name of the policy."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPath':: d.fn(help='"The path to the policy."', args=[d.arg(name='path', type=d.T.string)]),
