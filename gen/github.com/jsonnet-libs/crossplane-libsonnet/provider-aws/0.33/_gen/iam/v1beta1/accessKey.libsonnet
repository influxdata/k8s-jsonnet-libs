{
  ...
  '#':: d.pkg(name='accessKey', url='', help='"An AccessKey is a managed resource that represents an the Access Key for an AWS IAM User."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAccessKeyStatus':: d.fn(help='"The current status of this AccessKey on the AWS Must be either Active or Inactive."', args=[d.arg(name='accessKeyStatus', type=d.T.string)]),
      withAccessKeyStatus(accessKeyStatus): { spec+: { forProvider+: { accessKeyStatus: accessKeyStatus } } },
      '#withUserName':: d.fn(help='"Username contains the name of the User."', args=[d.arg(name='userName', type=d.T.string)]),
