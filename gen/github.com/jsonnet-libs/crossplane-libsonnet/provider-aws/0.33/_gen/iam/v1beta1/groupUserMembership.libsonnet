{
  ...
  '#':: d.pkg(name='groupUserMembership', url='', help='"An GroupUserMembership is a managed resource that represents an AWS IAM User group membership."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#userNameRef':: d.obj(help='"UserNameRef references to an User to retrieve its userName"'),
      userNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#userNameSelector':: d.obj(help='"UserNameSelector selects a reference to an User to retrieve its userName"'),
      userNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withGroupName':: d.fn(help='"GroupName is the Amazon IAM Group Name (Group) of the IAM group you want to add User to."', args=[d.arg(name='groupName', type=d.T.string)]),
