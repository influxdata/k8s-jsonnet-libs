{
  ...
  '#':: d.pkg(name='resolverRuleAssociation', url='', help='"ResolverRuleAssociation is a managed resource that represents an AWS Route53 ResolverRuleAssociation."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResolverRuleAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#resolverRuleIdRef':: d.obj(help='"ResolverRuleIDRef is a reference to a ResolverRule used to set the ResolverRuleID."'),
      resolverRuleIdRef: {
      ...
      '#resolverRuleIdSelector':: d.obj(help='"ResolverRuleIDSelector selects references to a ResolverRule used to set the ResolverRuleID."'),
      ...
      '#vpcIdRef':: d.obj(help='"VPCIdRef is a reference to a VPC used to set the VPCId."'),
      vpcIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#vpcIdSelector':: d.obj(help='"VPCIdSelector selects references to a VPC used to set the VPCId."'),
      vpcIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withResolverRuleId':: d.fn(help='"The ID of the Resolver rule that you want to associate with the VPC. To list the existing Resolver rules, use ListResolverRules (https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_ListResolverRules.html)."', args=[d.arg(name='resolverRuleId', type=d.T.string)]),
