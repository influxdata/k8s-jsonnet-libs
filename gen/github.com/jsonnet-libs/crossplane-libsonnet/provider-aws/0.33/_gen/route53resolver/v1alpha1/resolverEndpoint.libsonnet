{
  ...
  '#':: d.pkg(name='resolverEndpoint', url='', help='"ResolverEndpoint is the Schema for the ResolverEndpoints API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ResolverEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDirection':: d.fn(help='"Specify the applicable value: \\n * INBOUND: Resolver forwards DNS queries to the DNS service for a VPC from your network \\n * OUTBOUND: Resolver forwards DNS queries from the DNS service for a VPC to your network"', args=[d.arg(name='direction', type=d.T.string)]),
      withDirection(direction): { spec+: { forProvider+: { direction: direction } } },
      '#withIpAddresses':: d.fn(help='"IPAddresses are the subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC."', args=[d.arg(name='ipAddresses', type=d.T.array)]),
      withIpAddresses(ipAddresses): { spec+: { forProvider+: { ipAddresses: if std.isArray(v=ipAddresses) then ipAddresses else [ipAddresses] } } },
      '#withIpAddressesMixin':: d.fn(help='"IPAddresses are the subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddresses', type=d.T.array)]),
      ...
      '#withName':: d.fn(help='"A friendly name that lets you easily find a configuration in the Resolver dashboard in the Route 53 console."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the ResolverEndpoint will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help="\"The ID of one or more security groups that you want to use to control access to this VPC. The security group that you specify must include one or more inbound rules (for inbound Resolver endpoints) or outbound rules (for outbound Resolver endpoints). Inbound and outbound rules must allow TCP and UDP access. For inbound access, open port 53. For outbound access, open the port that you're using for DNS queries on your network.\"", args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupIdsMixin':: d.fn(help="\"The ID of one or more security groups that you want to use to control access to this VPC. The security group that you specify must include one or more inbound rules (for inbound Resolver endpoints) or outbound rules (for outbound Resolver endpoints). Inbound and outbound rules must allow TCP and UDP access. For inbound access, open port 53. For outbound access, open the port that you're using for DNS queries on your network.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='securityGroupIds', type=d.T.array)]),
