{
  ...
  '#':: d.pkg(name='resolverRule', url='', help='"ResolverRule is the Schema for the ResolverRules API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ResolverRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53resolver.aws.crossplane.io/v1alpha1',
    kind: 'ResolverRule',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ResolverRuleSpec defines the desired state of ResolverRule"'),
  spec: {
    '#forProvider':: d.obj(help='"ResolverRuleParameters defines the desired state of ResolverRule"'),
    forProvider: {
      '#resolverEndpointIdRefs':: d.obj(help='"ResolverEndpointIDRef is the reference to the ResolverEndpoint used to set the ResolverEndpointID"'),
      resolverEndpointIdRefs: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { resolverEndpointIdRefs+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { resolverEndpointIdRefs+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { resolverEndpointIdRefs+: { name: name } } } },
      },
      '#resolverEndpointIdSelector':: d.obj(help='"ResolverEndpointIDSelector selects references to ResolverEndpoint used to set the ResolverEndpointID"'),
      ...
      '#withDomainName':: d.fn(help='"DNS queries for this domain name are forwarded to the IP addresses that you specify in TargetIps. If a query matches multiple Resolver rules (example.com and www.example.com), outbound DNS queries are routed using the Resolver rule that contains the most specific domain name (www.example.com)."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withName':: d.fn(help='"A friendly name that lets you easily find a rule in the Resolver dashboard in the Route 53 console."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the ResolverRule will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withResolverEndpointID':: d.fn(help='"The ID of the outbound Resolver endpoint that you want to use to route DNS queries to the IP addresses that you specify in TargetIps."', args=[d.arg(name='resolverEndpointID', type=d.T.string)]),
      withResolverEndpointID(resolverEndpointID): { spec+: { forProvider+: { resolverEndpointID: resolverEndpointID } } },
      '#withRuleType':: d.fn(help='"When you want to forward DNS queries for specified domain name to resolvers on your network, specify FORWARD. \\n When you have a forwarding rule to forward DNS queries for a domain to your network and you want Resolver to process queries for a subdomain of that domain, specify SYSTEM. \\n For example, to forward DNS queries for example.com to resolvers on your network, you create a rule and specify FORWARD for RuleType. To then have Resolver process queries for apex.example.com, you create a rule and specify SYSTEM for RuleType. \\n Currently, only Resolver can create rules that have a value of RECURSIVE for RuleType."', args=[d.arg(name='ruleType', type=d.T.string)]),
      withRuleType(ruleType): { spec+: { forProvider+: { ruleType: ruleType } } },
      '#withTags':: d.fn(help='"A list of the tag keys and values that you want to associate with the endpoint."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"A list of the tag keys and values that you want to associate with the endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTargetIPs':: d.fn(help='"The IPs that you want Resolver to forward DNS queries to. You can specify only IPv4 addresses. Separate IP addresses with a space. \\n TargetIps is available only when the value of Rule type is FORWARD."', args=[d.arg(name='targetIPs', type=d.T.array)]),
      withTargetIPs(targetIPs): { spec+: { forProvider+: { targetIPs: if std.isArray(v=targetIPs) then targetIPs else [targetIPs] } } },
      '#withTargetIPsMixin':: d.fn(help='"The IPs that you want Resolver to forward DNS queries to. You can specify only IPv4 addresses. Separate IP addresses with a space. \\n TargetIps is available only when the value of Rule type is FORWARD."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetIPs', type=d.T.array)]),
      withTargetIPsMixin(targetIPs): { spec+: { forProvider+: { targetIPs+: if std.isArray(v=targetIPs) then targetIPs else [targetIPs] } } },
    },
