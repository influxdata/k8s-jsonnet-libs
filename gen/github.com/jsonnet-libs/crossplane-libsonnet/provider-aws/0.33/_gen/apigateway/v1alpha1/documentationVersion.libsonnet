{
  ...
  '#':: d.pkg(name='documentationVersion', url='', help='"DocumentationVersion is the Schema for the DocumentationVersions API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"DocumentationVersionParameters defines the desired state of DocumentationVersion"'),
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description about the new documentation snapshot."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDocumentationVersion':: d.fn(help='"[Required] The version identifier of the new snapshot."', args=[d.arg(name='documentationVersion', type=d.T.string)]),
      withDocumentationVersion(documentationVersion): { spec+: { forProvider+: { documentationVersion: documentationVersion } } },
      '#withRegion':: d.fn(help='"Region is which region the DocumentationVersion will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withStageName':: d.fn(help='"The stage name to be associated with the new documentation snapshot."', args=[d.arg(name='stageName', type=d.T.string)]),
