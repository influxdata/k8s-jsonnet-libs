{
  ...
  '#':: d.pkg(name='stage', url='', help='"Stage is the Schema for the Stages API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"StageParameters defines the desired state of Stage"'),
    forProvider: {
      '#canarySettings':: d.obj(help='"CustomStageCanarySettings includes the custom field Stage.CanarySettings"'),
      canarySettings: {
        '#deploymentIdRef':: d.obj(help='"DeploymentIDRef is a reference to an Deployment used to set the DeploymentID."'),
        deploymentIdRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { canarySettings+: { deploymentIdRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { canarySettings+: { deploymentIdRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { canarySettings+: { deploymentIdRef+: { name: name } } } } },
        },
        '#deploymentIdSelector':: d.obj(help='"DeploymentIDSelector selects references to Deployment used to set the DeploymentID."'),
        deploymentIdSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { canarySettings+: { deploymentIdSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { canarySettings+: { deploymentIdSelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { canarySettings+: { deploymentIdSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { canarySettings+: { deploymentIdSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { canarySettings+: { deploymentIdSelector+: { matchLabels+: matchLabels } } } } },
        },
        '#withDeploymentId':: d.fn(help='"DeploymentID is the ID for the Deployment."', args=[d.arg(name='deploymentId', type=d.T.string)]),
        withDeploymentId(deploymentId): { spec+: { forProvider+: { canarySettings+: { deploymentId: deploymentId } } } },
        '#withPercentTraffic':: d.fn(help='', args=[d.arg(name='percentTraffic', type=d.T.number)]),
        withPercentTraffic(percentTraffic): { spec+: { forProvider+: { canarySettings+: { percentTraffic: percentTraffic } } } },
        '#withStageVariableOverrides':: d.fn(help='', args=[d.arg(name='stageVariableOverrides', type=d.T.object)]),
        ...
        '#withUseStageCache':: d.fn(help='', args=[d.arg(name='useStageCache', type=d.T.boolean)]),
      ...
      '#withCacheClusterEnabled':: d.fn(help='"Whether cache clustering is enabled for the stage."', args=[d.arg(name='cacheClusterEnabled', type=d.T.boolean)]),
      withCacheClusterEnabled(cacheClusterEnabled): { spec+: { forProvider+: { cacheClusterEnabled: cacheClusterEnabled } } },
      '#withCacheClusterSize':: d.fn(help="\"The stage's cache cluster size.\"", args=[d.arg(name='cacheClusterSize', type=d.T.string)]),
      ...
      '#withDescription':: d.fn(help='"The description of the Stage resource."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDocumentationVersion':: d.fn(help='"The version of the associated API documentation."', args=[d.arg(name='documentationVersion', type=d.T.string)]),
      withDocumentationVersion(documentationVersion): { spec+: { forProvider+: { documentationVersion: documentationVersion } } },
      '#withRegion':: d.fn(help='"Region is which region the Stage will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withStageName':: d.fn(help='"[Required] The name for the Stage resource. Stage names can only contain alphanumeric characters, hyphens, and underscores. Maximum length is 128 characters."', args=[d.arg(name='stageName', type=d.T.string)]),
      ...
      '#withTracingEnabled':: d.fn(help='"Specifies whether active tracing with X-ray is enabled for the Stage."', args=[d.arg(name='tracingEnabled', type=d.T.boolean)]),
      withTracingEnabled(tracingEnabled): { spec+: { forProvider+: { tracingEnabled: tracingEnabled } } },
      '#withVariables':: d.fn(help='"A map that defines the stage variables for the new Stage resource. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&=,]+."', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"A map that defines the stage variables for the new Stage resource. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&=,]+."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
