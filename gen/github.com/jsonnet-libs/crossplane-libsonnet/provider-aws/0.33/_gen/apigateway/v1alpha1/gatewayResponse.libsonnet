{
  ...
  '#':: d.pkg(name='gatewayResponse', url='', help='"GatewayResponse is the Schema for the GatewayResponses API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"GatewayResponseParameters defines the desired state of GatewayResponse"'),
    forProvider: {
      ...
      '#withRegion':: d.fn(help='"Region is which region the GatewayResponse will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withResponseParameters':: d.fn(help='"Response parameters (paths, query strings and headers) of the GatewayResponse as a string-to-string map of key-value pairs."', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParameters(responseParameters): { spec+: { forProvider+: { responseParameters: responseParameters } } },
      '#withResponseParametersMixin':: d.fn(help='"Response parameters (paths, query strings and headers) of the GatewayResponse as a string-to-string map of key-value pairs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParametersMixin(responseParameters): { spec+: { forProvider+: { responseParameters+: responseParameters } } },
      '#withResponseTemplates':: d.fn(help='"Response templates of the GatewayResponse as a string-to-string map of key-value pairs."', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplates(responseTemplates): { spec+: { forProvider+: { responseTemplates: responseTemplates } } },
      '#withResponseTemplatesMixin':: d.fn(help='"Response templates of the GatewayResponse as a string-to-string map of key-value pairs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplatesMixin(responseTemplates): { spec+: { forProvider+: { responseTemplates+: responseTemplates } } },
      '#withResponseType':: d.fn(help='"[Required] The response type of the associated GatewayResponse."', args=[d.arg(name='responseType', type=d.T.string)]),
      ...
      '#withStatusCode':: d.fn(help='"The HTTP status code of the GatewayResponse."', args=[d.arg(name='statusCode', type=d.T.string)]),
