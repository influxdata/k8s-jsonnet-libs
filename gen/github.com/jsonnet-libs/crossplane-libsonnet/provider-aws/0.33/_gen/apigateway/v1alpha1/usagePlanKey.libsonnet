{
  ...
  '#':: d.pkg(name='usagePlanKey', url='', help='"UsagePlanKey is the Schema for the UsagePlanKeys API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"UsagePlanKeyParameters defines the desired state of UsagePlanKey"'),
    forProvider: {
      '#restApiIdRef':: d.obj(help='"UsagePlanIDRef is a reference to an UsagePlan used to set the UsagePlanID."'),
      restApiIdRef: {
      ...
      '#restApiIdSelector':: d.obj(help='"UsagePlanIdSelector selects references to UsagePlan used to set the UsagePlanID."'),
      restApiIdSelector: {
      ...
      '#withKeyID':: d.fn(help='"[Required] The identifier of a UsagePlanKey resource for a plan customer."', args=[d.arg(name='keyID', type=d.T.string)]),
      withKeyID(keyID): { spec+: { forProvider+: { keyID: keyID } } },
      '#withKeyType':: d.fn(help='"[Required] The type of a UsagePlanKey resource for a plan customer."', args=[d.arg(name='keyType', type=d.T.string)]),
      withKeyType(keyType): { spec+: { forProvider+: { keyType: keyType } } },
      '#withRegion':: d.fn(help='"Region is which region the UsagePlanKey will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRestApiId':: d.fn(help='"UsagePlanID is the ID for the UsagePlan."', args=[d.arg(name='restApiId', type=d.T.string)]),
