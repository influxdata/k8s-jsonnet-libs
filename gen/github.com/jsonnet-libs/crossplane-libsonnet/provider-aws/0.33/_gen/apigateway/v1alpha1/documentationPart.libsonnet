{
  ...
  '#':: d.pkg(name='documentationPart', url='', help='"DocumentationPart is the Schema for the DocumentationParts API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"DocumentationPartParameters defines the desired state of DocumentationPart"'),
    forProvider: {
      '#location':: d.obj(help='"[Required] The location of the targeted API entity of the to-be-created documentation part."'),
      location: {
        ...
        withType_(type_): { spec+: { forProvider+: { location+: { type_: type_ } } } },
      },
      ...
      '#withProperties':: d.fn(help='"[Required] The new documentation content map of the targeted API entity. Enclosed key-value pairs are API-specific, but only OpenAPI-compliant key-value pairs can be exported and, hence, published."', args=[d.arg(name='properties', type=d.T.string)]),
      withProperties(properties): { spec+: { forProvider+: { properties: properties } } },
      '#withRegion':: d.fn(help='"Region is which region the DocumentationPart will be created."', args=[d.arg(name='region', type=d.T.string)]),
