{
  ...
  '#':: d.pkg(name='resource', url='', help='"Resource is the Schema for the Resources API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"ResourceParameters defines the desired state of Resource"'),
    forProvider: {
      '#parentResourceIdRef':: d.obj(help='"ParentIDRef is a reference to an Parent used to set the ParentID."'),
      parentResourceIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { parentResourceIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { parentResourceIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { parentResourceIdRef+: { name: name } } } },
      },
      '#parentResourceIdSelector':: d.obj(help='"RestApiIdSelector selects references to Parent used to set the ParentID."'),
      parentResourceIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { parentResourceIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { parentResourceIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { parentResourceIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { parentResourceIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { parentResourceIdSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withParentResourceId':: d.fn(help='"ParentID is the ID for the Parent."', args=[d.arg(name='parentResourceId', type=d.T.string)]),
      withParentResourceId(parentResourceId): { spec+: { forProvider+: { parentResourceId: parentResourceId } } },
      '#withPathPart':: d.fn(help='"The last path segment for this resource."', args=[d.arg(name='pathPart', type=d.T.string)]),
      withPathPart(pathPart): { spec+: { forProvider+: { pathPart: pathPart } } },
      '#withRegion':: d.fn(help='"Region is which region the Resource will be created."', args=[d.arg(name='region', type=d.T.string)]),
