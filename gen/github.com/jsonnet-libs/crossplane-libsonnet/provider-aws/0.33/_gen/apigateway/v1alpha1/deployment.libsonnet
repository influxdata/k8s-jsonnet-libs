{
  ...
  '#':: d.pkg(name='deployment', url='', help='"Deployment is the Schema for the Deployments API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"DeploymentParameters defines the desired state of Deployment"'),
    forProvider: {
      '#canarySettings':: d.obj(help='"The input configuration for the canary deployment when the deployment is a canary release deployment."'),
      canarySettings: {
      ...
      '#withCacheClusterEnabled':: d.fn(help='"Enables a cache cluster for the Stage resource specified in the input."', args=[d.arg(name='cacheClusterEnabled', type=d.T.boolean)]),
      withCacheClusterEnabled(cacheClusterEnabled): { spec+: { forProvider+: { cacheClusterEnabled: cacheClusterEnabled } } },
      '#withCacheClusterSize':: d.fn(help='"Specifies the cache cluster size for the Stage resource specified in the input, if a cache cluster is enabled."', args=[d.arg(name='cacheClusterSize', type=d.T.string)]),
      withCacheClusterSize(cacheClusterSize): { spec+: { forProvider+: { cacheClusterSize: cacheClusterSize } } },
      '#withDescription':: d.fn(help='"The description for the Deployment resource to create."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withRegion':: d.fn(help='"Region is which region the Deployment will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withStageDescription':: d.fn(help='"The description of the Stage resource for the Deployment resource to create."', args=[d.arg(name='stageDescription', type=d.T.string)]),
      withStageDescription(stageDescription): { spec+: { forProvider+: { stageDescription: stageDescription } } },
      '#withStageName':: d.fn(help='"The name of the Stage resource for the Deployment resource to create."', args=[d.arg(name='stageName', type=d.T.string)]),
      ...
      '#withVariables':: d.fn(help='"A map that defines the stage variables for the Stage resource that is associated with the new deployment. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&=,]+."', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"A map that defines the stage variables for the Stage resource that is associated with the new deployment. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&=,]+."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
