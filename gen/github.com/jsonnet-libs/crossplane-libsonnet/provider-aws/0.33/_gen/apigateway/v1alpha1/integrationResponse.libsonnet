{
  ...
  '#':: d.pkg(name='integrationResponse', url='', help='"IntegrationResponse is the Schema for the IntegrationResponses API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"IntegrationResponseParameters defines the desired state of IntegrationResponse"'),
    forProvider: {
      ...
      '#withContentHandling':: d.fn(help='"Specifies how to handle response payload content type conversions. Supported values are CONVERT_TO_BINARY and CONVERT_TO_TEXT, with the following behaviors: \\n * CONVERT_TO_BINARY: Converts a response payload from a Base64-encoded string to the corresponding binary blob. \\n * CONVERT_TO_TEXT: Converts a response payload from a binary blob to a Base64-encoded string. \\n If this property is not defined, the response payload will be passed through from the integration response to the method response without modification."', args=[d.arg(name='contentHandling', type=d.T.string)]),
      withContentHandling(contentHandling): { spec+: { forProvider+: { contentHandling: contentHandling } } },
      '#withHttpMethod':: d.fn(help="\"[Required] Specifies a put integration response request's HTTP method.\"", args=[d.arg(name='httpMethod', type=d.T.string)]),
      withHttpMethod(httpMethod): { spec+: { forProvider+: { httpMethod: httpMethod } } },
      '#withRegion':: d.fn(help='"Region is which region the IntegrationResponse will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withSelectionPattern':: d.fn(help='"Specifies the selection pattern of a put integration response."', args=[d.arg(name='selectionPattern', type=d.T.string)]),
      withSelectionPattern(selectionPattern): { spec+: { forProvider+: { selectionPattern: selectionPattern } } },
      '#withStatusCode':: d.fn(help='"[Required] Specifies the status code that is used to map the integration response to an existing MethodResponse."', args=[d.arg(name='statusCode', type=d.T.string)]),
