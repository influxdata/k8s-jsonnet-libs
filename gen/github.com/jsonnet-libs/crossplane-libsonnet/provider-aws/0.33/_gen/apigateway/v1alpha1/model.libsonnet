{
  ...
  '#':: d.pkg(name='model', url='', help='"Model is the Schema for the Models API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"ModelParameters defines the desired state of Model"'),
    forProvider: {
      ...
      '#withContentType':: d.fn(help='"[Required] The content-type for the model."', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { forProvider+: { contentType: contentType } } },
      '#withDescription':: d.fn(help='"The description of the model."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"[Required] The name of the model. Must be alphanumeric."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the Model will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withSchema':: d.fn(help='"The schema for the model. For application/json models, this should be JSON schema draft 4 (https://tools.ietf.org/html/draft-zyp-json-schema-04) model."', args=[d.arg(name='schema', type=d.T.string)]),
