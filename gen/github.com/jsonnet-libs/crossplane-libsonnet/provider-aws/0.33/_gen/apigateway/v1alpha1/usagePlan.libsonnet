{
  ...
  '#':: d.pkg(name='usagePlan', url='', help='"UsagePlan is the Schema for the UsagePlans API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"UsagePlanParameters defines the desired state of UsagePlan"'),
    forProvider: {
      '#quota':: d.obj(help='"The quota of the usage plan."'),
      quota: {
        '#withLimit':: d.fn(help='', args=[d.arg(name='limit', type=d.T.integer)]),
        withLimit(limit): { spec+: { forProvider+: { quota+: { limit: limit } } } },
        '#withOffset':: d.fn(help='', args=[d.arg(name='offset', type=d.T.integer)]),
        withOffset(offset): { spec+: { forProvider+: { quota+: { offset: offset } } } },
        '#withPeriod':: d.fn(help='', args=[d.arg(name='period', type=d.T.string)]),
        withPeriod(period): { spec+: { forProvider+: { quota+: { period: period } } } },
      },
      '#throttle':: d.obj(help='"The throttling limits of the usage plan."'),
      throttle: {
        '#withBurstLimit':: d.fn(help='', args=[d.arg(name='burstLimit', type=d.T.integer)]),
        withBurstLimit(burstLimit): { spec+: { forProvider+: { throttle+: { burstLimit: burstLimit } } } },
        '#withRateLimit':: d.fn(help='', args=[d.arg(name='rateLimit', type=d.T.number)]),
        withRateLimit(rateLimit): { spec+: { forProvider+: { throttle+: { rateLimit: rateLimit } } } },
      },
      '#withApiStages':: d.fn(help='"The associated API stages of the usage plan."', args=[d.arg(name='apiStages', type=d.T.array)]),
      withApiStages(apiStages): { spec+: { forProvider+: { apiStages: if std.isArray(v=apiStages) then apiStages else [apiStages] } } },
      '#withApiStagesMixin':: d.fn(help='"The associated API stages of the usage plan."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='apiStages', type=d.T.array)]),
      withApiStagesMixin(apiStages): { spec+: { forProvider+: { apiStages+: if std.isArray(v=apiStages) then apiStages else [apiStages] } } },
      '#withDescription':: d.fn(help='"The description of the usage plan."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"[Required] The name of the usage plan."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the UsagePlan will be created."', args=[d.arg(name='region', type=d.T.string)]),
