{
  ...
  '#':: d.pkg(name='vpcLink', url='', help='"VPCLink is the Schema for the VPCLinks API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the VPC link."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"[Required] The name used to label and identify the VPC link."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the VPCLink will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withTargetARNs':: d.fn(help='"[Required] The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner."', args=[d.arg(name='targetARNs', type=d.T.array)]),
      withTargetARNs(targetARNs): { spec+: { forProvider+: { targetARNs: if std.isArray(v=targetARNs) then targetARNs else [targetARNs] } } },
      '#withTargetARNsMixin':: d.fn(help='"[Required] The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetARNs', type=d.T.array)]),
