{
  ...
  '#':: d.pkg(name='apiKey', url='', help='"APIKey is the Schema for the APIKeys API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"APIKeyParameters defines the desired state of APIKey"'),
    forProvider: {
      '#withCustomerID':: d.fn(help='"An AWS Marketplace customer identifier , when integrating with the AWS SaaS Marketplace."', args=[d.arg(name='customerID', type=d.T.string)]),
      withCustomerID(customerID): { spec+: { forProvider+: { customerID: customerID } } },
      '#withDescription':: d.fn(help='"The description of the ApiKey."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnabled':: d.fn(help='"Specifies whether the ApiKey can be used by callers."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withGenerateDistinctID':: d.fn(help='"Specifies whether (true) or not (false) the key identifier is distinct from the created API key value. This parameter is deprecated and should not be used."', args=[d.arg(name='generateDistinctID', type=d.T.boolean)]),
      withGenerateDistinctID(generateDistinctID): { spec+: { forProvider+: { generateDistinctID: generateDistinctID } } },
      '#withName':: d.fn(help='"The name of the ApiKey."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the APIKey will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withValue':: d.fn(help='"Specifies a value of the API key."', args=[d.arg(name='value', type=d.T.string)]),
