{
  ...
  '#':: d.pkg(name='requestValidator', url='', help='"RequestValidator is the Schema for the RequestValidators API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"RequestValidatorParameters defines the desired state of RequestValidator"'),
    forProvider: {
      ...
      '#withName':: d.fn(help='"The name of the to-be-created RequestValidator."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the RequestValidator will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withValidateRequestBody':: d.fn(help='"A Boolean flag to indicate whether to validate request body according to the configured model schema for the method (true) or not (false)."', args=[d.arg(name='validateRequestBody', type=d.T.boolean)]),
      withValidateRequestBody(validateRequestBody): { spec+: { forProvider+: { validateRequestBody: validateRequestBody } } },
      '#withValidateRequestParameters':: d.fn(help='"A Boolean flag to indicate whether to validate request parameters, true, or not false."', args=[d.arg(name='validateRequestParameters', type=d.T.boolean)]),
