{
  ...
  '#':: d.pkg(name='basePathMapping', url='', help='"BasePathMapping is the Schema for the BasePathMappings API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"BasePathMappingParameters defines the desired state of BasePathMapping"'),
    forProvider: {
      ...
      '#withBasePath':: d.fn(help="\"The base path name that callers of the API must provide as part of the URL after the domain name. This value must be unique for all of the mappings across a single API. Specify '(none)' if you do not want callers to specify a base path name after the domain name.\"", args=[d.arg(name='basePath', type=d.T.string)]),
      withBasePath(basePath): { spec+: { forProvider+: { basePath: basePath } } },
      '#withDomainName':: d.fn(help='"[Required] The domain name of the BasePathMapping resource to create."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withRegion':: d.fn(help='"Region is which region the BasePathMapping will be created."', args=[d.arg(name='region', type=d.T.string)]),
      ...
      '#withStage':: d.fn(help="\"The name of the API's stage that you want to use for this mapping. Specify '(none)' if you want callers to explicitly specify the stage name after any base path name.\"", args=[d.arg(name='stage', type=d.T.string)]),
