{
  ...
  spec: {
    ...
    forProvider: {
      '#withDbParameterGroupFamily':: d.fn(help='"The cluster parameter group family name."', args=[d.arg(name='dbParameterGroupFamily', type=d.T.string)]),
      withDbParameterGroupFamily(dbParameterGroupFamily): { spec+: { forProvider+: { dbParameterGroupFamily: dbParameterGroupFamily } } },
      '#withDescription':: d.fn(help='"The description for the cluster parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withTags':: d.fn(help='"The tags to be assigned to the cluster parameter group."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"The tags to be assigned to the cluster parameter group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
