{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoMinorVersionUpgrade':: d.fn(help='"This parameter does not apply to Amazon DocumentDB. Amazon DocumentDB does not perform minor version upgrades regardless of the value set. \\n Default: false"', args=[d.arg(name='autoMinorVersionUpgrade', type=d.T.boolean)]),
