{
  ...
  '#':: d.pkg(name='httpNamespace', url='', help='"HTTPNamespace is the Schema for the HTTPNamespaces API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"HTTPNamespaceParameters defines the desired state of HTTPNamespace"'),
    forProvider: {
      ...
      '#withRegion':: d.fn(help='"Region is which region the HTTPNamespace will be created."', args=[d.arg(name='region', type=d.T.string)]),
