{
  ...
  '#':: d.pkg(name='privateDNSNamespace', url='', help='"PrivateDNSNamespace is the Schema for the PrivateDNSNamespaces API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"PrivateDNSNamespaceParameters defines the desired state of PrivateDNSNamespace"'),
    forProvider: {
      '#properties':: d.obj(help='"Properties for the private DNS namespace."'),
      properties: {
        '#dnsProperties':: d.obj(help='"DNS properties for the private DNS namespace."'),
        dnsProperties: {
          '#sOA':: d.obj(help='"Start of Authority (SOA) properties for a public or private DNS namespace."'),
          sOA: {
            '#withTTL':: d.fn(help='', args=[d.arg(name='tTL', type=d.T.integer)]),
            withTTL(tTL): { spec+: { forProvider+: { properties+: { dnsProperties+: { sOA+: { tTL: tTL } } } } } },
          },
        },
      },
      '#vpcRef':: d.obj(help='"A referencer to retrieve the ID of a VPC"'),
      vpcRef: {
      ...
      '#vpcSelector':: d.obj(help='"A selector to select a referencer to retrieve the ID of a VPC."'),
      vpcSelector: {
      ...
      '#withName':: d.fn(help='"The name that you want to assign to this namespace. When you create a private DNS namespace, Cloud Map automatically creates an Amazon Route 53 private hosted zone that has the same name as the namespace."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the PrivateDNSNamespace will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"The tags to add to the namespace. Each tag consists of a key and an optional value that you define. Tags keys can be up to 128 characters in length, and tag values can be up to 256 characters in length."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"The tags to add to the namespace. Each tag consists of a key and an optional value that you define. Tags keys can be up to 128 characters in length, and tag values can be up to 256 characters in length."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: if std.isArray(v=tags) then tags else [tags] } } },
      '#withVpc':: d.fn(help='"VPC of the PrivateDNSNamespace. One if vpc, vpcRef or vpcSelector has to be supplied."', args=[d.arg(name='vpc', type=d.T.string)]),
