{
  ...
  spec: {
    ...
    forProvider: {
      '#withPolicyDocument':: d.fn(help='"The JSON document that describes the policy. policyDocument must have a minimum length of 1, with a maximum length of 2048, excluding whitespace."', args=[d.arg(name='policyDocument', type=d.T.string)]),
      withPolicyDocument(policyDocument): { spec+: { forProvider+: { policyDocument: policyDocument } } },
      '#withRegion':: d.fn(help='"Region is which region the Policy will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"Metadata which can be used to manage the policy. \\n For URI Request parameters use format: ...key1=value1&key2=value2... \\n For the CLI command-line parameter use format: &&tags \\"key1=value1&key2=value2...\\" \\n For the cli-input-json file use format: \\"tags\\": \\"key1=value1&key2=value2...\\', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"Metadata which can be used to manage the policy. \\n For URI Request parameters use format: ...key1=value1&key2=value2... \\n For the CLI command-line parameter use format: &&tags \\"key1=value1&key2=value2...\\" \\n For the cli-input-json file use format: \\"tags\\": \\"key1=value1&key2=value2...\\\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
