{
  ...
  '#':: d.pkg(name='thing', url='', help='"Thing is the Schema for the Things API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#attributePayload':: d.obj(help='"The attribute payload, which consists of up to three name/value pairs in a JSON document. For example: \\n {\\\\\\"attributes\\\\\\":{\\\\\\"string1\\\\\\":\\\\\\"string2\\\\\\"}}"'),
      attributePayload: {
        '#withAttributes':: d.fn(help='', args=[d.arg(name='attributes', type=d.T.object)]),
        withAttributes(attributes): { spec+: { forProvider+: { attributePayload+: { attributes: attributes } } } },
        ...
        withAttributesMixin(attributes): { spec+: { forProvider+: { attributePayload+: { attributes+: attributes } } } },
        '#withMerge':: d.fn(help='', args=[d.arg(name='merge', type=d.T.boolean)]),
        withMerge(merge): { spec+: { forProvider+: { attributePayload+: { merge: merge } } } },
      },
      '#withBillingGroupName':: d.fn(help='"The name of the billing group the thing will be added to."', args=[d.arg(name='billingGroupName', type=d.T.string)]),
      withBillingGroupName(billingGroupName): { spec+: { forProvider+: { billingGroupName: billingGroupName } } },
      '#withRegion':: d.fn(help='"Region is which region the Thing will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withThingTypeName':: d.fn(help='"The name of the thing type associated with the new thing."', args=[d.arg(name='thingTypeName', type=d.T.string)]),
