{
  ...
  '#':: d.pkg(name='identityProviderConfig', url='', help='"An IdentityProviderConfig is a managed resource that represents an AWS Elastic Kubernetes Service IdentityProviderConfig."'),
  ...
  '#spec':: d.obj(help='"A IdentityProviderConfigSpec defines the desired state of an EKS identity provider."'),
  spec: {
    '#forProvider':: d.obj(help='"IdentityProviderConfigParameters define the desired state of an AWS Elastic Kubernetes Service Identity Provider."'),
    forProvider: {
      ...
      '#oidc':: d.obj(help='"An object that represents an OpenID Connect (OIDC) identity provider configuration."'),
      oidc: {
        ...
        '#withGroupsPrefix':: d.fn(help='"The prefix that is prepended to group claims to prevent clashes with existing names (such as system: groups). For example, the value oidc: will create group names like oidc:engineering and oidc:infra."', args=[d.arg(name='groupsPrefix', type=d.T.string)]),
      ...
      '#withClusterName':: d.fn(help='"The name of the cluster to associate the identity provider with."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like the identity provider to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"The metadata to apply to the configuration to assist with categorization and organization. Each tag consists of a key and an optional value, both of which you define."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"The metadata to apply to the configuration to assist with categorization and organization. Each tag consists of a key and an optional value, both of which you define."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
