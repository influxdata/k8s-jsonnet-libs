{
  ...
  '#':: d.pkg(name='addon', url='', help='"Addon is the Schema for the Addons API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"AddonParameters defines the desired state of Addon"'),
    forProvider: {
      ...
      '#withAddonName':: d.fn(help='"The name of the add-on. The name must match one of the names returned by DescribeAddonVersions (https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html)."', args=[d.arg(name='addonName', type=d.T.string)]),
      withAddonName(addonName): { spec+: { forProvider+: { addonName: addonName } } },
      '#withAddonVersion':: d.fn(help='"The version of the add-on. The version must match one of the versions returned by DescribeAddonVersions (https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html)."', args=[d.arg(name='addonVersion', type=d.T.string)]),
      withAddonVersion(addonVersion): { spec+: { forProvider+: { addonVersion: addonVersion } } },
      '#withClusterName':: d.fn(help='"The name of the cluster to create the add-on for."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withRegion':: d.fn(help='"Region is which region the Addon will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withResolveConflicts':: d.fn(help='"How to resolve parameter value conflicts when migrating an existing add-on to an Amazon EKS add-on."', args=[d.arg(name='resolveConflicts', type=d.T.string)]),
      withResolveConflicts(resolveConflicts): { spec+: { forProvider+: { resolveConflicts: resolveConflicts } } },
      '#withServiceAccountRoleARN':: d.fn(help="\"The Amazon Resource Name (ARN) of an existing IAM role to bind to the add-on's service account. The role must be assigned the IAM permissions required by the add-on. If you don't specify an existing IAM role, then the add-on uses the permissions assigned to the node IAM role. For more information, see Amazon EKS node IAM role (https://docs.aws.amazon.com/eks/latest/userguide/create-node-role.html) in the Amazon EKS User Guide. \\n To specify an existing IAM role, you must have an IAM OpenID Connect (OIDC) provider created for your cluster. For more information, see Enabling IAM roles for service accounts on your cluster (https://docs.aws.amazon.com/eks/latest/userguide/enable-iam-roles-for-service-accounts.html) in the Amazon EKS User Guide.\"", args=[d.arg(name='serviceAccountRoleARN', type=d.T.string)]),
