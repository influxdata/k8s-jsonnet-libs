{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#imageConfig':: d.obj(help='"Container image configuration values (https://docs.aws.amazon.com/lambda/latest/dg/configuration-images.html#configuration-images-settings) that override the values in the container image Dockerfile."'),
      imageConfig: {
      ...
      '#tracingConfig':: d.obj(help='"Set Mode to Active to sample and trace a subset of incoming requests with X-Ray (https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html)."'),
      tracingConfig: {
      ...
      '#withArchitectures':: d.fn(help='"The instruction set architecture that the function supports. Enter a string array with one of the valid values. The default value is x86_64."', args=[d.arg(name='architectures', type=d.T.array)]),
      ...
      '#withArchitecturesMixin':: d.fn(help='"The instruction set architecture that the function supports. Enter a string array with one of the valid values. The default value is x86_64."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='architectures', type=d.T.array)]),
      ...
      '#withKmsKeyARN':: d.fn(help="\"The ARN of the Amazon Web Services Key Management Service (KMS) key that's used to encrypt your function's environment variables. If it's not provided, Lambda uses a default service key.\"", args=[d.arg(name='kmsKeyARN', type=d.T.string)]),
