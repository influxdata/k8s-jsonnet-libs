{
  ...
  '#':: d.pkg(name='permission', url='', help='"A Permission is a managed resource that represents a AWS Lambda Permission."'),
  ...
  '#spec':: d.obj(help='"A PermissionSpec defines the desired state of a Permission."'),
  spec: {
    '#forProvider':: d.obj(help='"PermissionParameters define the desired state of a Lambda Permission"'),
    forProvider: {
      '#functionNameRef':: d.obj(help='"FunctionNameRef is a reference to a function used to set the FunctionName."'),
      functionNameRef: {
      ...
      '#functionNameSelector':: d.obj(help='"FunctionNameSelector selects references to function used to set the FunctionName."'),
      ...
      '#withAction':: d.fn(help='"The action that the principal can use on the function. For example, lambda:InvokeFunction or lambda:GetFunction. \\n This member is required."', args=[d.arg(name='action', type=d.T.string)]),
      withAction(action): { spec+: { forProvider+: { action: action } } },
      '#withEventSourceToken':: d.fn(help='"For Alexa Smart Home functions, a token that must be supplied by the invoker."', args=[d.arg(name='eventSourceToken', type=d.T.string)]),
      withEventSourceToken(eventSourceToken): { spec+: { forProvider+: { eventSourceToken: eventSourceToken } } },
      '#withFunctionName':: d.fn(help='"The name of the Lambda function, version, or alias. Name formats \\n * Function name - my-function (name-only), my-function:v1 (with alias). \\n * Function ARN - arn:aws:lambda:us-west-2:123456789012:function:my-function. \\n * Partial ARN - 123456789012:function:my-function. \\n You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length. \\n This member is required."', args=[d.arg(name='functionName', type=d.T.string)]),
      withFunctionName(functionName): { spec+: { forProvider+: { functionName: functionName } } },
      '#withPrincipal':: d.fn(help='"The Amazon Web Services service or account that invokes the function. If you specify a service, use SourceArn or SourceAccount to limit who can invoke the function through that service. \\n This member is required."', args=[d.arg(name='principal', type=d.T.string)]),
      withPrincipal(principal): { spec+: { forProvider+: { principal: principal } } },
      '#withPrincipalOrgId':: d.fn(help='"The identifier for your organization in Organizations. Use this to grant permissions to all the Amazon Web Services accounts under this organization."', args=[d.arg(name='principalOrgId', type=d.T.string)]),
      ...
      '#withSourceARN':: d.fn(help='"For Amazon Web Services services, the ARN of the Amazon Web Services resource that invokes the function. For example, an Amazon S3 bucket or Amazon SNS topic. Note that Lambda configures the comparison using the StringLike operator."', args=[d.arg(name='sourceARN', type=d.T.string)]),
      withSourceARN(sourceARN): { spec+: { forProvider+: { sourceARN: sourceARN } } },
      '#withSourceAccount':: d.fn(help='"For Amazon S3, the ID of the account that owns the resource. Use this together with SourceArn to ensure that the resource is owned by the specified account. It is possible for an Amazon S3 bucket to be deleted by its owner and recreated by another account."', args=[d.arg(name='sourceAccount', type=d.T.string)]),
