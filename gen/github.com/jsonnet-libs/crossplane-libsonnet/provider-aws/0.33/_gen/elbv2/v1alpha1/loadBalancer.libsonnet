{
  ...
  '#':: d.pkg(name='loadBalancer', url='', help='"LoadBalancer is the Schema for the LoadBalancers API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadBalancer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#securityGroupRefs':: d.obj(help='"Reference to Security Groups for SecurityGroups field"'),
      securityGroupRefs: {
      ...
      '#securityGroupSelector':: d.obj(help='"Selector for references to SecurityGroups"'),
      ...
      '#subnetMappings':: d.obj(help='"The IDs of the public subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings. \\n [Application Load Balancers] You must specify subnets from at least two Availability Zones. You cannot specify Elastic IP addresses for your subnets. \\n [Application Load Balancers on Outposts] You must specify one Outpost subnet. \\n [Application Load Balancers on Local Zones] You can specify subnets from one or more Local Zones. \\n [Network Load Balancers] You can specify subnets from one or more Availability Zones. You can specify one Elastic IP address per subnet if you need static IP addresses for your internet-facing load balancer. For internal load balancers, you can specify one private IP address per subnet from the IPv4 range of the subnet. For internet-facing load balancer, you can specify one IPv6 address per subnet. \\n [Gateway Load Balancers] You can specify subnets from one or more Availability Zones. You cannot specify Elastic IP addresses for your subnets."'),
      subnetMappings: {
        '#withAllocationID':: d.fn(help='', args=[d.arg(name='allocationID', type=d.T.string)]),
        ...
        '#withPrivateIPv4Address':: d.fn(help='', args=[d.arg(name='privateIPv4Address', type=d.T.string)]),
      ...
      '#subnetRefs':: d.obj(help='"Reference to Subnets for Subnets field"'),
      subnetRefs: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#subnetSelector':: d.obj(help='"Selector for references to Subnets"'),
      subnetSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#tags':: d.obj(help='"The tags to assign to the load balancer."'),
      tags: {
      ...
      '#withCustomerOwnedIPv4Pool':: d.fn(help='"[Application Load Balancers on Outposts] The ID of the customer-owned address pool (CoIP pool)."', args=[d.arg(name='customerOwnedIPv4Pool', type=d.T.string)]),
      withCustomerOwnedIPv4Pool(customerOwnedIPv4Pool): { spec+: { forProvider+: { customerOwnedIPv4Pool: customerOwnedIPv4Pool } } },
      '#withIpAddressType':: d.fn(help='"The type of IP addresses used by the subnets for your load balancer. The possible values are ipv4 (for IPv4 addresses) and dualstack (for IPv4 and IPv6 addresses). Internal load balancers must use ipv4."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
      withIpAddressType(ipAddressType): { spec+: { forProvider+: { ipAddressType: ipAddressType } } },
      '#withLoadBalancerType':: d.fn(help='"The type of load balancer. The default is application."', args=[d.arg(name='loadBalancerType', type=d.T.string)]),
      withLoadBalancerType(loadBalancerType): { spec+: { forProvider+: { loadBalancerType: loadBalancerType } } },
      '#withName':: d.fn(help='"The name of the load balancer. \\n This name must be unique per region per account, can have a maximum of 32 characters, must contain only alphanumeric characters or hyphens, must not begin or end with a hyphen, and must not begin with \\"internal-\\"."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the LoadBalancer will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withScheme':: d.fn(help='"The nodes of an Internet-facing load balancer have public IP addresses. The DNS name of an Internet-facing load balancer is publicly resolvable to the public IP addresses of the nodes. Therefore, Internet-facing load balancers can route requests from clients over the internet. \\n The nodes of an internal load balancer have only private IP addresses. The DNS name of an internal load balancer is publicly resolvable to the private IP addresses of the nodes. Therefore, internal load balancers can route requests only from clients with access to the VPC for the load balancer. \\n The default is an Internet-facing load balancer. \\n You cannot specify a scheme for a Gateway Load Balancer."', args=[d.arg(name='scheme', type=d.T.string)]),
      withScheme(scheme): { spec+: { forProvider+: { scheme: scheme } } },
      '#withSecurityGroupRefs':: d.fn(help='"Reference to Security Groups for SecurityGroups field"', args=[d.arg(name='securityGroupRefs', type=d.T.array)]),
      ...
      '#withSecurityGroups':: d.fn(help='"[Application Load Balancers] The IDs of the security groups for the load balancer."', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSecurityGroupsMixin':: d.fn(help='"[Application Load Balancers] The IDs of the security groups for the load balancer."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSubnetMappings':: d.fn(help='"The IDs of the public subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings. \\n [Application Load Balancers] You must specify subnets from at least two Availability Zones. You cannot specify Elastic IP addresses for your subnets. \\n [Application Load Balancers on Outposts] You must specify one Outpost subnet. \\n [Application Load Balancers on Local Zones] You can specify subnets from one or more Local Zones. \\n [Network Load Balancers] You can specify subnets from one or more Availability Zones. You can specify one Elastic IP address per subnet if you need static IP addresses for your internet-facing load balancer. For internal load balancers, you can specify one private IP address per subnet from the IPv4 range of the subnet. For internet-facing load balancer, you can specify one IPv6 address per subnet. \\n [Gateway Load Balancers] You can specify subnets from one or more Availability Zones. You cannot specify Elastic IP addresses for your subnets."', args=[d.arg(name='subnetMappings', type=d.T.array)]),
      withSubnetMappings(subnetMappings): { spec+: { forProvider+: { subnetMappings: if std.isArray(v=subnetMappings) then subnetMappings else [subnetMappings] } } },
      '#withSubnetMappingsMixin':: d.fn(help='"The IDs of the public subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings. \\n [Application Load Balancers] You must specify subnets from at least two Availability Zones. You cannot specify Elastic IP addresses for your subnets. \\n [Application Load Balancers on Outposts] You must specify one Outpost subnet. \\n [Application Load Balancers on Local Zones] You can specify subnets from one or more Local Zones. \\n [Network Load Balancers] You can specify subnets from one or more Availability Zones. You can specify one Elastic IP address per subnet if you need static IP addresses for your internet-facing load balancer. For internal load balancers, you can specify one private IP address per subnet from the IPv4 range of the subnet. For internet-facing load balancer, you can specify one IPv6 address per subnet. \\n [Gateway Load Balancers] You can specify subnets from one or more Availability Zones. You cannot specify Elastic IP addresses for your subnets."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetMappings', type=d.T.array)]),
      withSubnetMappingsMixin(subnetMappings): { spec+: { forProvider+: { subnetMappings+: if std.isArray(v=subnetMappings) then subnetMappings else [subnetMappings] } } },
      '#withSubnetRefs':: d.fn(help='"Reference to Subnets for Subnets field"', args=[d.arg(name='subnetRefs', type=d.T.array)]),
      withSubnetRefs(subnetRefs): { spec+: { forProvider+: { subnetRefs: if std.isArray(v=subnetRefs) then subnetRefs else [subnetRefs] } } },
      '#withSubnetRefsMixin':: d.fn(help='"Reference to Subnets for Subnets field"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetRefs', type=d.T.array)]),
      withSubnetRefsMixin(subnetRefs): { spec+: { forProvider+: { subnetRefs+: if std.isArray(v=subnetRefs) then subnetRefs else [subnetRefs] } } },
      '#withSubnets':: d.fn(help='"The IDs of the public subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings. \\n [Application Load Balancers] You must specify subnets from at least two Availability Zones. \\n [Application Load Balancers on Outposts] You must specify one Outpost subnet. \\n [Application Load Balancers on Local Zones] You can specify subnets from one or more Local Zones. \\n [Network Load Balancers] You can specify subnets from one or more Availability Zones. \\n [Gateway Load Balancers] You can specify subnets from one or more Availability Zones."', args=[d.arg(name='subnets', type=d.T.array)]),
      withSubnets(subnets): { spec+: { forProvider+: { subnets: if std.isArray(v=subnets) then subnets else [subnets] } } },
      '#withSubnetsMixin':: d.fn(help='"The IDs of the public subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings. \\n [Application Load Balancers] You must specify subnets from at least two Availability Zones. \\n [Application Load Balancers on Outposts] You must specify one Outpost subnet. \\n [Application Load Balancers on Local Zones] You can specify subnets from one or more Local Zones. \\n [Network Load Balancers] You can specify subnets from one or more Availability Zones. \\n [Gateway Load Balancers] You can specify subnets from one or more Availability Zones."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnets', type=d.T.array)]),
      withSubnetsMixin(subnets): { spec+: { forProvider+: { subnets+: if std.isArray(v=subnets) then subnets else [subnets] } } },
      '#withTags':: d.fn(help='"The tags to assign to the load balancer."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"The tags to assign to the load balancer."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
