{
  ...
  '#':: d.pkg(name='target', url='', help='"Target is the Schema for registering a target to an ELBV2 TargetGroup."'),
  ...
  '#spec':: d.obj(help='"TargetSpec defines the desired state of a Target"'),
  spec: {
    '#forProvider':: d.obj(help='"TargetParameters defines the desired state of a Target"'),
    forProvider: {
      '#lambdaArnRef':: d.obj(help='"LambdaARNRef references a Lambda Function to set LambdaARN."'),
      lambdaArnRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { lambdaArnRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { lambdaArnRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { lambdaArnRef+: { name: name } } } },
      },
      '#lambdaArnSelector':: d.obj(help='"LambdaARNSelector references a Lambda Function to set LambdaARN."'),
      lambdaArnSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { lambdaArnSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { lambdaArnSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { lambdaArnSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { lambdaArnSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { lambdaArnSelector+: { matchLabels+: matchLabels } } } },
      },
      '#targetGroupArnRef':: d.obj(help='"TargetGroupARNRef selects a ELBv2 TargetGroupARN with the given name."'),
      targetGroupArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#targetGroupArnSelector':: d.obj(help='"TargetGroupARNSelector selects a ELBv2 TargetGroupARN with the given labels."'),
      ...
      '#withAvailabilityZone':: d.fn(help='"An Availability Zone or all. This determines whether the target receives traffic from the load balancer nodes in the specified Availability Zone or from all enabled Availability Zones for the load balancer. \\n This parameter is not supported if the target type of the target group is instance or alb. \\n If the target type is ip and the IP address is in a subnet of the VPC for the target group, the Availability Zone is automatically detected and this parameter is optional. If the IP address is outside the VPC, this parameter is required. \\n With an Application Load Balancer, if the target type is ip and the IP address is outside the VPC for the target group, the only supported value is all. \\n If the target type is lambda, this parameter is optional and the only supported value is all."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      withAvailabilityZone(availabilityZone): { spec+: { forProvider+: { availabilityZone: availabilityZone } } },
      '#withLambdaArn':: d.fn(help='"The LambdaARN that should be used as target. \\n Note: If you want to reference anything else than Lambda you currently have to specify the crossplane.io/external-name annotation directly. If the target type of the target group is instance, specify an instance ID. If the target type is ip, specify an IP address. If the target type is lambda, specify the ARN of the Lambda function. If the target type is alb, specify the ARN of the Application Load Balancer target."', args=[d.arg(name='lambdaArn', type=d.T.string)]),
      withLambdaArn(lambdaArn): { spec+: { forProvider+: { lambdaArn: lambdaArn } } },
      '#withPort':: d.fn(help='"The port on which the target is listening. If the target group protocol is GENEVE, the supported port is 6081. If the target type is alb, the targeted Application Load Balancer must have at least one listener whose port matches the target group port. Not used if the target is a Lambda function."', args=[d.arg(name='port', type=d.T.integer)]),
      withPort(port): { spec+: { forProvider+: { port: port } } },
      '#withRegion':: d.fn(help='"The AWS region the target resides in."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTargetGroupArn':: d.fn(help='"The Amazon Resource Name (ARN) of the target group. \\n One of TargetGroupARN, TargetGroupARNRef or TargetGroupARNSelector is required."', args=[d.arg(name='targetGroupArn', type=d.T.string)]),
