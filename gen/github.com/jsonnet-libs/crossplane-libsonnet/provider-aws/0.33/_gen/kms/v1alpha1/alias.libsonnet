{
  ...
  '#':: d.pkg(name='alias', url='', help='"Alias is the Schema for the Aliases API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"AliasParameters defines the desired state of Alias"'),
    forProvider: {
      '#targetKeyIdRef':: d.obj(help='"TargetKeyIDRef is a reference to a KMS Key used to set TargetKeyID."'),
      targetKeyIdRef: {
      ...
      '#targetKeyIdSelector':: d.obj(help='"TargetKeyIDSelector selects a reference to a KMS Key used to set TargetKeyID."'),
      targetKeyIdSelector: {
      ...
      '#withRegion':: d.fn(help='"Region is which region the Alias will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTargetKeyId':: d.fn(help='"Associates the alias with the specified customer managed CMK (https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk). The CMK must be in the same AWS Region. \\n A valid CMK ID is required. If you supply a null or empty string value, this operation returns an error. \\n For help finding the key ID and ARN, see Finding the Key ID and ARN (https://docs.aws.amazon.com/kms/latest/developerguide/viewing-keys.html#find-cmk-id-arn) in the AWS Key Management Service Developer Guide. \\n Specify the key ID or the Amazon Resource Name (ARN) of the CMK. \\n For example: \\n * Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab \\n * Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab \\n To get the key ID and key ARN for a CMK, use ListKeys or DescribeKey."', args=[d.arg(name='targetKeyId', type=d.T.string)]),
