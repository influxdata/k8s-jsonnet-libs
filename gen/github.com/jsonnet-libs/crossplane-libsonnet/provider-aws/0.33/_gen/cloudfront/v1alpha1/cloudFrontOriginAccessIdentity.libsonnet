{
  ...
  '#':: d.pkg(name='cloudFrontOriginAccessIdentity', url='', help='"CloudFrontOriginAccessIdentity is the Schema for the CloudFrontOriginAccessIdentities API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudFrontOriginAccessIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudfront.aws.crossplane.io/v1alpha1',
    kind: 'CloudFrontOriginAccessIdentity',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CloudFrontOriginAccessIdentitySpec defines the desired state of CloudFrontOriginAccessIdentity"'),
  spec: {
    '#forProvider':: d.obj(help='"CloudFrontOriginAccessIdentityParameters defines the desired state of CloudFrontOriginAccessIdentity"'),
    forProvider: {
      '#cloudFrontOriginAccessIdentityConfig':: d.obj(help='"The current configuration information for the identity."'),
      cloudFrontOriginAccessIdentityConfig: {
        '#withComment':: d.fn(help='', args=[d.arg(name='comment', type=d.T.string)]),
        withComment(comment): { spec+: { forProvider+: { cloudFrontOriginAccessIdentityConfig+: { comment: comment } } } },
      },
      '#withRegion':: d.fn(help='"Region is which region the CloudFrontOriginAccessIdentity will be created."', args=[d.arg(name='region', type=d.T.string)]),
