{
  ...
  '#':: d.pkg(name='repository', url='', help='"A Repository is a managed resource that represents an Elastic Container Repository Deprecated: Please use v1beta1 version of this resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#imageScanningConfiguration':: d.obj(help='"The image scanning configuration for the repository. This determines whether images are scanned for known vulnerabilities after being pushed to the repository."'),
      imageScanningConfiguration: {
        '#withScanOnPush':: d.fn(help='"The setting that determines whether images are scanned after being pushed to a repository. If set to true, images will be scanned after being pushed. If this parameter is not specified, it will default to false and images will not be scanned unless a scan is manually started with the StartImageScan API."', args=[d.arg(name='scanOnPush', type=d.T.boolean)]),
        withScanOnPush(scanOnPush): { spec+: { forProvider+: { imageScanningConfiguration+: { scanOnPush: scanOnPush } } } },
      },
      '#withForceDelete':: d.fn(help='"If a repository contains images, forces the deletion."', args=[d.arg(name='forceDelete', type=d.T.boolean)]),
      withForceDelete(forceDelete): { spec+: { forProvider+: { forceDelete: forceDelete } } },
      '#withImageTagMutability':: d.fn(help='"The tag mutability setting for the repository. If this parameter is omitted, the default setting of MUTABLE will be used which will allow image tags to be overwritten. If IMMUTABLE is specified, all image tags within the repository will be immutable which will prevent them from being overwritten."', args=[d.arg(name='imageTagMutability', type=d.T.string)]),
      withImageTagMutability(imageTagMutability): { spec+: { forProvider+: { imageTagMutability: imageTagMutability } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like your Repository to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
