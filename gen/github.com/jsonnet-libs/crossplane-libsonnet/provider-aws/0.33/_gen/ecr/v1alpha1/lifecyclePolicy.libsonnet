{
  ...
  '#':: d.pkg(name='lifecyclePolicy', url='', help='"LifecyclePolicy is the Schema for the LifecyclePolicies API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"LifecyclePolicyParameters defines the desired state of LifecyclePolicy"'),
    forProvider: {
      '#repositoryNameRef':: d.obj(help='"RepositoryNameRef is the name of the Repository that the policy should attach to"'),
      repositoryNameRef: {
      ...
      '#repositoryNameSelector':: d.obj(help='"RepositoryNameSelector selects a references to the Repository the policy should attach to"'),
      ...
      '#withLifecyclePolicyText':: d.fn(help='"The JSON repository policy text to apply to the repository."', args=[d.arg(name='lifecyclePolicyText', type=d.T.string)]),
      withLifecyclePolicyText(lifecyclePolicyText): { spec+: { forProvider+: { lifecyclePolicyText: lifecyclePolicyText } } },
      '#withRegion':: d.fn(help='"Region is which region the LifecyclePolicy will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRegistryID':: d.fn(help='"The Amazon Web Services account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed."', args=[d.arg(name='registryID', type=d.T.string)]),
      withRegistryID(registryID): { spec+: { forProvider+: { registryID: registryID } } },
      '#withRepositoryName':: d.fn(help='"RepositoryName is the name of the Repository that the policy should attach to"', args=[d.arg(name='repositoryName', type=d.T.string)]),
