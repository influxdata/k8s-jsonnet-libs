{
  ...
  '#':: d.pkg(name='topic', url='', help='"Topic defines a managed resource that represents state of a AWS Topic"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"TopicParameters define the desired state of a AWS SNS Topic"'),
    forProvider: {
      ...
      '#withFifoTopic':: d.fn(help='"Whether or not this should be a fifo-topic"', args=[d.arg(name='fifoTopic', type=d.T.boolean)]),
      ...
      '#withRegion':: d.fn(help="\"Region is the region you'd like your Topic to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
