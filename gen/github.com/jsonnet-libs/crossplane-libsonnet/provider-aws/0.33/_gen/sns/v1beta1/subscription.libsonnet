{
  ...
  '#':: d.pkg(name='subscription', url='', help='"Subscription defines a managed resource that represents state of a AWS SNS Subscription"'),
  ...
  '#spec':: d.obj(help='"SubscriptionSpec defined the desired state of a AWS SNS Topic"'),
  spec: {
    '#forProvider':: d.obj(help='"SubscriptionParameters define the desired state of a AWS SNS Topic"'),
    forProvider: {
      '#topicArnRef':: d.obj(help='"TopicArnRef references a SNS Topic and retrieves its TopicArn"'),
      topicArnRef: {
      ...
      '#topicArnSelector':: d.obj(help='"TopicArnSelector selects a reference to a SNS Topic and retrieves its TopicArn"'),
      topicArnSelector: {
      ...
      '#withDeliveryPolicy':: d.fn(help='"DeliveryPolicy defines how Amazon SNS retries failed deliveries to HTTP/S endpoints."', args=[d.arg(name='deliveryPolicy', type=d.T.string)]),
      withDeliveryPolicy(deliveryPolicy): { spec+: { forProvider+: { deliveryPolicy: deliveryPolicy } } },
      '#withEndpoint':: d.fn(help="\"The subscription's endpoint\"", args=[d.arg(name='endpoint', type=d.T.string)]),
      withEndpoint(endpoint): { spec+: { forProvider+: { endpoint: endpoint } } },
      '#withFilterPolicy':: d.fn(help='"The simple JSON object that lets your subscriber receive only a subset of messages, rather than receiving every message published to the topic."', args=[d.arg(name='filterPolicy', type=d.T.string)]),
      withFilterPolicy(filterPolicy): { spec+: { forProvider+: { filterPolicy: filterPolicy } } },
      '#withProtocol':: d.fn(help="\"The subscription's protocol.\"", args=[d.arg(name='protocol', type=d.T.string)]),
      withProtocol(protocol): { spec+: { forProvider+: { protocol: protocol } } },
      '#withRawMessageDelivery':: d.fn(help='"When set to true, enables raw message delivery to Amazon SQS or HTTP/S endpoints. This eliminates the need for the endpoints to process JSON formatting, which is otherwise created for Amazon SNS metadata."', args=[d.arg(name='rawMessageDelivery', type=d.T.string)]),
      withRawMessageDelivery(rawMessageDelivery): { spec+: { forProvider+: { rawMessageDelivery: rawMessageDelivery } } },
      '#withRedrivePolicy':: d.fn(help="\"When specified, sends undeliverable messages to the specified Amazon SQS dead-letter queue. Messages that can't be delivered due to client errors (for example, when the subscribed endpoint is unreachable) or server errors (for example, when the service that powers the subscribed endpoint becomes unavailable) are held in the dead-letter queue for further analysis or reprocessing.\"", args=[d.arg(name='redrivePolicy', type=d.T.string)]),
      withRedrivePolicy(redrivePolicy): { spec+: { forProvider+: { redrivePolicy: redrivePolicy } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like your Subscription to be in.\"", args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTopicArn':: d.fn(help='"TopicArn is the Arn of the SNS Topic"', args=[d.arg(name='topicArn', type=d.T.string)]),
