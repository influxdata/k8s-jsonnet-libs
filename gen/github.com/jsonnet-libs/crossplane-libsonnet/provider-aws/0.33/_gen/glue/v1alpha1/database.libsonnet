    ...
    forProvider: {
      ...
      databaseInput: {
        ...
        targetDatabase: {
          ...
          withCatalogID(catalogID): { spec+: { forProvider+: { databaseInput+: { targetDatabase+: { catalogID: catalogID } } } } },
          '#withDatabaseName':: d.fn(help='', args=[d.arg(name='databaseName', type=d.T.string)]),
          withDatabaseName(databaseName): { spec+: { forProvider+: { databaseInput+: { targetDatabase+: { databaseName: databaseName } } } } },
        },
        '#withCreateTableDefaultPermissions':: d.fn(help='"Creates a set of default permissions on the table for principals. If left empty on creation, AWS defaults it to [Permissions: [\\"All\\"], Principal: DataLake Prinicpal Identifier : \\"IAM_ALLOWED_PRINCIPALS\\"]"', args=[d.arg(name='createTableDefaultPermissions', type=d.T.array)]),
        withCreateTableDefaultPermissions(createTableDefaultPermissions): { spec+: { forProvider+: { databaseInput+: { createTableDefaultPermissions: if std.isArray(v=createTableDefaultPermissions) then createTableDefaultPermissions else [createTableDefaultPermissions] } } } },
        '#withCreateTableDefaultPermissionsMixin':: d.fn(help='"Creates a set of default permissions on the table for principals. If left empty on creation, AWS defaults it to [Permissions: [\\"All\\"], Principal: DataLake Prinicpal Identifier : \\"IAM_ALLOWED_PRINCIPALS\\"]"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='createTableDefaultPermissions', type=d.T.array)]),
        withCreateTableDefaultPermissionsMixin(createTableDefaultPermissions): { spec+: { forProvider+: { databaseInput+: { createTableDefaultPermissions+: if std.isArray(v=createTableDefaultPermissions) then createTableDefaultPermissions else [createTableDefaultPermissions] } } } },
        '#withDescription':: d.fn(help='"A description of the database."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { spec+: { forProvider+: { databaseInput+: { description: description } } } },
        '#withLocationURI':: d.fn(help='"The location of the database (for example, an HDFS path)."', args=[d.arg(name='locationURI', type=d.T.string)]),
        withLocationURI(locationURI): { spec+: { forProvider+: { databaseInput+: { locationURI: locationURI } } } },
        '#withParameters':: d.fn(help='"These key-value pairs define parameters and properties of the database."', args=[d.arg(name='parameters', type=d.T.object)]),
        withParameters(parameters): { spec+: { forProvider+: { databaseInput+: { parameters: parameters } } } },
        '#withParametersMixin':: d.fn(help='"These key-value pairs define parameters and properties of the database."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.object)]),
        withParametersMixin(parameters): { spec+: { forProvider+: { databaseInput+: { parameters+: parameters } } } },
      },
      '#withCatalogID':: d.fn(help='"The ID of the Data Catalog in which to create the database. If none is provided, the Amazon Web Services account ID is used by default."', args=[d.arg(name='catalogID', type=d.T.string)]),
      withCatalogID(catalogID): { spec+: { forProvider+: { catalogID: catalogID } } },
      '#withRegion':: d.fn(help='"Region is which region the Database will be created."', args=[d.arg(name='region', type=d.T.string)]),
