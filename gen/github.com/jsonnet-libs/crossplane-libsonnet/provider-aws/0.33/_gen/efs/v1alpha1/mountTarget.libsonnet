{
  ...
  '#':: d.pkg(name='mountTarget', url='', help='"MountTarget is the Schema for the MountTargets API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"MountTargetParameters defines the desired state of MountTarget"'),
    forProvider: {
      ...
      '#securityGroupsSelector':: d.obj(help='"SecurityGroupIDSelector selects references to SecurityGroups used to set the SecurityGroupIDs."'),
      ...
      '#subnetIDRef':: d.obj(help='"SubnetIDRef are references to Subnet used to set the SubnetID."'),
      subnetIDRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#subnetIDSelector':: d.obj(help='"SubnetIDSelector selects references to Subnet used to set the SubnetID."'),
      subnetIDSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withIpAddress':: d.fn(help='"Valid IPv4 address within the address range of the specified subnet."', args=[d.arg(name='ipAddress', type=d.T.string)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: ipAddress } } },
      '#withRegion':: d.fn(help='"Region is which region the MountTarget will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSecurityGroups':: d.fn(help='"Up to five VPC security group IDs, of the form sg-xxxxxxxx. These must be for the same VPC as subnet specified."', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSecurityGroupsMixin':: d.fn(help='"Up to five VPC security group IDs, of the form sg-xxxxxxxx. These must be for the same VPC as subnet specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSecurityGroupsRefs':: d.fn(help='"SecurityGroupIDRefs are references to SecurityGroups used to set the SecurityGroupIDs."', args=[d.arg(name='securityGroupsRefs', type=d.T.array)]),
      ...
      '#withSecurityGroupsRefsMixin':: d.fn(help='"SecurityGroupIDRefs are references to SecurityGroups used to set the SecurityGroupIDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupsRefs', type=d.T.array)]),
