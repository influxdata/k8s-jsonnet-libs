{
  ...
  '#':: d.pkg(name='accessPoint', url='', help='"AccessPoint is the Schema for the AccessPoints API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"AccessPointParameters defines the desired state of AccessPoint"'),
    forProvider: {
      '#fileSystemIDRef':: d.obj(help='"FileSystemIDRef are references to Filesystem used to set the FileSystemID."'),
      fileSystemIDRef: {
      ...
      '#fileSystemIDSelector':: d.obj(help='"FileSystemIDSelector selects references to Filesystem used to set the FileSystemID."'),
      ...
      '#posixUser':: d.obj(help='"The operating system user and group applied to all file system requests made using the access point."'),
      posixUser: {
      ...
      '#tags':: d.obj(help='"Creates tags associated with the access point. Each tag is a key-value pair, each key must be unique. For more information, see Tagging Amazon Web Services resources (https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) in the Amazon Web Services General Reference Guide."'),
      tags: {
      ...
      '#withFileSystemID':: d.fn(help='"The ID of the file system for which to create the mount target."', args=[d.arg(name='fileSystemID', type=d.T.string)]),
      withFileSystemID(fileSystemID): { spec+: { forProvider+: { fileSystemID: fileSystemID } } },
      '#withRegion':: d.fn(help='"Region is which region the AccessPoint will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"Creates tags associated with the access point. Each tag is a key-value pair, each key must be unique. For more information, see Tagging Amazon Web Services resources (https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) in the Amazon Web Services General Reference Guide."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"Creates tags associated with the access point. Each tag is a key-value pair, each key must be unique. For more information, see Tagging Amazon Web Services resources (https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) in the Amazon Web Services General Reference Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
