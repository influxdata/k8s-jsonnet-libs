{
  ...
  spec: {
    '#forProvider':: d.obj(help='"DBClusterParameterGroupParameters defines the desired state of DBClusterParameterGroup"'),
    forProvider: {
      '#dbParameterGroupFamilySelector':: d.obj(help='"DBParameterGroupFamilySelector determines DBParameterGroupFamily from the engine and engine version. \\n One of DBParameterGroupFamily or DBParameterGroupFamilySelector is required. \\n Will not be used if DBParameterGroupFamily is already set."'),
      dbParameterGroupFamilySelector: {
        '#withEngine':: d.fn(help='"Engine is the name of the database engine."', args=[d.arg(name='engine', type=d.T.string)]),
        withEngine(engine): { spec+: { forProvider+: { dbParameterGroupFamilySelector+: { engine: engine } } } },
        '#withEngineVersion':: d.fn(help='"EngineVersion is the version of the database engine. If it is nil, the default engine version given by AWS will be used."', args=[d.arg(name='engineVersion', type=d.T.string)]),
        withEngineVersion(engineVersion): { spec+: { forProvider+: { dbParameterGroupFamilySelector+: { engineVersion: engineVersion } } } },
      },
      '#withDbParameterGroupFamily':: d.fn(help='"The DB cluster parameter group family name. A DB cluster parameter group can be associated with one and only one DB cluster parameter group family, and can be applied only to a DB cluster running a database engine and engine version compatible with that DB cluster parameter group family. \\n Aurora MySQL \\n Example: aurora5.6, aurora-mysql5.7 \\n Aurora PostgreSQL \\n Example: aurora-postgresql9.6 \\n To list all of the available parameter group families for a DB engine, use the following command: \\n aws rds describe-db-engine-versions --query \\"DBEngineVersions[].DBParameterGroupFamily\\" --engine <engine> \\n For example, to list all of the available parameter group families for the Aurora PostgreSQL DB engine, use the following command: \\n aws rds describe-db-engine-versions --query \\"DBEngineVersions[].DBParameterGroupFamily\\" --engine aurora-postgresql \\n The output contains duplicates. \\n The following are the valid DB engine values: \\n * aurora (for MySQL 5.6-compatible Aurora) \\n * aurora-mysql (for MySQL 5.7-compatible Aurora) \\n * aurora-postgresql \\n One of DBParameterGroupFamily or DBParameterGroupFamilySelector is required."', args=[d.arg(name='dbParameterGroupFamily', type=d.T.string)]),
      withDbParameterGroupFamily(dbParameterGroupFamily): { spec+: { forProvider+: { dbParameterGroupFamily: dbParameterGroupFamily } } },
      ...
      '#withParameters':: d.fn(help='"A list of parameters to associate with this DB cluster parameter group"', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"A list of parameters to associate with this DB cluster parameter group"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { spec+: { forProvider+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withRegion':: d.fn(help='"Region is which region the DBClusterParameterGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
