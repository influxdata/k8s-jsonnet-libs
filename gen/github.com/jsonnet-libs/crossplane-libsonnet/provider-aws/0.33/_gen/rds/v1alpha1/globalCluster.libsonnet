{
  ...
  '#':: d.pkg(name='globalCluster', url='', help='"GlobalCluster is the Schema for the GlobalClusters API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#sourceDBClusterIdentifierRef':: d.obj(help='"SourceDBClusterIdentifierRef is a reference to a DBCluster used to set SourceDBClusterIdentifier."'),
      ...
      '#sourceDBClusterIdentifierSelector':: d.obj(help='"SourceDBClusterIdentifierSelector selects a reference to a DBCluster used to set SourceDBClusterIdentifier."'),
      ...
      '#withDatabaseName':: d.fn(help='"The name for your database of up to 64 alpha-numeric characters. If you do not provide a name, Amazon Aurora will not create a database in the global database cluster you are creating."', args=[d.arg(name='databaseName', type=d.T.string)]),
      withDatabaseName(databaseName): { spec+: { forProvider+: { databaseName: databaseName } } },
      '#withDeletionProtection':: d.fn(help="\"The deletion protection setting for the new global database. The global database can't be deleted when deletion protection is enabled.\"", args=[d.arg(name='deletionProtection', type=d.T.boolean)]),
      withDeletionProtection(deletionProtection): { spec+: { forProvider+: { deletionProtection: deletionProtection } } },
      '#withEngine':: d.fn(help='"The name of the database engine to be used for this DB cluster."', args=[d.arg(name='engine', type=d.T.string)]),
      withEngine(engine): { spec+: { forProvider+: { engine: engine } } },
      '#withEngineVersion':: d.fn(help='"The engine version of the Aurora global database."', args=[d.arg(name='engineVersion', type=d.T.string)]),
      withEngineVersion(engineVersion): { spec+: { forProvider+: { engineVersion: engineVersion } } },
      '#withRegion':: d.fn(help='"Region is which region the GlobalCluster will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSourceDBClusterIdentifier':: d.fn(help='"The Amazon Resource Name (ARN) to use as the primary cluster of the global database. This parameter is optional."', args=[d.arg(name='sourceDBClusterIdentifier', type=d.T.string)]),
      ...
      '#withStorageEncrypted':: d.fn(help='"The storage encryption setting for the new global database cluster."', args=[d.arg(name='storageEncrypted', type=d.T.boolean)]),
