{
  ...
  spec: {
    '#forProvider':: d.obj(help='"DBParameterGroupParameters defines the desired state of DBParameterGroup"'),
    forProvider: {
      ...
      '#withDbParameterGroupFamily':: d.fn(help='"The DB parameter group family name. A DB parameter group can be associated with one and only one DB parameter group family, and can be applied only to a DB instance running a database engine and engine version compatible with that DB parameter group family. \\n To list all of the available parameter group families for a DB engine, use the following command: \\n aws rds describe-db-engine-versions --query \\"DBEngineVersions[].DBParameterGroupFamily\\" --engine <engine> \\n For example, to list all of the available parameter group families for the MySQL DB engine, use the following command: \\n aws rds describe-db-engine-versions --query \\"DBEngineVersions[].DBParameterGroupFamily\\" --engine mysql \\n The output contains duplicates. \\n The following are the valid DB engine values: \\n * aurora (for MySQL 5.6-compatible Aurora) \\n * aurora-mysql (for MySQL 5.7-compatible Aurora) \\n * aurora-postgresql \\n * mariadb \\n * mysql \\n * oracle-ee \\n * oracle-ee-cdb \\n * oracle-se2 \\n * oracle-se2-cdb \\n * postgres \\n * sqlserver-ee \\n * sqlserver-se \\n * sqlserver-ex \\n * sqlserver-web \\n One of DBParameterGroupFamily or DBParameterGroupFamilySelector is required."', args=[d.arg(name='dbParameterGroupFamily', type=d.T.string)]),
      ...
      '#withRegion':: d.fn(help='"Region is which region the DBParameterGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
