{
  ...
  '#':: d.pkg(name='dbInstanceRoleAssociation', url='', help='"DBInstanceRoleAssociation is the Schema for the DBInstanceRoleAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DBInstanceRoleAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'rds.aws.crossplane.io/v1alpha1',
    kind: 'DBInstanceRoleAssociation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DBInstanceRoleAssociationSpec defines the desired state of DBInstanceRoleAssociation"'),
  spec: {
    '#forProvider':: d.obj(help='"DBInstanceRoleAssociationParameters defines the desired state of DBInstanceRoleAssociation"'),
    forProvider: {
      '#dbInstanceIdentifierRef':: d.obj(help='"DBInstanceIdentifierRef is a reference to a DBInstance used to set the DBInstanceIdentifier."'),
      ...
      '#dbInstanceIdentifierSelector':: d.obj(help='"DBInstanceIdentifierSelector selects references to a DBInstance used to set the DBInstanceIdentifier."'),
      ...
      '#roleArnRef':: d.obj(help='"RoleARNRef is a reference to a IAM Role used to set RoleARN."'),
      roleArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#roleArnSelector':: d.obj(help='"RoleARNSelector selects a reference to a IAM Role used to set RoleARN."'),
      roleArnSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withDbInstanceIdentifier':: d.fn(help='"The name of the DB instance to associate the IAM role with."', args=[d.arg(name='dbInstanceIdentifier', type=d.T.string)]),
      withDbInstanceIdentifier(dbInstanceIdentifier): { spec+: { forProvider+: { dbInstanceIdentifier: dbInstanceIdentifier } } },
      '#withFeatureName':: d.fn(help='"The name of the feature for the DB instance that the IAM role is to be associated with. For information about supported feature names, see DBEngineVersion."', args=[d.arg(name='featureName', type=d.T.string)]),
      withFeatureName(featureName): { spec+: { forProvider+: { featureName: featureName } } },
      '#withRegion':: d.fn(help='"Region is which region the DBInstanceRoleAssociation will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) of the IAM role to associate with the DB instance, for example arn:aws:iam::123456789012:role/AccessRole."', args=[d.arg(name='roleArn', type=d.T.string)]),
