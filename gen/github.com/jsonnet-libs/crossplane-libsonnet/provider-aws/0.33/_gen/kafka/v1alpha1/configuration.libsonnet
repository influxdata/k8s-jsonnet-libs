{
  ...
  spec: {
    '#forProvider':: d.obj(help='"ConfigurationParameters defines the desired state of Configuration"'),
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the configuration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKafkaVersions':: d.fn(help='"The versions of Apache Kafka with which you can use this MSK configuration."', args=[d.arg(name='kafkaVersions', type=d.T.array)]),
      ...
      '#withKafkaVersionsMixin':: d.fn(help='"The versions of Apache Kafka with which you can use this MSK configuration."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='kafkaVersions', type=d.T.array)]),
