{
  ...
  spec: {
    '#forProvider':: d.obj(help='"WorkspaceParameters defines the desired state of Workspace"'),
    forProvider: {
      '#withAlias':: d.fn(help='"An optional user-assigned alias for this workspace. This alias is for user reference and does not need to be unique."', args=[d.arg(name='alias', type=d.T.string)]),
      withAlias(alias): { spec+: { forProvider+: { alias: alias } } },
      '#withRegion':: d.fn(help='"Region is which region the Workspace will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"Optional, user-provided tags for this workspace."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Optional, user-provided tags for this workspace."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
