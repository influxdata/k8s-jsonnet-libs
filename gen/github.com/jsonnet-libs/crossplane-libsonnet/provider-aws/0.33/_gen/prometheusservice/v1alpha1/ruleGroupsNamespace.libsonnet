{
  ...
  '#':: d.pkg(name='ruleGroupsNamespace', url='', help='"RuleGroupsNamespace is the Schema for the RuleGroupsNamespaces API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RuleGroupsNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'prometheusservice.aws.crossplane.io/v1alpha1',
    kind: 'RuleGroupsNamespace',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RuleGroupsNamespaceSpec defines the desired state of RuleGroupsNamespace"'),
  spec: {
    '#forProvider':: d.obj(help='"RuleGroupsNamespaceParameters defines the desired state of RuleGroupsNamespace"'),
    forProvider: {
      '#withData':: d.fn(help='"The namespace data that define the rule groups."', args=[d.arg(name='data', type=d.T.string)]),
      withData(data): { spec+: { forProvider+: { data: data } } },
      '#withName':: d.fn(help='"The rule groups namespace name."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the RuleGroupsNamespace will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"Optional, user-provided tags for this rule groups namespace."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Optional, user-provided tags for this rule groups namespace."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withWorkspaceId':: d.fn(help='"workspaceID is the ID for the Workspace."', args=[d.arg(name='workspaceId', type=d.T.string)]),
      withWorkspaceId(workspaceId): { spec+: { forProvider+: { workspaceId: workspaceId } } },
      '#workspaceIdRef':: d.obj(help='"WorkspaceIDRef is a reference to a Workspace used to set the workspaceID."'),
      workspaceIdRef: {
      ...
      '#workspaceIdSelector':: d.obj(help='"WorkspaceIDSelector selects references to Workspace used to set the workspaceID."'),
      workspaceIdSelector: {
