{
  ...
  '#':: d.pkg(name='alertManagerDefinition', url='', help='"AlertManagerDefinition is the Schema for the AlertManagerDefinitions API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"AlertManagerDefinitionParameters defines the desired state of AlertManagerDefinition"'),
    forProvider: {
      '#withData':: d.fn(help='"The alert manager definition data."', args=[d.arg(name='data', type=d.T.string)]),
      withData(data): { spec+: { forProvider+: { data: data } } },
      '#withRegion':: d.fn(help='"Region is which region the AlertManagerDefinition will be created."', args=[d.arg(name='region', type=d.T.string)]),
