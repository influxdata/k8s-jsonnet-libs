{
  ...
  '#':: d.pkg(name='securityGroupRule', url='', help='"A SecurityGroupRule is a managed resource that represents an SecurityGroupRule"'),
  ...
  '#spec':: d.obj(help='"A SecurityGroupRuleSpec defines the desired state of a SecurityGroupRule."'),
  spec: {
    '#forProvider':: d.obj(help='"SecurityGroupRuleParameters define the desired state of the SecurityGroupRule"'),
    forProvider: {
      '#securityGroupIdRef':: d.obj(help='"If using a SecurityGroup managed by crossplane as reference, enable ignoreIngress or ignoreEgress on the sg to prevent the rules to be constantly created and deleted"'),
      securityGroupIdRef: {
      ...
      '#sourceSecurityGroupIdRef':: d.obj(help='"A Reference to a named object."'),
      ...
      '#sourceSecurityGroupIdSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withCidrBlock':: d.fn(help='', args=[d.arg(name='cidrBlock', type=d.T.string)]),
      ...
      '#withIpv6cidrBlock':: d.fn(help='', args=[d.arg(name='ipv6cidrBlock', type=d.T.string)]),
      withIpv6cidrBlock(ipv6cidrBlock): { spec+: { forProvider+: { ipv6cidrBlock: ipv6cidrBlock } } },
      '#withPrefixListId':: d.fn(help='', args=[d.arg(name='prefixListId', type=d.T.string)]),
      ...
      '#withSecurityGroupId':: d.fn(help='"If using a SecurityGroup managed by crossplane as reference, enable ignoreIngress or ignoreEgress on the sg to prevent the rules to be constantly created and deleted"', args=[d.arg(name='securityGroupId', type=d.T.string)]),
      withSecurityGroupId(securityGroupId): { spec+: { forProvider+: { securityGroupId: securityGroupId } } },
      '#withSourceSecurityGroupId':: d.fn(help='', args=[d.arg(name='sourceSecurityGroupId', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of rule, ingress (inbound) or egress (outbound)."', args=[d.arg(name='type', type=d.T.string)]),
