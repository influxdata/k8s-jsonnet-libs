{
  ...
  '#':: d.pkg(name='transitGatewayRoute', url='', help='"TransitGatewayRoute is the Schema for the TransitGatewayRoutes API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"TransitGatewayRouteParameters defines the desired state of TransitGatewayRoute"'),
    forProvider: {
      ...
      '#transitGatewayRouteTableIdRef':: d.obj(help='"TransitGatewayRouteTableIDRef is a reference to an API used to set the TransitGatewayRouteTableID."'),
      ...
      '#transitGatewayRouteTableIdSelector':: d.obj(help='"TransitGatewayRouteTableIDSelector selects references to API used to set the TransitGatewayRouteTableID."'),
      ...
      '#withBlackhole':: d.fn(help='"Indicates whether to drop traffic that matches this route."', args=[d.arg(name='blackhole', type=d.T.boolean)]),
      withBlackhole(blackhole): { spec+: { forProvider+: { blackhole: blackhole } } },
      '#withDestinationCIDRBlock':: d.fn(help='"The CIDR range used for destination matches. Routing decisions are based on the most specific match."', args=[d.arg(name='destinationCIDRBlock', type=d.T.string)]),
      withDestinationCIDRBlock(destinationCIDRBlock): { spec+: { forProvider+: { destinationCIDRBlock: destinationCIDRBlock } } },
      '#withRegion':: d.fn(help='"Region is which region the TransitGatewayRoute will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTransitGatewayAttachmentId':: d.fn(help='"The ID of the attachment."', args=[d.arg(name='transitGatewayAttachmentId', type=d.T.string)]),
      ...
      '#withTransitGatewayRouteTableId':: d.fn(help='"The ID of the transit gateway route table."', args=[d.arg(name='transitGatewayRouteTableId', type=d.T.string)]),
