{
  ...
  '#':: d.pkg(name='vpccidrBlock', url='', help='"A VPCCIDRBlock is a managed resource that represents an secondary CIDR block for a VPC Deprecated: Please use v1beta1 version of this resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of VPCCIDRBlock', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAmazonProvidedIpv6CidrBlock':: d.fn(help='"Requests an Amazon-provided IPv6 CIDR block with a /56 prefix length for the VPC. You cannot specify the range of IPv6 addresses, or the size of the CIDR block."', args=[d.arg(name='amazonProvidedIpv6CidrBlock', type=d.T.boolean)]),
      withAmazonProvidedIpv6CidrBlock(amazonProvidedIpv6CidrBlock): { spec+: { forProvider+: { amazonProvidedIpv6CidrBlock: amazonProvidedIpv6CidrBlock } } },
      '#withCidrBlock':: d.fn(help='"An IPv4 CIDR block to associate with the VPC."', args=[d.arg(name='cidrBlock', type=d.T.string)]),
      withCidrBlock(cidrBlock): { spec+: { forProvider+: { cidrBlock: cidrBlock } } },
      '#withIpv6CdirBlock':: d.fn(help='"An IPv6 CIDR block from the IPv6 address pool. You must also specify Ipv6Pool in the request. \\n To let Amazon choose the IPv6 CIDR block for you, omit this parameter."', args=[d.arg(name='ipv6CdirBlock', type=d.T.string)]),
      withIpv6CdirBlock(ipv6CdirBlock): { spec+: { forProvider+: { ipv6CdirBlock: ipv6CdirBlock } } },
      '#withIpv6CidrBlockNetworkBorderGroup':: d.fn(help='"The name of the location from which we advertise the IPV6 CIDR block. Use this parameter to limit the CiDR block to this location. \\n You must set AmazonProvidedIpv6CIDRBlock to true to use this parameter. \\n You can have one IPv6 CIDR block association per network border group."', args=[d.arg(name='ipv6CidrBlockNetworkBorderGroup', type=d.T.string)]),
      ...
      '#withIpv6Pool':: d.fn(help='"The ID of an IPv6 address pool from which to allocate the IPv6 CIDR block."', args=[d.arg(name='ipv6Pool', type=d.T.string)]),
      withIpv6Pool(ipv6Pool): { spec+: { forProvider+: { ipv6Pool: ipv6Pool } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like your VPC CIDR to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
