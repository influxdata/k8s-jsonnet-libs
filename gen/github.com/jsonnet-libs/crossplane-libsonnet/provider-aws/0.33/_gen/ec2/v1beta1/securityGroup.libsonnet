{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIgnoreEgress':: d.fn(help='"Dont manage the egress settings for the created resource"', args=[d.arg(name='ignoreEgress', type=d.T.boolean)]),
      withIgnoreEgress(ignoreEgress): { spec+: { forProvider+: { ignoreEgress: ignoreEgress } } },
      '#withIgnoreIngress':: d.fn(help='"Dont manage the ingress settings for the created resource"', args=[d.arg(name='ignoreIngress', type=d.T.boolean)]),
      withIgnoreIngress(ignoreIngress): { spec+: { forProvider+: { ignoreIngress: ignoreIngress } } },
