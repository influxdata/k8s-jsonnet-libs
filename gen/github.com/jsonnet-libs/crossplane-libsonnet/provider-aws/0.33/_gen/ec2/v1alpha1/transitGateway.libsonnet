{
  ...
  '#':: d.pkg(name='transitGateway', url='', help='"TransitGateway is the Schema for the TransitGateways API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"TransitGatewayParameters defines the desired state of TransitGateway"'),
    forProvider: {
      '#options':: d.obj(help='"The transit gateway options."'),
      options: {
        '#withAmazonSideASN':: d.fn(help='', args=[d.arg(name='amazonSideASN', type=d.T.integer)]),
        withAmazonSideASN(amazonSideASN): { spec+: { forProvider+: { options+: { amazonSideASN: amazonSideASN } } } },
        '#withAutoAcceptSharedAttachments':: d.fn(help='', args=[d.arg(name='autoAcceptSharedAttachments', type=d.T.string)]),
        withAutoAcceptSharedAttachments(autoAcceptSharedAttachments): { spec+: { forProvider+: { options+: { autoAcceptSharedAttachments: autoAcceptSharedAttachments } } } },
        '#withDefaultRouteTableAssociation':: d.fn(help='', args=[d.arg(name='defaultRouteTableAssociation', type=d.T.string)]),
        withDefaultRouteTableAssociation(defaultRouteTableAssociation): { spec+: { forProvider+: { options+: { defaultRouteTableAssociation: defaultRouteTableAssociation } } } },
        '#withDefaultRouteTablePropagation':: d.fn(help='', args=[d.arg(name='defaultRouteTablePropagation', type=d.T.string)]),
        withDefaultRouteTablePropagation(defaultRouteTablePropagation): { spec+: { forProvider+: { options+: { defaultRouteTablePropagation: defaultRouteTablePropagation } } } },
        ...
        '#withMulticastSupport':: d.fn(help='', args=[d.arg(name='multicastSupport', type=d.T.string)]),
        withMulticastSupport(multicastSupport): { spec+: { forProvider+: { options+: { multicastSupport: multicastSupport } } } },
        '#withTransitGatewayCIDRBlocks':: d.fn(help='', args=[d.arg(name='transitGatewayCIDRBlocks', type=d.T.array)]),
        withTransitGatewayCIDRBlocks(transitGatewayCIDRBlocks): { spec+: { forProvider+: { options+: { transitGatewayCIDRBlocks: if std.isArray(v=transitGatewayCIDRBlocks) then transitGatewayCIDRBlocks else [transitGatewayCIDRBlocks] } } } },
        '#withTransitGatewayCIDRBlocksMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='transitGatewayCIDRBlocks', type=d.T.array)]),
        withTransitGatewayCIDRBlocksMixin(transitGatewayCIDRBlocks): { spec+: { forProvider+: { options+: { transitGatewayCIDRBlocks+: if std.isArray(v=transitGatewayCIDRBlocks) then transitGatewayCIDRBlocks else [transitGatewayCIDRBlocks] } } } },
        '#withVpnECMPSupport':: d.fn(help='', args=[d.arg(name='vpnECMPSupport', type=d.T.string)]),
        withVpnECMPSupport(vpnECMPSupport): { spec+: { forProvider+: { options+: { vpnECMPSupport: vpnECMPSupport } } } },
      },
      '#withDescription':: d.fn(help='"A description of the transit gateway."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withRegion':: d.fn(help='"Region is which region the TransitGateway will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTagSpecifications':: d.fn(help='"The tags to apply to the transit gateway."', args=[d.arg(name='tagSpecifications', type=d.T.array)]),
