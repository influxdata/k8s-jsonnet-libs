{
  ...
  '#':: d.pkg(name='transitGatewayRouteTable', url='', help='"TransitGatewayRouteTable is the Schema for the TransitGatewayRouteTables API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"TransitGatewayRouteTableParameters defines the desired state of TransitGatewayRouteTable"'),
    forProvider: {
      ...
      '#withRegion':: d.fn(help='"Region is which region the TransitGatewayRouteTable will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTagSpecifications':: d.fn(help='"The tags to apply to the transit gateway route table."', args=[d.arg(name='tagSpecifications', type=d.T.array)]),
