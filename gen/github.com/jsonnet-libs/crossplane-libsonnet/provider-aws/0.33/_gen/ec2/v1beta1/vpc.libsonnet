{
  ...
  '#':: d.pkg(name='vpc', url='', help='"A VPC is a managed resource that represents an AWS Virtual Private Cloud."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAmazonProvidedIpv6CidrBlock':: d.fn(help='"Requests an Amazon-provided IPv6 CIDR block with a /56 prefix length for the VPC. You cannot specify the range of IP addresses, or the size of the CIDR block."', args=[d.arg(name='amazonProvidedIpv6CidrBlock', type=d.T.boolean)]),
      ...
      '#withCidrBlock':: d.fn(help='"CIDRBlock is the IPv4 network range for the VPC, in CIDR notation. For example, 10.0.0.0/16."', args=[d.arg(name='cidrBlock', type=d.T.string)]),
      withCidrBlock(cidrBlock): { spec+: { forProvider+: { cidrBlock: cidrBlock } } },
      '#withEnableDnsHostNames':: d.fn(help='"Indicates whether the instances launched in the VPC get DNS hostnames."', args=[d.arg(name='enableDnsHostNames', type=d.T.boolean)]),
      withEnableDnsHostNames(enableDnsHostNames): { spec+: { forProvider+: { enableDnsHostNames: enableDnsHostNames } } },
      '#withEnableDnsSupport':: d.fn(help='"A boolean flag to enable/disable DNS support in the VPC"', args=[d.arg(name='enableDnsSupport', type=d.T.boolean)]),
      withEnableDnsSupport(enableDnsSupport): { spec+: { forProvider+: { enableDnsSupport: enableDnsSupport } } },
      '#withInstanceTenancy':: d.fn(help='"The allowed tenancy of instances launched into the VPC."', args=[d.arg(name='instanceTenancy', type=d.T.string)]),
      withInstanceTenancy(instanceTenancy): { spec+: { forProvider+: { instanceTenancy: instanceTenancy } } },
      '#withIpv6CidrBlock':: d.fn(help='"The IPv6 CIDR block from the IPv6 address pool. You must also specify Ipv6Pool in the request. To let Amazon choose the IPv6 CIDR block for you, omit this parameter."', args=[d.arg(name='ipv6CidrBlock', type=d.T.string)]),
