{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#routeTableIdRef':: d.obj(help='"RouteTableIDRef is a reference to an API used to set the RouteTableID."'),
      routeTableIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#routeTableIdSelector':: d.obj(help='"RouteTableIDSelector selects references to API used to set the RouteTableID."'),
      ...
      '#withRouteTableId':: d.fn(help='"The ID of the route table for the route. provider-aws currently provides both a standalone Route resource and a RouteTable resource with routes defined in-line. At this time you cannot use a RouteTable with in-line routes in conjunction with any Route resources. Set the flag ignoreRoutes=true in RouteTable to use Route resource"', args=[d.arg(name='routeTableId', type=d.T.string)]),
