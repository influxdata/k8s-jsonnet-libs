{
  ...
  '#':: d.pkg(name='address', url='', help='"An Address is a managed resource that represents an AWS Elastic IP Address."'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"AddressParameters define the desired state of an AWS Elastic IP"'),
    forProvider: {
      '#withAddress':: d.fn(help='"[EC2-VPC] The Elastic IP address to recover or an IPv4 address from an address pool."', args=[d.arg(name='address', type=d.T.string)]),
      withAddress(address): { spec+: { forProvider+: { address: address } } },
      '#withCustomerOwnedIPv4Pool':: d.fn(help='"The ID of a customer-owned address pool. Use this parameter to let Amazon EC2 select an address from the address pool. Alternatively, specify a specific address from the address pool"', args=[d.arg(name='customerOwnedIPv4Pool', type=d.T.string)]),
      withCustomerOwnedIPv4Pool(customerOwnedIPv4Pool): { spec+: { forProvider+: { customerOwnedIPv4Pool: customerOwnedIPv4Pool } } },
      '#withDomain':: d.fn(help='"Set to vpc to allocate the address for use with instances in a VPC. Default: The address is for use with instances in EC2-Classic."', args=[d.arg(name='domain', type=d.T.string)]),
      withDomain(domain): { spec+: { forProvider+: { domain: domain } } },
      '#withNetworkBorderGroup':: d.fn(help='"The location from which the IP address is advertised. Use this parameter to limit the address to this location. \\n A network border group is a unique set of Availability Zones or Local Zones from where AWS advertises IP addresses and limits the addresses to the group. IP addresses cannot move between network border groups. \\n Use DescribeAvailabilityZones (https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAvailabilityZones.html) to view the network border groups. \\n You cannot use a network border group with EC2 Classic. If you attempt this operation on EC2 classic, you will receive an InvalidParameterCombination error. For more information, see Error Codes (https://docs.aws.amazon.com/AWSEC2/latest/APIReference/errors-overview.html)."', args=[d.arg(name='networkBorderGroup', type=d.T.string)]),
      withNetworkBorderGroup(networkBorderGroup): { spec+: { forProvider+: { networkBorderGroup: networkBorderGroup } } },
      '#withPublicIpv4Pool':: d.fn(help='"The ID of an address pool that you own. Use this parameter to let Amazon EC2 select an address from the address pool. To specify a specific address from the address pool, use the Address parameter instead."', args=[d.arg(name='publicIpv4Pool', type=d.T.string)]),
      withPublicIpv4Pool(publicIpv4Pool): { spec+: { forProvider+: { publicIpv4Pool: publicIpv4Pool } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like your Address to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
