{
  ...
  '#':: d.pkg(name='logGroup', url='', help='"LogGroup is the Schema for the LogGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LogGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKmsKeyID':: d.fn(help='"The Amazon Resource Name (ARN) of the CMK to use when encrypting log data. For more information, see Amazon Resource Names - AWS Key Management Service (AWS KMS) (https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms)."', args=[d.arg(name='kmsKeyID', type=d.T.string)]),
      withKmsKeyID(kmsKeyID): { spec+: { forProvider+: { kmsKeyID: kmsKeyID } } },
      '#withLogGroupName':: d.fn(help='"The name of the log group."', args=[d.arg(name='logGroupName', type=d.T.string)]),
      withLogGroupName(logGroupName): { spec+: { forProvider+: { logGroupName: logGroupName } } },
      '#withRegion':: d.fn(help='"Region is which region the LogGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRetentionInDays':: d.fn(help='"The number of days to retain the log events in the specified log group. If you select 0, the events in the log group are always retained and never expire."', args=[d.arg(name='retentionInDays', type=d.T.integer)]),
      withRetentionInDays(retentionInDays): { spec+: { forProvider+: { retentionInDays: retentionInDays } } },
      '#withTags':: d.fn(help='"The key-value pairs to use for the tags. \\n CloudWatch Logs doesn’t support IAM policies that prevent users from assigning specified tags to log groups using the aws:Resource/key-name or aws:TagKeys condition keys. For more information about using tags to control access, see Controlling access to Amazon Web Services resources using tags (https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html)."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"The key-value pairs to use for the tags. \\n CloudWatch Logs doesn’t support IAM policies that prevent users from assigning specified tags to log groups using the aws:Resource/key-name or aws:TagKeys condition keys. For more information about using tags to control access, see Controlling access to Amazon Web Services resources using tags (https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
