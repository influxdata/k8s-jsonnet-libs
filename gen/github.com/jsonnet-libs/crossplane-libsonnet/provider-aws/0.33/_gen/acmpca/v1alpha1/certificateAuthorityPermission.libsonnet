{
  ...
  '#':: d.pkg(name='certificateAuthorityPermission', url='', help='"CertificateAuthorityPermission is a managed resource that represents an AWS CertificateAuthorityPermission Manager."'),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateAuthorityPermission', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'acmpca.aws.crossplane.io/v1alpha1',
    kind: 'CertificateAuthorityPermission',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CertificateAuthorityPermissionSpec defines the desired state of CertificateAuthorityPermission"'),
  spec: {
    '#forProvider':: d.obj(help='"CertificateAuthorityPermissionParameters defines the desired state of an AWS CertificateAuthority."'),
    forProvider: {
      '#certificateAuthorityARNRef':: d.obj(help='"CertificateAuthorityARNRef references an CertificateAuthority to retrieve its Arn"'),
      ...
      '#certificateAuthorityARNSelector':: d.obj(help='"CertificateAuthorityARNSelector selects a reference to an CertificateAuthority to retrieve its Arn"'),
      ...
      '#withActions':: d.fn(help='"The actions that the specified AWS service principal can use."', args=[d.arg(name='actions', type=d.T.array)]),
      withActions(actions): { spec+: { forProvider+: { actions: if std.isArray(v=actions) then actions else [actions] } } },
      '#withActionsMixin':: d.fn(help='"The actions that the specified AWS service principal can use."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actions', type=d.T.array)]),
      ...
      '#withPrincipal':: d.fn(help='"The AWS service or identity that receives the permission. At this time, the only valid principal is acm.amazonaws.com."', args=[d.arg(name='principal', type=d.T.string)]),
      withPrincipal(principal): { spec+: { forProvider+: { principal: principal } } },
      '#withRegion':: d.fn(help='"Region is the region of CertificateAuthorityPermission."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSourceAccount':: d.fn(help='"Calling Account ID"', args=[d.arg(name='sourceAccount', type=d.T.string)]),
