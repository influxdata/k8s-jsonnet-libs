{
  ...
  spec: {
    '#forProvider':: d.obj(help='"BackupParameters defines the desired state of Backup"'),
    forProvider: {
      '#tableNameRef':: d.obj(help='"TableNameRef points to the Table resource whose Name will be used to fill TableName field."'),
      tableNameRef: {
      ...
      '#tableNameSelector':: d.obj(help='"TableNameSelector selects a Table resource."'),
      tableNameSelector: {
      ...
      '#withBackupName':: d.fn(help='"Specified name for the backup."', args=[d.arg(name='backupName', type=d.T.string)]),
      withBackupName(backupName): { spec+: { forProvider+: { backupName: backupName } } },
      '#withRegion':: d.fn(help='"Region is which region the Backup will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTableName':: d.fn(help='"TableName is the name of the Table whose backup will be taken."', args=[d.arg(name='tableName', type=d.T.string)]),
