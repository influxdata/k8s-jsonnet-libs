{
  ...
  '#':: d.pkg(name='elbAttachment', url='', help='"An ELBAttachment is a managed resource that represents attachment of an AWS Classic Load Balancer and an AWS EC2 instance."'),
  ...
  '#new':: d.fn(help='new returns an instance of ELBAttachment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#elbNameRef':: d.obj(help='"ELBNameRef references an ELB to and retrieves its external-name."'),
      elbNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { elbNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { elbNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { elbNameRef+: { name: name } } } },
      },
      '#elbNameSelector':: d.obj(help='"ELBNameSelector selects a reference to a ELB to and retrieves its external-name."'),
      elbNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { elbNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { elbNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { elbNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { elbNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { elbNameSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withElbName':: d.fn(help='"Name of the Elastic Load Balancer to which the instances will attach."', args=[d.arg(name='elbName', type=d.T.string)]),
      withElbName(elbName): { spec+: { forProvider+: { elbName: elbName } } },
      '#withInstanceId':: d.fn(help='"List of identities of the instances to be attached."', args=[d.arg(name='instanceId', type=d.T.string)]),
      withInstanceId(instanceId): { spec+: { forProvider+: { instanceId: instanceId } } },
      '#withRegion':: d.fn(help="\"Region is the region you'd like your ELBAttachment to be in.\"", args=[d.arg(name='region', type=d.T.string)]),
