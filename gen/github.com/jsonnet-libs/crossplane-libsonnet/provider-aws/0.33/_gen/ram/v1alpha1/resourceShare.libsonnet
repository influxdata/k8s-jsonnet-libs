{
  ...
  '#':: d.pkg(name='resourceShare', url='', help='"ResourceShare is the Schema for the ResourceShares API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"ResourceShareParameters defines the desired state of ResourceShare"'),
    forProvider: {
      '#tags':: d.obj(help='"One or more tags."'),
      tags: {
      ...
      '#withAllowExternalPrincipals':: d.fn(help='"Indicates whether principals outside your organization in Organizations can be associated with a resource share."', args=[d.arg(name='allowExternalPrincipals', type=d.T.boolean)]),
      withAllowExternalPrincipals(allowExternalPrincipals): { spec+: { forProvider+: { allowExternalPrincipals: allowExternalPrincipals } } },
      '#withClientToken':: d.fn(help='"A unique, case-sensitive identifier that you provide to ensure the idempotency of the request."', args=[d.arg(name='clientToken', type=d.T.string)]),
      ...
      '#withPermissionARNs':: d.fn(help='"The Amazon Resource Names (ARNs) of the permissions to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. Only one permission can be associated with each resource type in a resource share."', args=[d.arg(name='permissionARNs', type=d.T.array)]),
      ...
      '#withPrincipals':: d.fn(help='"The principals to associate with the resource share. The possible values are: \\n * An Amazon Web Services account ID \\n * An Amazon Resource Name (ARN) of an organization in Organizations \\n * An ARN of an organizational unit (OU) in Organizations \\n * An ARN of an IAM role \\n * An ARN of an IAM user \\n Not all resource types can be shared with IAM roles and IAM users. For more information, see Sharing with IAM roles and IAM users (https://docs.aws.amazon.com/ram/latest/userguide/permissions.html#permissions-rbp-supported-resource-types) in the Resource Access Manager User Guide."', args=[d.arg(name='principals', type=d.T.array)]),
      withPrincipals(principals): { spec+: { forProvider+: { principals: if std.isArray(v=principals) then principals else [principals] } } },
      '#withPrincipalsMixin':: d.fn(help='"The principals to associate with the resource share. The possible values are: \\n * An Amazon Web Services account ID \\n * An Amazon Resource Name (ARN) of an organization in Organizations \\n * An ARN of an organizational unit (OU) in Organizations \\n * An ARN of an IAM role \\n * An ARN of an IAM user \\n Not all resource types can be shared with IAM roles and IAM users. For more information, see Sharing with IAM roles and IAM users (https://docs.aws.amazon.com/ram/latest/userguide/permissions.html#permissions-rbp-supported-resource-types) in the Resource Access Manager User Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='principals', type=d.T.array)]),
      withPrincipalsMixin(principals): { spec+: { forProvider+: { principals+: if std.isArray(v=principals) then principals else [principals] } } },
      '#withRegion':: d.fn(help='"Region is which region the ResourceShare will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withResourceARNs':: d.fn(help='"The ARNs of the resources to associate with the resource share."', args=[d.arg(name='resourceARNs', type=d.T.array)]),
      withResourceARNs(resourceARNs): { spec+: { forProvider+: { resourceARNs: if std.isArray(v=resourceARNs) then resourceARNs else [resourceARNs] } } },
      '#withResourceARNsMixin':: d.fn(help='"The ARNs of the resources to associate with the resource share."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceARNs', type=d.T.array)]),
      withResourceARNsMixin(resourceARNs): { spec+: { forProvider+: { resourceARNs+: if std.isArray(v=resourceARNs) then resourceARNs else [resourceARNs] } } },
      '#withTags':: d.fn(help='"One or more tags."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"One or more tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
