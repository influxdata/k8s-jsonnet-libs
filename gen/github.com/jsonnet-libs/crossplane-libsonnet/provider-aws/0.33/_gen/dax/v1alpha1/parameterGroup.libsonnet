{
  ...
  '#':: d.pkg(name='parameterGroup', url='', help='"ParameterGroup is the Schema for the ParameterGroups API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"ParameterGroupParameters defines the desired state of ParameterGroup"'),
    forProvider: {
      ...
      '#withParameterNameValues':: d.fn(help='"An array of name-value pairs for the parameters in the group. Each element in the array represents a single parameter. \\n record-ttl-millis and query-ttl-millis are the only supported parameter names. For more details, see Configuring TTL Settings (https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DAX.cluster-management.html#DAX.cluster-management.custom-settings.ttl)."', args=[d.arg(name='parameterNameValues', type=d.T.array)]),
      withParameterNameValues(parameterNameValues): { spec+: { forProvider+: { parameterNameValues: if std.isArray(v=parameterNameValues) then parameterNameValues else [parameterNameValues] } } },
      '#withParameterNameValuesMixin':: d.fn(help='"An array of name-value pairs for the parameters in the group. Each element in the array represents a single parameter. \\n record-ttl-millis and query-ttl-millis are the only supported parameter names. For more details, see Configuring TTL Settings (https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DAX.cluster-management.html#DAX.cluster-management.custom-settings.ttl)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameterNameValues', type=d.T.array)]),
      withParameterNameValuesMixin(parameterNameValues): { spec+: { forProvider+: { parameterNameValues+: if std.isArray(v=parameterNameValues) then parameterNameValues else [parameterNameValues] } } },
      '#withRegion':: d.fn(help='"Region is which region the ParameterGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
