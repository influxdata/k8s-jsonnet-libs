{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"SubnetGroupParameters defines the desired state of SubnetGroup"'),
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description for the subnet group"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withRegion':: d.fn(help='"Region is which region the SubnetGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
