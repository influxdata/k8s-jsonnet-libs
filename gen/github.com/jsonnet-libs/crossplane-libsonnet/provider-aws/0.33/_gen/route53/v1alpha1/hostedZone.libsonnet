{
  ...
  '#':: d.pkg(name='hostedZone', url='', help='"HostedZone is a managed resource that represents an AWS Route53 Hosted HostedZone."'),
  ...
  '#new':: d.fn(help='new returns an instance of HostedZone', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#config':: d.obj(help="\"Config includes the Comment and PrivateZone elements. If you omitted the Config and Comment elements from the request, the Config and Comment elements don't appear in the response.\""),
      config: {
        '#withComment':: d.fn(help='"Comment that you want to include about the hosted zone."', args=[d.arg(name='comment', type=d.T.string)]),
        withComment(comment): { spec+: { forProvider+: { config+: { comment: comment } } } },
        '#withPrivateZone':: d.fn(help='"PrivateZone indicates whether this is a private hosted zone."', args=[d.arg(name='privateZone', type=d.T.boolean)]),
        withPrivateZone(privateZone): { spec+: { forProvider+: { config+: { privateZone: privateZone } } } },
      },
      '#vpc':: d.obj(help="\"(Private hosted zones only) A complex type that contains information about the Amazon VPC that you're associating with this hosted zone. \\n You can specify only one Amazon VPC when you create a private hosted zone. To associate additional Amazon VPCs with the hosted zone, use AssociateVPCWithHostedZone (https://docs.aws.amazon.com/Route53/latest/APIReference/API_AssociateVPCWithHostedZone.html) after you create a hosted zone.\""),
      vpc: {
        '#vpcIdRef':: d.obj(help='"(Private hosted Hostedzones only) VPCIDRef references a VPC to retrieves its VPC Id."'),
        vpcIdRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { vpc+: { vpcIdRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { vpc+: { vpcIdRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { vpc+: { vpcIdRef+: { name: name } } } } },
        },
        '#vpcIdSelector':: d.obj(help='"VPCIDSelector selects a reference to a VPC."'),
        vpcIdSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { vpc+: { vpcIdSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { vpc+: { vpcIdSelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { vpc+: { vpcIdSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { vpc+: { vpcIdSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { vpc+: { vpcIdSelector+: { matchLabels+: matchLabels } } } } },
        },
        '#withVpcId':: d.fn(help='"(Private hosted zones only) The ID of an Amazon VPC."', args=[d.arg(name='vpcId', type=d.T.string)]),
        withVpcId(vpcId): { spec+: { forProvider+: { vpc+: { vpcId: vpcId } } } },
        '#withVpcRegion':: d.fn(help='"(Private hosted zones only) The region that an Amazon VPC was created in."', args=[d.arg(name='vpcRegion', type=d.T.string)]),
        withVpcRegion(vpcRegion): { spec+: { forProvider+: { vpc+: { vpcRegion: vpcRegion } } } },
      },
      '#withDelegationSetId':: d.fn(help='"DelegationSetId let you associate a reusable delegation set with this hosted zone. It has to be the ID that Amazon Route 53 assigned to the reusable delegation set when you created it. For more information about reusable delegation sets, see CreateReusableDelegationSet (https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateReusableDelegationSet.html)."', args=[d.arg(name='delegationSetId', type=d.T.string)]),
      withDelegationSetId(delegationSetId): { spec+: { forProvider+: { delegationSetId: delegationSetId } } },
      '#withName':: d.fn(help="\"The name of the domain. Specify a fully qualified domain name, for example, www.example.com. The trailing dot is optional; Amazon Route 53 assumes that the domain name is fully qualified. This means that Route 53 treats www.example.com (without a trailing dot) and www.example.com. (with a trailing dot) as identical. \\n If you're creating a public hosted zone, this is the name you have registered with your DNS registrar. If your domain name is registered with a registrar other than Route 53, change the name servers for your domain to the set of NameServers that CreateHostedHostedZone returns in DelegationSet.\"", args=[d.arg(name='name', type=d.T.string)]),
