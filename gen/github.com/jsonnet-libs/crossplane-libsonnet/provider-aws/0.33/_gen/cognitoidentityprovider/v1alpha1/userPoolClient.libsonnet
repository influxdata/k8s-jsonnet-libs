{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#tokenValidityUnits':: d.obj(help='"The units in which the validity times are represented in. Default for RefreshToken is days, and default for ID and access tokens are hours."'),
      tokenValidityUnits: {
      ...
      '#withAccessTokenValidity':: d.fn(help='"The time limit, between 5 minutes and 1 day, after which the access token is no longer valid and cannot be used. This value will be overridden if you have entered a value in TokenValidityUnits."', args=[d.arg(name='accessTokenValidity', type=d.T.integer)]),
      ...
      '#withAllowedOAuthFlowsUserPoolClient':: d.fn(help='"Set to true if the client is allowed to follow the OAuth protocol when interacting with Cognito user pools."', args=[d.arg(name='allowedOAuthFlowsUserPoolClient', type=d.T.boolean)]),
      ...
      '#withEnableTokenRevocation':: d.fn(help="\"Enables or disables token revocation. For more information about revoking tokens, see RevokeToken (https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_RevokeToken.html). \\n If you don't include this parameter, token revocation is automatically enabled for the new user pool client.\"", args=[d.arg(name='enableTokenRevocation', type=d.T.boolean)]),
      withEnableTokenRevocation(enableTokenRevocation): { spec+: { forProvider+: { enableTokenRevocation: enableTokenRevocation } } },
      '#withExplicitAuthFlows':: d.fn(help='"The authentication flows that are supported by the user pool clients. Flow names without the ALLOW_ prefix are deprecated in favor of new names with the ALLOW_ prefix. Note that values with ALLOW_ prefix cannot be used along with values without ALLOW_ prefix. \\n Valid values include: \\n * ALLOW_ADMIN_USER_PASSWORD_AUTH: Enable admin based user password authentication flow ADMIN_USER_PASSWORD_AUTH. This setting replaces the ADMIN_NO_SRP_AUTH setting. With this authentication flow, Cognito receives the password in the request instead of using the SRP (Secure Remote Password protocol) protocol to verify passwords. \\n * ALLOW_CUSTOM_AUTH: Enable Lambda trigger based authentication. \\n * ALLOW_USER_PASSWORD_AUTH: Enable user password-based authentication. In this flow, Cognito receives the password in the request instead of using the SRP protocol to verify passwords. \\n * ALLOW_USER_SRP_AUTH: Enable SRP based authentication. \\n * ALLOW_REFRESH_TOKEN_AUTH: Enable authflow to refresh tokens."', args=[d.arg(name='explicitAuthFlows', type=d.T.array)]),
      ...
      '#withExplicitAuthFlowsMixin':: d.fn(help='"The authentication flows that are supported by the user pool clients. Flow names without the ALLOW_ prefix are deprecated in favor of new names with the ALLOW_ prefix. Note that values with ALLOW_ prefix cannot be used along with values without ALLOW_ prefix. \\n Valid values include: \\n * ALLOW_ADMIN_USER_PASSWORD_AUTH: Enable admin based user password authentication flow ADMIN_USER_PASSWORD_AUTH. This setting replaces the ADMIN_NO_SRP_AUTH setting. With this authentication flow, Cognito receives the password in the request instead of using the SRP (Secure Remote Password protocol) protocol to verify passwords. \\n * ALLOW_CUSTOM_AUTH: Enable Lambda trigger based authentication. \\n * ALLOW_USER_PASSWORD_AUTH: Enable user password-based authentication. In this flow, Cognito receives the password in the request instead of using the SRP protocol to verify passwords. \\n * ALLOW_USER_SRP_AUTH: Enable SRP based authentication. \\n * ALLOW_REFRESH_TOKEN_AUTH: Enable authflow to refresh tokens."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='explicitAuthFlows', type=d.T.array)]),
      ...
      '#withIdTokenValidity':: d.fn(help='"The time limit, between 5 minutes and 1 day, after which the ID token is no longer valid and cannot be used. This value will be overridden if you have entered a value in TokenValidityUnits."', args=[d.arg(name='idTokenValidity', type=d.T.integer)]),
      ...
      '#withPreventUserExistenceErrors':: d.fn(help='"Use this setting to choose which errors and responses are returned by Cognito APIs during authentication, account confirmation, and password recovery when the user does not exist in the user pool. When set to ENABLED and the user does not exist, authentication returns an error indicating either the username or password was incorrect, and account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to LEGACY, those APIs will return a UserNotFoundException exception if the user does not exist in the user pool. \\n Valid values include: \\n * ENABLED - This prevents user existence-related errors. \\n * LEGACY - This represents the old behavior of Cognito where user existence related errors are not prevented. \\n After February 15th 2020, the value of PreventUserExistenceErrors will default to ENABLED for newly created user pool clients if no value is provided."', args=[d.arg(name='preventUserExistenceErrors', type=d.T.string)]),
      ...
      '#withRefreshTokenValidity':: d.fn(help='"The time limit, in days, after which the refresh token is no longer valid and cannot be used."', args=[d.arg(name='refreshTokenValidity', type=d.T.integer)]),
