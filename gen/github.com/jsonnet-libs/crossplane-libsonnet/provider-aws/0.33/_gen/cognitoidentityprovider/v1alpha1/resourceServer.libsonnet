{
  ...
  '#':: d.pkg(name='resourceServer', url='', help='"ResourceServer is the Schema for the ResourceServers API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"ResourceServerParameters defines the desired state of ResourceServer"'),
    forProvider: {
      '#scopes':: d.obj(help='"A list of scopes. Each scope is map, where the keys are name and description."'),
      scopes: {
        '#withScopeDescription':: d.fn(help='', args=[d.arg(name='scopeDescription', type=d.T.string)]),
        withScopeDescription(scopeDescription): { scopeDescription: scopeDescription },
        '#withScopeName':: d.fn(help='', args=[d.arg(name='scopeName', type=d.T.string)]),
      ...
      '#withIdentifier':: d.fn(help='"A unique resource server identifier for the resource server. This could be an HTTPS endpoint where the resource server is located. For example, https://my-weather-api.example.com."', args=[d.arg(name='identifier', type=d.T.string)]),
      withIdentifier(identifier): { spec+: { forProvider+: { identifier: identifier } } },
      '#withName':: d.fn(help='"A friendly name for the resource server."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegion':: d.fn(help='"Region is which region the ResourceServer will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withScopes':: d.fn(help='"A list of scopes. Each scope is map, where the keys are name and description."', args=[d.arg(name='scopes', type=d.T.array)]),
      withScopes(scopes): { spec+: { forProvider+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } },
      '#withScopesMixin':: d.fn(help='"A list of scopes. Each scope is map, where the keys are name and description."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
