{
  ...
  '#':: d.pkg(name='identityProvider', url='', help='"IdentityProvider is the Schema for the IdentityProviders API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAttributeMapping':: d.fn(help='"A mapping of identity provider attributes to standard and custom user pool attributes."', args=[d.arg(name='attributeMapping', type=d.T.object)]),
      withAttributeMapping(attributeMapping): { spec+: { forProvider+: { attributeMapping: attributeMapping } } },
      '#withAttributeMappingMixin':: d.fn(help='"A mapping of identity provider attributes to standard and custom user pool attributes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='attributeMapping', type=d.T.object)]),
      withAttributeMappingMixin(attributeMapping): { spec+: { forProvider+: { attributeMapping+: attributeMapping } } },
      '#withIdpIdentifiers':: d.fn(help='"A list of identity provider identifiers."', args=[d.arg(name='idpIdentifiers', type=d.T.array)]),
      ...
      '#withProviderType':: d.fn(help='"The identity provider type."', args=[d.arg(name='providerType', type=d.T.string)]),
      withProviderType(providerType): { spec+: { forProvider+: { providerType: providerType } } },
      '#withRegion':: d.fn(help='"Region is which region the IdentityProvider will be created."', args=[d.arg(name='region', type=d.T.string)]),
