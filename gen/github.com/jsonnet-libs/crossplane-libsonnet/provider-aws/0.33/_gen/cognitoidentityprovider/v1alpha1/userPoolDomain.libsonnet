{
  ...
  '#':: d.pkg(name='userPoolDomain', url='', help='"UserPoolDomain is the Schema for the UserPoolDomains API"'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"UserPoolDomainParameters defines the desired state of UserPoolDomain"'),
    forProvider: {
      '#customDomainConfig':: d.obj(help='"The configuration for a custom domain that hosts the sign-up and sign-in webpages for your application. \\n Provide this parameter only if you want to use a custom domain for your user pool. Otherwise, you can exclude this parameter and use the Amazon Cognito hosted domain instead. \\n For more information about the hosted domain and custom domains, see Configuring a User Pool Domain (https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-assign-domain.html)."'),
      customDomainConfig: {
        '#withCertificateARN':: d.fn(help='', args=[d.arg(name='certificateARN', type=d.T.string)]),
        withCertificateARN(certificateARN): { spec+: { forProvider+: { customDomainConfig+: { certificateARN: certificateARN } } } },
      },
      ...
      '#withRegion':: d.fn(help='"Region is which region the UserPoolDomain will be created."', args=[d.arg(name='region', type=d.T.string)]),
