{
  ...
  '#':: d.pkg(name='workGroup', url='', help='"WorkGroup is the Schema for the WorkGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#configuration':: d.obj(help="\"The configuration for the workgroup, which includes the location in Amazon S3 where query results are stored, the encryption configuration, if any, used for encrypting query results, whether the Amazon CloudWatch Metrics are enabled for the workgroup, the limit for the amount of bytes scanned (cutoff) per query, if it is specified, and whether workgroup's settings (specified with EnforceWorkGroupConfiguration) in the WorkGroupConfiguration override client-side settings. See WorkGroupConfiguration$EnforceWorkGroupConfiguration.\""),
      configuration: {
        '#engineVersion':: d.obj(help='"The Athena engine version for running queries."'),
        engineVersion: {
          '#withEffectiveEngineVersion':: d.fn(help='', args=[d.arg(name='effectiveEngineVersion', type=d.T.string)]),
          withEffectiveEngineVersion(effectiveEngineVersion): { spec+: { forProvider+: { configuration+: { engineVersion+: { effectiveEngineVersion: effectiveEngineVersion } } } } },
          '#withSelectedEngineVersion':: d.fn(help='', args=[d.arg(name='selectedEngineVersion', type=d.T.string)]),
        ...
        '#resultConfiguration':: d.obj(help='"The location in Amazon S3 where query results are stored and the encryption option, if any, used for query results. These are known as \\"client-side settings\\". If workgroup settings override client-side settings, then the query uses the workgroup settings."'),
        resultConfiguration: {
          '#encryptionConfiguration':: d.obj(help='"If query results are encrypted in Amazon S3, indicates the encryption option used (for example, SSE-KMS or CSE-KMS) and key information."'),
          encryptionConfiguration: {
            '#withEncryptionOption':: d.fn(help='', args=[d.arg(name='encryptionOption', type=d.T.string)]),
            ...
            '#withKmsKey':: d.fn(help='', args=[d.arg(name='kmsKey', type=d.T.string)]),
            withKmsKey(kmsKey): { spec+: { forProvider+: { configuration+: { resultConfiguration+: { encryptionConfiguration+: { kmsKey: kmsKey } } } } } },
          },
          '#withOutputLocation':: d.fn(help='', args=[d.arg(name='outputLocation', type=d.T.string)]),
          withOutputLocation(outputLocation): { spec+: { forProvider+: { configuration+: { resultConfiguration+: { outputLocation: outputLocation } } } } },
        },
        '#withBytesScannedCutoffPerQuery':: d.fn(help='', args=[d.arg(name='bytesScannedCutoffPerQuery', type=d.T.integer)]),
        ...
        '#withEnforceWorkGroupConfiguration':: d.fn(help='', args=[d.arg(name='enforceWorkGroupConfiguration', type=d.T.boolean)]),
        ...
        '#withPublishCloudWatchMetricsEnabled':: d.fn(help='', args=[d.arg(name='publishCloudWatchMetricsEnabled', type=d.T.boolean)]),
        ...
        '#withRequesterPaysEnabled':: d.fn(help='', args=[d.arg(name='requesterPaysEnabled', type=d.T.boolean)]),
        withRequesterPaysEnabled(requesterPaysEnabled): { spec+: { forProvider+: { configuration+: { requesterPaysEnabled: requesterPaysEnabled } } } },
      },
      '#tags':: d.obj(help='"A list of comma separated tags to add to the workgroup that is created."'),
      tags: {
      ...
      '#withDescription':: d.fn(help='"The workgroup description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withRegion':: d.fn(help='"Region is which region the WorkGroup will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"A list of comma separated tags to add to the workgroup that is created."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"A list of comma separated tags to add to the workgroup that is created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
