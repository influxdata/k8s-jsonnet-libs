{
  ...
  '#':: d.pkg(name='stream', url='', help='"Stream is the Schema for the Streams API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#enhancedMetrics':: d.obj(help='"List of shard-level metrics. \\n The following are the valid shard-level metrics. The value \\"ALL\\" enhances every metric. \\n * IncomingBytes \\n * IncomingRecords \\n * OutgoingBytes \\n * OutgoingRecords \\n * WriteProvisionedThroughputExceeded \\n * ReadProvisionedThroughputExceeded \\n * IteratorAgeMilliseconds \\n * ALL \\n For more information, see Monitoring the Amazon Kinesis Data Streams Service with Amazon CloudWatch (https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html) in the Amazon Kinesis Data Streams Developer Guide."'),
      enhancedMetrics: {
        '#withShardLevelMetrics':: d.fn(help='', args=[d.arg(name='shardLevelMetrics', type=d.T.array)]),
        withShardLevelMetrics(shardLevelMetrics): { shardLevelMetrics: if std.isArray(v=shardLevelMetrics) then shardLevelMetrics else [shardLevelMetrics] },
        '#withShardLevelMetricsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='shardLevelMetrics', type=d.T.array)]),
        withShardLevelMetricsMixin(shardLevelMetrics): { shardLevelMetrics+: if std.isArray(v=shardLevelMetrics) then shardLevelMetrics else [shardLevelMetrics] },
      },
      '#kmsKeyARNRef':: d.obj(help='"A Reference to a named object."'),
      kmsKeyARNRef: {
      ...
      '#kmsKeyARNSelector':: d.obj(help='"A Selector selects an object."'),
      kmsKeyARNSelector: {
      ...
      '#tags':: d.obj(help=''),
      tags: {
        '#withKey':: d.fn(help='"A unique identifier for the tag."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { key: key },
        '#withValue':: d.fn(help='"An optional string, typically used to describe or define the tag."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withEnforceConsumerDeletion':: d.fn(help='"If this parameter is unset (null) or if you set it to false, and the stream has registered consumers, the call to DeleteStream fails with a ResourceInUseException."', args=[d.arg(name='enforceConsumerDeletion', type=d.T.boolean)]),
      withEnforceConsumerDeletion(enforceConsumerDeletion): { spec+: { forProvider+: { enforceConsumerDeletion: enforceConsumerDeletion } } },
      '#withEnhancedMetrics':: d.fn(help='"List of shard-level metrics. \\n The following are the valid shard-level metrics. The value \\"ALL\\" enhances every metric. \\n * IncomingBytes \\n * IncomingRecords \\n * OutgoingBytes \\n * OutgoingRecords \\n * WriteProvisionedThroughputExceeded \\n * ReadProvisionedThroughputExceeded \\n * IteratorAgeMilliseconds \\n * ALL \\n For more information, see Monitoring the Amazon Kinesis Data Streams Service with Amazon CloudWatch (https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html) in the Amazon Kinesis Data Streams Developer Guide."', args=[d.arg(name='enhancedMetrics', type=d.T.array)]),
      withEnhancedMetrics(enhancedMetrics): { spec+: { forProvider+: { enhancedMetrics: if std.isArray(v=enhancedMetrics) then enhancedMetrics else [enhancedMetrics] } } },
      '#withEnhancedMetricsMixin':: d.fn(help='"List of shard-level metrics. \\n The following are the valid shard-level metrics. The value \\"ALL\\" enhances every metric. \\n * IncomingBytes \\n * IncomingRecords \\n * OutgoingBytes \\n * OutgoingRecords \\n * WriteProvisionedThroughputExceeded \\n * ReadProvisionedThroughputExceeded \\n * IteratorAgeMilliseconds \\n * ALL \\n For more information, see Monitoring the Amazon Kinesis Data Streams Service with Amazon CloudWatch (https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html) in the Amazon Kinesis Data Streams Developer Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enhancedMetrics', type=d.T.array)]),
      withEnhancedMetricsMixin(enhancedMetrics): { spec+: { forProvider+: { enhancedMetrics+: if std.isArray(v=enhancedMetrics) then enhancedMetrics else [enhancedMetrics] } } },
      ...
      '#withRegion':: d.fn(help='"Region is which region the Stream will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRetentionPeriodHours':: d.fn(help='"The retention period of the stream, in hours. Default: 24 hours"', args=[d.arg(name='retentionPeriodHours', type=d.T.integer)]),
      withRetentionPeriodHours(retentionPeriodHours): { spec+: { forProvider+: { retentionPeriodHours: retentionPeriodHours } } },
      '#withShardCount':: d.fn(help='"The number of shards that the stream will use. The throughput of the stream is a function of the number of shards; more shards are required for greater provisioned throughput."', args=[d.arg(name='shardCount', type=d.T.integer)]),
