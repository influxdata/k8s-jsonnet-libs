{
  ...
  spec: {
    ...
    forProvider: {
      '#brokerIDRef':: d.obj(help='"BrokerIDRef is a reference to a Broker used to set BrokerID."'),
      brokerIDRef: {
      ...
      '#brokerIDSelector':: d.obj(help='"BrokerIDSelector selects a reference to a Broker used to set BrokerID."'),
      brokerIDSelector: {
      ...
      '#withBrokerID':: d.fn(help='', args=[d.arg(name='brokerID', type=d.T.string)]),
