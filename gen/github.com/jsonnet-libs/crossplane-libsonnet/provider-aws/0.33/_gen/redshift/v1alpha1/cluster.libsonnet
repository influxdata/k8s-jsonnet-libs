    ...
    forProvider: {
      ...
      clusterSecurityGroupSelector: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { clusterSecurityGroupSelector+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { clusterSecurityGroupSelector+: { policy+: { resolve: resolve } } } } },
        },
