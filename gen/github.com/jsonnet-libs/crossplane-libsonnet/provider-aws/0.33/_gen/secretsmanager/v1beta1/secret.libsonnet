{
  ...
  spec: {
    ...
    forProvider: {
      '#addReplicaRegions':: d.obj(help='"(Optional) Add a list of regions to replicate secrets. Secrets Manager replicates the KMSKeyID objects to the list of regions specified in the parameter."'),
      addReplicaRegions: {
