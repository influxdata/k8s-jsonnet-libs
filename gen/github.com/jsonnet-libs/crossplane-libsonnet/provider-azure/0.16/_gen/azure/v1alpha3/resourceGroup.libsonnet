{
  ...
  '#':: d.pkg(name='resourceGroup', url='', help='"A ResourceGroup is a managed resource that represents an Azure Resource Group."'),
  ...
  spec: {
    ...
    '#withLocation':: d.fn(help='"Location of the resource group. See the  official list of valid regions - https://azure.microsoft.com/en-us/global-infrastructure/regions/"', args=[d.arg(name='location', type=d.T.string)]),
