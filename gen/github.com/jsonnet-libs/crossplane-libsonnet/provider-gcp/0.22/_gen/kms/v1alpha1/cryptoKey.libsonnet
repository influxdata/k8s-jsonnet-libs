{
  ...
  '#':: d.pkg(name='cryptoKey', url='', help='"CryptoKey is a managed resource that represents a Google KMS Crypto Key."'),
  ...
  '#new':: d.fn(help='new returns an instance of CryptoKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    '#forProvider':: d.obj(help='"CryptoKeyParameters defines parameters for a desired KMS CryptoKey https://cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.cryptoKeys"'),
    forProvider: {
      '#keyRingRef':: d.obj(help='"KeyRingRef references a KeyRing and retrieves its URI"'),
      keyRingRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { keyRingRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { keyRingRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { keyRingRef+: { name: name } } } },
      },
      '#keyRingSelector':: d.obj(help='"KeyRingSelector selects a reference to a KeyRing"'),
      keyRingSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { keyRingSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { keyRingSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { keyRingSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { keyRingSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { keyRingSelector+: { matchLabels+: matchLabels } } } },
      },
      '#versionTemplate':: d.obj(help='"VersionTemplate: A template describing settings for new CryptoKeyVersion instances. The properties of new CryptoKeyVersion instances created by either CreateCryptoKeyVersion or auto-rotation are controlled by this template."'),
      versionTemplate: {
        '#withAlgorithm':: d.fn(help='"Algorithm: Required. Algorithm to use when creating a CryptoKeyVersion based on this template. \\n For backwards compatibility, GOOGLE_SYMMETRIC_ENCRYPTION is implied if both this field is omitted and CryptoKey.purpose is ENCRYPT_DECRYPT. \\n Possible values: \\"CRYPTO_KEY_VERSION_ALGORITHM_UNSPECIFIED\\" - Not specified. \\"GOOGLE_SYMMETRIC_ENCRYPTION\\" - Creates symmetric encryption keys. \\"RSA_SIGN_PSS_2048_SHA256\\" - RSASSA-PSS 2048 bit key with a SHA256 digest. \\"RSA_SIGN_PSS_3072_SHA256\\" - RSASSA-PSS 3072 bit key with a SHA256 digest. \\"RSA_SIGN_PSS_4096_SHA256\\" - RSASSA-PSS 4096 bit key with a SHA256 digest. \\"RSA_SIGN_PSS_4096_SHA512\\" - RSASSA-PSS 4096 bit key with a SHA512 digest. \\"RSA_SIGN_PKCS1_2048_SHA256\\" - RSASSA-PKCS1-v1_5 with a 2048 bit key and a SHA256 digest. \\"RSA_SIGN_PKCS1_3072_SHA256\\" - RSASSA-PKCS1-v1_5 with a 3072 bit key and a SHA256 digest. \\"RSA_SIGN_PKCS1_4096_SHA256\\" - RSASSA-PKCS1-v1_5 with a 4096 bit key and a SHA256 digest. \\"RSA_SIGN_PKCS1_4096_SHA512\\" - RSASSA-PKCS1-v1_5 with a 4096 bit key and a SHA512 digest. \\"RSA_DECRYPT_OAEP_2048_SHA256\\" - RSAES-OAEP 2048 bit key with a SHA256 digest. \\"RSA_DECRYPT_OAEP_3072_SHA256\\" - RSAES-OAEP 3072 bit key with a SHA256 digest. \\"RSA_DECRYPT_OAEP_4096_SHA256\\" - RSAES-OAEP 4096 bit key with a SHA256 digest. \\"RSA_DECRYPT_OAEP_4096_SHA512\\" - RSAES-OAEP 4096 bit key with a SHA512 digest. \\"EC_SIGN_P256_SHA256\\" - ECDSA on the NIST P-256 curve with a SHA256 digest. \\"EC_SIGN_P384_SHA384\\" - ECDSA on the NIST P-384 curve with a SHA384 digest. \\"EXTERNAL_SYMMETRIC_ENCRYPTION\\" - Algorithm representing symmetric encryption by an external key manager."', args=[d.arg(name='algorithm', type=d.T.string)]),
        withAlgorithm(algorithm): { spec+: { forProvider+: { versionTemplate+: { algorithm: algorithm } } } },
        '#withProtectionLevel':: d.fn(help='"ProtectionLevel: ProtectionLevel to use when creating a CryptoKeyVersion based on this template. Immutable. Defaults to SOFTWARE. \\n Possible values: \\"PROTECTION_LEVEL_UNSPECIFIED\\" - Not specified. \\"SOFTWARE\\" - Crypto operations are performed in software. \\"HSM\\" - Crypto operations are performed in a Hardware Security Module. \\"EXTERNAL\\" - Crypto operations are performed by an external key manager."', args=[d.arg(name='protectionLevel', type=d.T.string)]),
        withProtectionLevel(protectionLevel): { spec+: { forProvider+: { versionTemplate+: { protectionLevel: protectionLevel } } } },
      },
      '#withKeyRing':: d.fn(help='"KeyRing: The RRN of the KeyRing to which this CryptoKey belongs, provided by the client when initially creating the CryptoKey."', args=[d.arg(name='keyRing', type=d.T.string)]),
      withKeyRing(keyRing): { spec+: { forProvider+: { keyRing: keyRing } } },
      '#withLabels':: d.fn(help='"Labels: Labels with user-defined metadata. For more information, see [Labeling Keys](/kms/docs/labeling-keys)."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels: Labels with user-defined metadata. For more information, see [Labeling Keys](/kms/docs/labeling-keys)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withNextRotationTime':: d.fn(help='"NextRotationTime: At next_rotation_time, the Key Management Service will automatically: \\n 1. Create a new version of this CryptoKey. 2. Mark the new version as primary. \\n Key rotations performed manually via CreateCryptoKeyVersion and UpdateCryptoKeyPrimaryVersion do not affect next_rotation_time. \\n Keys with purpose ENCRYPT_DECRYPT support automatic rotation. For other keys, this field must be omitted."', args=[d.arg(name='nextRotationTime', type=d.T.string)]),
      withNextRotationTime(nextRotationTime): { spec+: { forProvider+: { nextRotationTime: nextRotationTime } } },
      '#withPurpose':: d.fn(help='"Purpose: Immutable. The immutable purpose of this CryptoKey. \\n Possible values: \\"CRYPTO_KEY_PURPOSE_UNSPECIFIED\\" - Not specified. \\"ENCRYPT_DECRYPT\\" - CryptoKeys with this purpose may be used with Encrypt and Decrypt. \\"ASYMMETRIC_SIGN\\" - CryptoKeys with this purpose may be used with AsymmetricSign and GetPublicKey. \\"ASYMMETRIC_DECRYPT\\" - CryptoKeys with this purpose may be used with AsymmetricDecrypt and GetPublicKey."', args=[d.arg(name='purpose', type=d.T.string)]),
      withPurpose(purpose): { spec+: { forProvider+: { purpose: purpose } } },
      '#withRotationPeriod':: d.fn(help='"RotationPeriod: next_rotation_time will be advanced by this period when the service automatically rotates a key. Must be at least 24 hours and at most 876,000 hours. \\n If rotation_period is set, next_rotation_time must also be set. \\n Keys with purpose ENCRYPT_DECRYPT support automatic rotation. For other keys, this field must be omitted."', args=[d.arg(name='rotationPeriod', type=d.T.string)]),
      withRotationPeriod(rotationPeriod): { spec+: { forProvider+: { rotationPeriod: rotationPeriod } } },
    },
