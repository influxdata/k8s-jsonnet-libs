{
  ...
  '#':: d.pkg(name='globalAddress', url='', help='"A GlobalAddress is a managed resource that represents a Google Compute Engine Global Address."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalAddress', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
