{
  ...
  '#':: d.pkg(name='address', url='', help='"An Address is a managed resource that represents a Google Compute Engine Address."'),
  ...
  '#new':: d.fn(help='new returns an instance of Address', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#networkRef':: d.obj(help='"NetworkRef references a Network to retrieve its URI"'),
      networkRef: {
      ...
      '#subnetworkRef':: d.obj(help='"SubnetworkRef references a Subnetwork to retrieve its URI"'),
      subnetworkRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#subnetworkSelector':: d.obj(help='"SubnetworkSelector selects a reference to a Subnetwork"'),
      subnetworkSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withAddress':: d.fn(help='"Address: The static IP address represented by this resource."', args=[d.arg(name='address', type=d.T.string)]),
      withAddress(address): { spec+: { forProvider+: { address: address } } },
      '#withAddressType':: d.fn(help='"AddressType: The type of address to reserve, either INTERNAL or EXTERNAL. If unspecified, defaults to EXTERNAL. \\n Possible values: \\"EXTERNAL\\" \\"INTERNAL\\" \\"UNSPECIFIED_TYPE\\', args=[d.arg(name='addressType', type=d.T.string)]),
      withAddressType(addressType): { spec+: { forProvider+: { addressType: addressType } } },
      '#withDescription':: d.fn(help='"Description: An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIpVersion':: d.fn(help='"IPVersion: The IP version that will be used by this address. Valid options are IPV4 or IPV6. \\n Possible values: \\"IPV4\\" \\"IPV6\\" \\"UNSPECIFIED_VERSION\\', args=[d.arg(name='ipVersion', type=d.T.string)]),
      withIpVersion(ipVersion): { spec+: { forProvider+: { ipVersion: ipVersion } } },
      '#withNetwork':: d.fn(help='"Network: The URL of the network in which to reserve the address. This field can only be used with INTERNAL type with the VPC_PEERING purpose."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withPrefixLength':: d.fn(help='"PrefixLength: The prefix length if the resource represents an IP range."', args=[d.arg(name='prefixLength', type=d.T.integer)]),
      withPrefixLength(prefixLength): { spec+: { forProvider+: { prefixLength: prefixLength } } },
      '#withPurpose':: d.fn(help='"Purpose: The purpose of this resource, which can be one of the following values: - `GCE_ENDPOINT` for addresses that are used by VM instances, alias IP ranges, load balancers, and similar resources. - `DNS_RESOLVER` for a DNS resolver address in a subnetwork for a Cloud DNS inbound forwarder IP addresses (regional internal IP address in a subnet of a VPC network) - `VPC_PEERING` for global internal IP addresses used for private services access allocated ranges. - `NAT_AUTO` for the regional external IP addresses used by Cloud NAT when allocating addresses using automatic NAT IP address allocation. - `IPSEC_INTERCONNECT` for addresses created from a private IP range that are reserved for a VLAN attachment in an IPsec-encrypted Cloud Interconnect configuration. These addresses are regional resources. Not currently available publicly. - `SHARED_LOADBALANCER_VIP` for an internal IP address that is assigned to multiple internal forwarding rules. - `PRIVATE_SERVICE_CONNECT` for a private network address that is used to configure Private Service Connect. Only global internal addresses can use this purpose. Possible values: \\"DNS_RESOLVER\\" \\"GCE_ENDPOINT\\" \\"NAT_AUTO\\" \\"VPC_PEERING\\" \\"IPSEC_INTERCONNECT\\" \\"SHARED_LOADBALANCER_VIP\\" \\"PRIVATE_SERVICE_CONNECT\\', args=[d.arg(name='purpose', type=d.T.string)]),
      withPurpose(purpose): { spec+: { forProvider+: { purpose: purpose } } },
      '#withRegion':: d.fn(help='"Region: An optional region in which to create the address."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSubnetwork':: d.fn(help="\"Subnetwork: The URL of the subnetwork in which to reserve the address. If an IP address is specified, it must be within the subnetwork's IP range. This field can only be used with INTERNAL type with a GCE_ENDPOINT or DNS_RESOLVER purpose.\"", args=[d.arg(name='subnetwork', type=d.T.string)]),
