{
  ...
  '#':: d.pkg(name='network', url='', help='"A Network is a managed resource that represents a Google Compute Engine VPC Network."'),
  ...
  spec: {
    '#forProvider':: d.obj(help='"NetworkParameters define the desired state of a Google Compute Engine VPC Network. Most fields map directly to a Network: https://cloud.google.com/compute/docs/reference/rest/v1/networks"'),
    forProvider: {
      '#routingConfig':: d.obj(help='"RoutingConfig: The network-level routing configuration for this network. Used by Cloud Router to determine what type of network-wide routing behavior to enforce."'),
      routingConfig: {
        '#withRoutingMode':: d.fn(help="\"RoutingMode: The network-wide routing mode to use. If set to REGIONAL, this network's Cloud Routers will only advertise routes with subnets of this network in the same region as the router. If set to GLOBAL, this network's Cloud Routers will advertise routes with all subnets of this network, across regions. \\n Possible values: \\\"GLOBAL\\\" \\\"REGIONAL\\", args=[d.arg(name='routingMode', type=d.T.string)]),
        withRoutingMode(routingMode): { spec+: { forProvider+: { routingConfig+: { routingMode: routingMode } } } },
      },
      '#withAutoCreateSubnetworks':: d.fn(help='"AutoCreateSubnetworks: When set to true, the VPC network is created in \\"auto\\" mode. When set to false, the VPC network is created in \\"custom\\" mode. When set to nil, the VPC network is created in \\"legacy\\" mode which will be deprecated by GCP soon. \\n An auto mode VPC network starts with one subnet per region. Each subnet has a predetermined range as described in Auto mode VPC network IP ranges. \\n This field can only be updated from true to false after creation using switchToCustomMode."', args=[d.arg(name='autoCreateSubnetworks', type=d.T.boolean)]),
      withAutoCreateSubnetworks(autoCreateSubnetworks): { spec+: { forProvider+: { autoCreateSubnetworks: autoCreateSubnetworks } } },
