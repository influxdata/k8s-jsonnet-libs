{
  ...
  '#':: d.pkg(name='connection', url='', help='"A Connection is a managed resource that represents a Google Cloud Service Networking Connection."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#reservedPeeringRangeSelector':: d.obj(help='"ReservedPeeringRangeSelector selects a set of references to GlobalAddress objects."'),
      reservedPeeringRangeSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { reservedPeeringRangeSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { reservedPeeringRangeSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { reservedPeeringRangeSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { reservedPeeringRangeSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { reservedPeeringRangeSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withNetwork':: d.fn(help="\"Network: The name of service consumer's VPC network that's connected with service producer network, in the following format: `projects/{project}/global/networks/{network}`. `{project}` is a project number, such as in `12345` that includes the VPC service consumer's VPC network. `{network}` is the name of the service consumer's VPC network.\"", args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withParent':: d.fn(help="\"Parent: The service that is managing peering connectivity for a service producer's organization. For Google services that support this functionality, this value is services/servicenetworking.googleapis.com.\"", args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withReservedPeeringRangeRefs':: d.fn(help='"ReservedPeeringRangeRefs is a set of references to GlobalAddress objects"', args=[d.arg(name='reservedPeeringRangeRefs', type=d.T.array)]),
      withReservedPeeringRangeRefs(reservedPeeringRangeRefs): { spec+: { forProvider+: { reservedPeeringRangeRefs: if std.isArray(v=reservedPeeringRangeRefs) then reservedPeeringRangeRefs else [reservedPeeringRangeRefs] } } },
      '#withReservedPeeringRangeRefsMixin':: d.fn(help='"ReservedPeeringRangeRefs is a set of references to GlobalAddress objects"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservedPeeringRangeRefs', type=d.T.array)]),
      withReservedPeeringRangeRefsMixin(reservedPeeringRangeRefs): { spec+: { forProvider+: { reservedPeeringRangeRefs+: if std.isArray(v=reservedPeeringRangeRefs) then reservedPeeringRangeRefs else [reservedPeeringRangeRefs] } } },
      '#withReservedPeeringRanges':: d.fn(help='"ReservedPeeringRanges: The name of one or more allocated IP address ranges for this service producer of type `PEERING`."', args=[d.arg(name='reservedPeeringRanges', type=d.T.array)]),
      withReservedPeeringRanges(reservedPeeringRanges): { spec+: { forProvider+: { reservedPeeringRanges: if std.isArray(v=reservedPeeringRanges) then reservedPeeringRanges else [reservedPeeringRanges] } } },
      '#withReservedPeeringRangesMixin':: d.fn(help='"ReservedPeeringRanges: The name of one or more allocated IP address ranges for this service producer of type `PEERING`."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservedPeeringRanges', type=d.T.array)]),
      withReservedPeeringRangesMixin(reservedPeeringRanges): { spec+: { forProvider+: { reservedPeeringRanges+: if std.isArray(v=reservedPeeringRanges) then reservedPeeringRanges else [reservedPeeringRanges] } } },
    },
