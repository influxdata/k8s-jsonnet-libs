{
  ...
  '#':: d.pkg(name='serviceAccountPolicy', url='', help='"ServiceAccountPolicy is a managed resource that represents a Google IAM ServiceAccount."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceAccountPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
