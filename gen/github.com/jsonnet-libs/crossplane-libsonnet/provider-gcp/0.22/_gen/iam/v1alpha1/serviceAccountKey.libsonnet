{
  ...
  '#':: d.pkg(name='serviceAccountKey', url='', help='"ServiceAccountKey is a managed resource that represents a Google IAM Service Account Key."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceAccountKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#serviceAccountRef':: d.obj(help='"ServiceAccountRef references a ServiceAccount and retrieves its URI"'),
      serviceAccountRef: {
      ...
      '#serviceAccountSelector':: d.obj(help='"ServiceAccountSelector selects a reference to a ServiceAccount"'),
      ...
      '#withKeyAlgorithm':: d.fn(help='"KeyAlgorithm is an optional user-specified string that specifies the type of key and algorithm to use for the key. The default is currently a 2048-bit RSA key. However this may change in the future. Possible values: \\"KEY_ALG_UNSPECIFIED\\" - Not specified. \\"KEY_ALG_RSA_1024\\" - 1024-bit RSA key \\"KEY_ALG_RSA_2048\\" - 2048-bit RSA key"', args=[d.arg(name='keyAlgorithm', type=d.T.string)]),
      withKeyAlgorithm(keyAlgorithm): { spec+: { forProvider+: { keyAlgorithm: keyAlgorithm } } },
      '#withPrivateKeyType':: d.fn(help='"PrivateKeyType is an optional specification of the output format of the generated private key. The default value is TYPE_GOOGLE_CREDENTIALS_FILE, which corresponds to the Google Credentials File Format. Possible values: \\"TYPE_UNSPECIFIED\\" - Not specified. Equivalent to TYPE_GOOGLE_CREDENTIALS_FILE. \\"TYPE_PKCS12_FILE\\" - Private key stored in a RFC7292 PKCS #12 document. Password for the PKCS #12 document is \\"notasecret\\". \\"TYPE_GOOGLE_CREDENTIALS_FILE\\" - Google Credentials File format."', args=[d.arg(name='privateKeyType', type=d.T.string)]),
      withPrivateKeyType(privateKeyType): { spec+: { forProvider+: { privateKeyType: privateKeyType } } },
      '#withPublicKeyType':: d.fn(help='"PublicKeyType is an optional specification of the output format for the associated public key. The default value is TYPE_RAW_PUBLIC_KEY. Possible values: \\"TYPE_NONE\\" - Not specified. Public key is not retrieved via Google Cloud API. \\"TYPE_X509_PEM_FILE\\" - X509 PEM format. \\"TYPE_RAW_PUBLIC_KEY\\" - Raw public key."', args=[d.arg(name='publicKeyType', type=d.T.string)]),
      withPublicKeyType(publicKeyType): { spec+: { forProvider+: { publicKeyType: publicKeyType } } },
      '#withServiceAccount':: d.fn(help='"ServiceAccount: The RRN of the referred ServiceAccount RRN is the relative resource name as defined by Google Cloud API design docs here: https://cloud.google.com/apis/design/resource_names#relative_resource_name An example value for the ServiceAccount field is as follows: projects/<project-name>/serviceAccounts/perfect-test-sa@crossplane-playground.iam.gserviceaccount.com"', args=[d.arg(name='serviceAccount', type=d.T.string)]),
