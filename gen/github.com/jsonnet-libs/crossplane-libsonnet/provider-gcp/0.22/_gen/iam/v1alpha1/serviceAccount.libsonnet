{
  ...
  '#':: d.pkg(name='serviceAccount', url='', help='"ServiceAccount is a managed resource that represents a Google IAM Service Account."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description is an optional user-specified opaque description of the service account. Must be less than or equal to 256 characters."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"DisplayName is an optional user-specified name for the service account. Must be less than or equal to 100 characters."', args=[d.arg(name='displayName', type=d.T.string)]),
