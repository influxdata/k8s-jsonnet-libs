{
  ...
  '#':: d.pkg(name='containerRegistry', url='', help='"ContainerRegistry is the Schema for the containerregistries API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ContainerRegistry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'registry.gcp.crossplane.io/v1alpha1',
    kind: 'ContainerRegistry',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ContainerRegistrySpec defines the desired state of ContainerRegistry"'),
  spec: {
    '#forProvider':: d.obj(help='"ContainerRegistryParameters define the desired state of a ContainerRegistry"'),
    forProvider: {
      '#withLocation':: d.fn(help='"The location of the registry. Possible Values: ASIA, EU, US"', args=[d.arg(name='location', type=d.T.string)]),
