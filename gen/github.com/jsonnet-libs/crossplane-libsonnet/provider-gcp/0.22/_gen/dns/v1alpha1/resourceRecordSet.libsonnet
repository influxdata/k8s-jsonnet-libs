{
  ...
  '#':: d.pkg(name='resourceRecordSet', url='', help='"ResourceRecordSet is a managed resource that represents a Resource Record Set in Cloud DNS"'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceRecordSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'dns.gcp.crossplane.io/v1alpha1',
    kind: 'ResourceRecordSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ResourceRecordSetSpec defines the desired state of a ResourceRecordSet."'),
  spec: {
    '#forProvider':: d.obj(help='"ResourceRecordSetParameters define the desired state of a ResourceRecordSet"'),
    forProvider: {
      '#withManagedZone':: d.fn(help='"Managed zone name that this ResourceRecordSet will be created in."', args=[d.arg(name='managedZone', type=d.T.string)]),
      withManagedZone(managedZone): { spec+: { forProvider+: { managedZone: managedZone } } },
      '#withRrdatas':: d.fn(help='"List of ResourceRecord datas as defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1)"', args=[d.arg(name='rrdatas', type=d.T.array)]),
      withRrdatas(rrdatas): { spec+: { forProvider+: { rrdatas: if std.isArray(v=rrdatas) then rrdatas else [rrdatas] } } },
      '#withRrdatasMixin':: d.fn(help='"List of ResourceRecord datas as defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1)"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rrdatas', type=d.T.array)]),
      withRrdatasMixin(rrdatas): { spec+: { forProvider+: { rrdatas+: if std.isArray(v=rrdatas) then rrdatas else [rrdatas] } } },
      '#withSignatureRrdatas':: d.fn(help='"List of Signature ResourceRecord datas, as defined in RFC 4034 (section 3.2)."', args=[d.arg(name='signatureRrdatas', type=d.T.array)]),
      withSignatureRrdatas(signatureRrdatas): { spec+: { forProvider+: { signatureRrdatas: if std.isArray(v=signatureRrdatas) then signatureRrdatas else [signatureRrdatas] } } },
      '#withSignatureRrdatasMixin':: d.fn(help='"List of Signature ResourceRecord datas, as defined in RFC 4034 (section 3.2)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='signatureRrdatas', type=d.T.array)]),
      withSignatureRrdatasMixin(signatureRrdatas): { spec+: { forProvider+: { signatureRrdatas+: if std.isArray(v=signatureRrdatas) then signatureRrdatas else [signatureRrdatas] } } },
      '#withTtl':: d.fn(help='"Number of seconds that this ResourceRecordSet can be cached by resolvers."', args=[d.arg(name='ttl', type=d.T.integer)]),
      withTtl(ttl): { spec+: { forProvider+: { ttl: ttl } } },
      '#withType':: d.fn(help='"The identifier of a supported record type."', args=[d.arg(name='type', type=d.T.string)]),
