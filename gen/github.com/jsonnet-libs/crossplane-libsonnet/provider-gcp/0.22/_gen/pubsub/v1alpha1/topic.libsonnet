{
  ...
  '#':: d.pkg(name='topic', url='', help='"Topic is a managed resource that represents a Google PubSub Topic."'),
  ...
  spec: {
    ...
    forProvider: {
      '#kmsKeyNameRef':: d.obj(help='"KmsKeyNameRef allows you to specify custom resource name of the KMS Key to fill KmsKeyName field."'),
      kmsKeyNameRef: {
      ...
      '#kmsKeyNameSelector':: d.obj(help='"KmsKeyNameSelector allows you to use selector constraints to select a KMS Key."'),
      kmsKeyNameSelector: {
      ...
      '#messageStoragePolicy':: d.obj(help='"MessageStoragePolicy is the policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect."'),
      messageStoragePolicy: {
        '#withAllowedPersistenceRegions':: d.fn(help='"AllowedPersistenceRegions is the list of IDs of GCP regions where messages that are published to the topic may be persisted in storage. Messages published by publishers running in non-allowed GCP regions (or running outside of GCP altogether) will be routed for storage in one of the allowed regions. An empty list means that no regions are allowed, and is not a valid configuration."', args=[d.arg(name='allowedPersistenceRegions', type=d.T.array)]),
        ...
        '#withAllowedPersistenceRegionsMixin':: d.fn(help='"AllowedPersistenceRegions is the list of IDs of GCP regions where messages that are published to the topic may be persisted in storage. Messages published by publishers running in non-allowed GCP regions (or running outside of GCP altogether) will be routed for storage in one of the allowed regions. An empty list means that no regions are allowed, and is not a valid configuration."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedPersistenceRegions', type=d.T.array)]),
      ...
      '#withKmsKeyName':: d.fn(help='"KmsKeyName is the resource name of the Cloud KMS CryptoKey to be used to protect access to messages published on this topic. \\n The expected format is `projects/*/locations/*/keyRings/*/cryptoKeys/*`."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      withKmsKeyName(kmsKeyName): { spec+: { forProvider+: { kmsKeyName: kmsKeyName } } },
      '#withLabels':: d.fn(help='"Labels are used as additional metadata on Topic."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels are used as additional metadata on Topic."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withMessageRetentionDuration':: d.fn(help="\"MessageRetentionDuration: Indicates the minimum duration to retain a message after it is published to the topic. If this field is set, messages published to the topic in the last `message_retention_duration` are always available to subscribers. For instance, it allows any attached subscription to seek to a timestamp (https://cloud.google.com/pubsub/docs/replay-overview#seek_to_a_time) that is up to `message_retention_duration` in the past. If this field is not set, message retention is controlled by settings on individual subscriptions. Cannot be more than 31 days or less than 10 minutes. \\n The duration must be in seconds, terminated by 's'. Example: \\\"1200s\\\". Avoid using fractional digits.\"", args=[d.arg(name='messageRetentionDuration', type=d.T.string)]),
