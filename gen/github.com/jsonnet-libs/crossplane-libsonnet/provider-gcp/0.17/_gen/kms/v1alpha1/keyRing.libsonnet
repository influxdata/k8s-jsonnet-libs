{
  ...
  '#':: d.pkg(name='keyRing', url='', help='"KeyRing is a managed resource that represents a Google KMS KeyRing"'),
  ...
  '#new':: d.fn(help='new returns an instance of KeyRing', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#withLocation':: d.fn(help="\"The location for the KeyRing. A full list of valid locations can be found by running 'gcloud kms locations list'.\"", args=[d.arg(name='location', type=d.T.string)]),
