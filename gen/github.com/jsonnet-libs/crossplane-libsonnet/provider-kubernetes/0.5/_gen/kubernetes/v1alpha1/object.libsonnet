{
  ...
  spec: {
    ...
    '#withManagementPolicy':: d.fn(help='"A ManagementPolicy determines what should happen to the underlying external resource when a managed resource is created, updated, deleted, or observed."', args=[d.arg(name='managementPolicy', type=d.T.string)]),
    withManagementPolicy(managementPolicy): { spec+: { managementPolicy: managementPolicy } },
