{
  ...
  '#':: d.pkg(name='compositeResourceDefinition', url='', help='"An CompositeResourceDefinition defines a new kind of composite infrastructure resource. The new resource is composed of other composite or managed infrastructure resources. [DEPRECATED]: Please use the identical v1 API instead. The v1beta1 API is scheduled to be removed in Crossplane v1.6."'),
  ...
  spec: {
    ...
    '#withConnectionSecretKeys':: d.fn(help='"ConnectionSecretKeys is the list of keys that will be exposed to the end user of the defined kind."', args=[d.arg(name='connectionSecretKeys', type=d.T.array)]),
    ...
    '#withConnectionSecretKeysMixin':: d.fn(help='"ConnectionSecretKeys is the list of keys that will be exposed to the end user of the defined kind."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='connectionSecretKeys', type=d.T.array)]),
    ...
    '#withVersions':: d.fn(help='"Versions is the list of all API versions of the defined composite resource. Version names are used to compute the order in which served versions are listed in API discovery. If the version string is \\"kube-like\\", it will sort above non \\"kube-like\\" version strings, which are ordered lexicographically. \\"Kube-like\\" versions start with a \\"v\\", then are followed by a number (the major version), then optionally the string \\"alpha\\" or \\"beta\\" and another number (the minor version). These are sorted first by GA > beta > alpha (where GA is a version with no suffix such as beta or alpha), and then by comparing major version, then minor version. An example sorted list of versions: v10, v2, v1, v11beta2, v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10. Note that all versions must have identical schemas; Crossplane does not currently support conversion between different version schemas."', args=[d.arg(name='versions', type=d.T.array)]),
