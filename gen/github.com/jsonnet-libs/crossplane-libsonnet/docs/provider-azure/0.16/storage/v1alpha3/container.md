---
permalink: /provider-azure/0.16/storage/v1alpha3/container/
---

# storage.v1alpha3.container
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPublicAccessType(publicAccessType)`](#fn-specwithpublicaccesstype)
...
### fn spec.withPublicAccessType

```ts
withPublicAccessType(publicAccessType)
```
