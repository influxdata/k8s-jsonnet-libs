---
permalink: /provider-sql/0.5/mysql/v1alpha1/providerConfig/
---

# mysql.v1alpha1.providerConfig
...
"A CredentialsSecretRef is a reference to a MySQL connection secret that contains the credentials that must be used to connect to the provider. +optional"
