---
permalink: /provider-sql/0.5/mssql/v1alpha1/user/
---
...
"DatabaseRef allows you to specify custom resource name of the Database to fill Database field."
...
"DatabaseSelector allows you to use selector constraints to select a Database."
