---
permalink: /provider-sql/0.5/mssql/v1alpha1/grant/
---

# mssql.v1alpha1.grant
...
"Permissions to be granted. See https://docs.microsoft.com/en-us/sql/t-sql/statements/grant-database-permissions-transact-sql?view=sql-server-ver15#remarks for available privileges."
