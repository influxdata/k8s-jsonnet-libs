---
permalink: /provider-gcp/0.17/gcp/v1alpha3/provider/
---

# gcp.v1alpha3.provider
...
"CredentialsSecretRef references a specific secret's key that contains the credentials that are used to connect to the GCP API."
