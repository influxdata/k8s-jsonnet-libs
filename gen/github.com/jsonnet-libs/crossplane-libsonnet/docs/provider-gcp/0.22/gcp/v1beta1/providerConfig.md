---
permalink: /provider-gcp/0.22/gcp/v1beta1/providerConfig/
---

# gcp.v1beta1.providerConfig
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.clientOptions`](#obj-specclientoptions)
    * [`fn withEndpoint(endpoint)`](#fn-specclientoptionswithendpoint)
    * [`fn withWithoutAuthentication(withoutAuthentication)`](#fn-specclientoptionswithwithoutauthentication)
...
### fn spec.clientOptions.withWithoutAuthentication

```ts
withWithoutAuthentication(withoutAuthentication)
```
