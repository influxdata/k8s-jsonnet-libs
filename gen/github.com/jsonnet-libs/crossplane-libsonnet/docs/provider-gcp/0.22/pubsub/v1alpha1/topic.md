---
permalink: /provider-gcp/0.22/pubsub/v1alpha1/topic/
---

# pubsub.v1alpha1.topic
...
"KmsKeyNameRef allows you to specify custom resource name of the KMS Key to fill KmsKeyName field."
...
"KmsKeyNameSelector allows you to use selector constraints to select a KMS Key."
...
"MessageStoragePolicy is the policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect."
