---
permalink: /provider-gcp/0.22/dns/v1alpha1/resourceRecordSet/
---

# dns.v1alpha1.resourceRecordSet
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSignatureRrdatas(signatureRrdatas)`](#fn-specforproviderwithsignaturerrdatas)
    * [`fn withSignatureRrdatasMixin(signatureRrdatas)`](#fn-specforproviderwithsignaturerrdatasmixin)
...
"List of ResourceRecord datas as defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1)"
...
### fn spec.forProvider.withSignatureRrdatas

```ts
withSignatureRrdatas(signatureRrdatas)
```

"List of Signature ResourceRecord datas, as defined in RFC 4034 (section 3.2)."

### fn spec.forProvider.withSignatureRrdatasMixin

```ts
withSignatureRrdatasMixin(signatureRrdatas)
```
