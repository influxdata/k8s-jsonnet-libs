---
permalink: /provider-aws/0.18/aws/v1alpha3/provider/
---

# aws.v1alpha3.provider
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withUseServiceAccount(useServiceAccount)`](#fn-specwithuseserviceaccount)
  * [`obj spec.credentialsSecretRef`](#obj-speccredentialssecretref)
...
### fn spec.withUseServiceAccount

```ts
withUseServiceAccount(useServiceAccount)
```
...
### fn spec.credentialsSecretRef.withKey
...
### fn spec.credentialsSecretRef.withName
...
### fn spec.credentialsSecretRef.withNamespace
