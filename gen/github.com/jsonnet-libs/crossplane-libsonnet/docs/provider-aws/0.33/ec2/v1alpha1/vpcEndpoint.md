---
permalink: /provider-aws/0.33/ec2/v1alpha1/vpcEndpoint/
---

# ec2.v1alpha1.vpcEndpoint
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withRouteTableIdRefs(routeTableIdRefs)`](#fn-specforproviderwithroutetableidrefs)
    * [`fn withRouteTableIdRefsMixin(routeTableIdRefs)`](#fn-specforproviderwithroutetableidrefsmixin)
...
### fn spec.forProvider.withRouteTableIdRefs

```ts
withRouteTableIdRefs(routeTableIdRefs)
```

"RouteTableIDRefs is a list of references to RouteTables used to set the RouteTableIDs."

### fn spec.forProvider.withRouteTableIdRefsMixin

```ts
withRouteTableIdRefsMixin(routeTableIdRefs)
```
