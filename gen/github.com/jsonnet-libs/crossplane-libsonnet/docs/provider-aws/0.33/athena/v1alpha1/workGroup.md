---
permalink: /provider-aws/0.33/athena/v1alpha1/workGroup/
---

# athena.v1alpha1.workGroup
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.configuration`](#obj-specforproviderconfiguration)
      ...
      * [`obj spec.forProvider.configuration.engineVersion`](#obj-specforproviderconfigurationengineversion)
        * [`fn withEffectiveEngineVersion(effectiveEngineVersion)`](#fn-specforproviderconfigurationengineversionwitheffectiveengineversion)
      ...
      * [`obj spec.forProvider.configuration.resultConfiguration`](#obj-specforproviderconfigurationresultconfiguration)
        ...
        * [`obj spec.forProvider.configuration.resultConfiguration.encryptionConfiguration`](#obj-specforproviderconfigurationresultconfigurationencryptionconfiguration)
          ...
          * [`fn withKmsKey(kmsKey)`](#fn-specforproviderconfigurationresultconfigurationencryptionconfigurationwithkmskey)
...
### fn spec.forProvider.configuration.engineVersion.withEffectiveEngineVersion

```ts
withEffectiveEngineVersion(effectiveEngineVersion)
```
...
### fn spec.forProvider.configuration.resultConfiguration.encryptionConfiguration.withKmsKey
