---
permalink: /provider-aws/0.33/sqs/v1beta1/queue/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.kmsMasterKeyIdRef`](#obj-specforproviderkmsmasterkeyidref)
      * [`fn withName(name)`](#fn-specforproviderkmsmasterkeyidrefwithname)
      * [`obj spec.forProvider.kmsMasterKeyIdRef.policy`](#obj-specforproviderkmsmasterkeyidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderkmsmasterkeyidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderkmsmasterkeyidrefpolicywithresolve)
    * [`obj spec.forProvider.kmsMasterKeyIdSelector`](#obj-specforproviderkmsmasterkeyidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderkmsmasterkeyidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderkmsmasterkeyidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderkmsmasterkeyidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.kmsMasterKeyIdSelector.policy`](#obj-specforproviderkmsmasterkeyidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderkmsmasterkeyidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderkmsmasterkeyidselectorpolicywithresolve)
    * [`obj spec.forProvider.redrivePolicy`](#obj-specforproviderredrivepolicy)
      ...
      * [`obj spec.forProvider.redrivePolicy.deadLetterTargetArnRef`](#obj-specforproviderredrivepolicydeadlettertargetarnref)
        ...
        * [`obj spec.forProvider.redrivePolicy.deadLetterTargetArnRef.policy`](#obj-specforproviderredrivepolicydeadlettertargetarnrefpolicy)
          * [`fn withResolution(resolution)`](#fn-specforproviderredrivepolicydeadlettertargetarnrefpolicywithresolution)
          * [`fn withResolve(resolve)`](#fn-specforproviderredrivepolicydeadlettertargetarnrefpolicywithresolve)
      * [`obj spec.forProvider.redrivePolicy.deadLetterTargetArnSelector`](#obj-specforproviderredrivepolicydeadlettertargetarnselector)
        ...
        * [`obj spec.forProvider.redrivePolicy.deadLetterTargetArnSelector.policy`](#obj-specforproviderredrivepolicydeadlettertargetarnselectorpolicy)
          * [`fn withResolution(resolution)`](#fn-specforproviderredrivepolicydeadlettertargetarnselectorpolicywithresolution)
          * [`fn withResolve(resolve)`](#fn-specforproviderredrivepolicydeadlettertargetarnselectorpolicywithresolve)
