---
permalink: /provider-aws/0.33/route53resolver/v1alpha1/resolverEndpoint/
---
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.ipAddresses`](#obj-specforprovideripaddresses)
      ...
      * [`obj spec.forProvider.ipAddresses.subnetIdRef`](#obj-specforprovideripaddressessubnetidref)
        ...
        * [`obj spec.forProvider.ipAddresses.subnetIdRef.policy`](#obj-specforprovideripaddressessubnetidrefpolicy)
          * [`fn withResolution(resolution)`](#fn-specforprovideripaddressessubnetidrefpolicywithresolution)
          * [`fn withResolve(resolve)`](#fn-specforprovideripaddressessubnetidrefpolicywithresolve)
      * [`obj spec.forProvider.ipAddresses.subnetIdSelector`](#obj-specforprovideripaddressessubnetidselector)
        ...
        * [`obj spec.forProvider.ipAddresses.subnetIdSelector.policy`](#obj-specforprovideripaddressessubnetidselectorpolicy)
          * [`fn withResolution(resolution)`](#fn-specforprovideripaddressessubnetidselectorpolicywithresolution)
          * [`fn withResolve(resolve)`](#fn-specforprovideripaddressessubnetidselectorpolicywithresolve)
...
## obj spec.forProvider.ipAddresses.subnetIdRef.policy

"Policies for referencing."

### fn spec.forProvider.ipAddresses.subnetIdRef.policy.withResolution
...
### fn spec.forProvider.ipAddresses.subnetIdRef.policy.withResolve
...
## obj spec.forProvider.ipAddresses.subnetIdSelector.policy

"Policies for selection."

### fn spec.forProvider.ipAddresses.subnetIdSelector.policy.withResolution
...
### fn spec.forProvider.ipAddresses.subnetIdSelector.policy.withResolve
