---
permalink: /provider-aws/0.33/iam/v1beta1/group/
---

# iam.v1beta1.group

"An Group is a managed resource that represents an AWS IAM Group. An User is a managed resource that represents an AWS IAM User."
