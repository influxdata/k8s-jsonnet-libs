---
permalink: /crossplane/1.3/pkg/v1beta1/configurationRevision/
---

# pkg.v1beta1.configurationRevision

"A ConfigurationRevision that has been added to Crossplane. [DEPRECATED]: Please use the identical v1 API instead. The v1beta1 API is scheduled to be removed in Crossplane v1.6."
