---
permalink: /crossplane/1.3/pkg/v1beta1/provider/
---

# pkg.v1beta1.provider

"Provider is the CRD type for a request to add a provider to Crossplane. [DEPRECATED]: Please use the identical v1 API instead. The v1beta1 API is scheduled to be removed in Crossplane v1.6."
