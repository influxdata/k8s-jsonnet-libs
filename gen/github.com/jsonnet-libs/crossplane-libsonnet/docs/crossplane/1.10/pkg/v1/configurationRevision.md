---
permalink: /crossplane/1.10/pkg/v1/configurationRevision/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withWebhookTLSSecretName(webhookTLSSecretName)`](#fn-specwithwebhooktlssecretname)
...
### fn spec.withWebhookTLSSecretName

```ts
withWebhookTLSSecretName(webhookTLSSecretName)
```
